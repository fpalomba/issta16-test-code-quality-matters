...
public class Optimization_ESTest extends Optimization_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      weka.core.matrix.Matrix matrix0 = new weka.core.matrix.Matrix(95, 95);
      double[] doubleArray0 = new double[2];
  ...
  public void test2()  throws Throwable  {
      weka.core.matrix.Matrix matrix0 = new weka.core.matrix.Matrix(125, 125);
      double[] doubleArray0 = new double[10];
      boolean[] booleanArray0 = new boolean[20];
      booleanArray0[4] = true;
      double[] doubleArray1 = Optimization.solveTriangle(matrix0, doubleArray0, true, booleanArray0);
      assertArrayEquals(new double[] {Double.NaN, Double.NaN, Double.NaN, Double.NaN, 0.0, Double.NaN, Double.NaN, Double.NaN, Double.NaN, Double.NaN}, doubleArray1, 0.01);
  }
  ...
  public void test4()  throws Throwable  {
      weka.core.matrix.Matrix matrix0 = new weka.core.matrix.Matrix(106, 106);
      double[] doubleArray0 = new double[2];
