...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**Erreur d'E/S** (java.io.IOException: Remote address/port is not opened: org.evosuite.runtime.vnet.EndPointInfo@25ffacdd) **");
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://0)3$sO|C0w;=st:2579");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "0)3$sO|C0w;=st");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("0)3$sO|C0w;=st", 2579);
