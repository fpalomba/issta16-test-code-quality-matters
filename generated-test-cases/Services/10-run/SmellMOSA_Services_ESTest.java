...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**URL Mal Form\u00E9** (");
      assertTrue(boolean0);
  ...
  public void test1()  throws Throwable  {
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testSMTP("=9=S", (-3449));
      assertNotNull(services_SIMPLE_Result0);
      assertEquals(0L, services_SIMPLE_Result0.time);
      assertFalse(services_SIMPLE_Result0.works);
      
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://sO0R#81+&gOP4uV7");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**Erreur : java.lang.IllegalArgumentException: port out of range:-3449**");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("sO0R#81+&gOP4uV7", (-1));
      assertNotNull(services_HTTP_Result0);
      assertEquals(0L, services_HTTP_Result0.time);
      assertEquals((-1), services_HTTP_Result0.code);
      assertTrue(services_HTTP_Result0.works);
      ...
      Services.HTTP_Result services_HTTP_Result1 = Services.testHTTP("=9=S", (-3449));
