...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://R\\k4':0");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "Y8#-))%XxTVUj/;$S");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("Y8#-))%XxTVUj/;$S", 23);
      ...
      Services.HTTP_Result services_HTTP_Result1 = Services.testHTTP("Rk4'", 0);
  ...
  public void test4()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://** Poid de a page  :1685");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "** Poid de a page  ");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("** Poid de a page  ", 1685);
      assertEquals(0L, services_HTTP_Result0.time);
