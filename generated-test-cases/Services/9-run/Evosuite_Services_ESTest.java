...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://:632");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**Erreur d'E/S** (java.io.IOException: Remote address/port is not opened: org.evosuite.runtime.vnet.EndPointInfo@42dae68d) **");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("", 632);
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://w=u>1,Kbh(*iq=nT:27");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "w=u>1,Kbh(*iq=nT");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("w=u>1,Kbh(*iq=nT", 27);
  ...
  public void test2()  throws Throwable  {
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testSMTP((String) null, 69);
