...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://'{b@!~z2~:0");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "'{b@!~z2~");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("'{b@!~z2~", 0);
      assertEquals(0L, services_HTTP_Result0.time);
      assertEquals((-1), services_HTTP_Result0.code);
  }
  ...
  public void test2()  throws Throwable  {
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testPOP3("'{b@!~z2~", 32);
  ...
  public void test4()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("'{b@!~z2~", 0);
