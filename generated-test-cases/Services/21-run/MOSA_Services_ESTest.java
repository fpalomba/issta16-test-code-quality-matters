...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "8(UG[vvZ0O\"`LF");
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://ZUZ?a+(t'-Z:0");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "6r7mH%a<");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("ZUZ?a+(t'-Z", 0);
      assertEquals(0L, services_HTTP_Result0.time);
  ...
  public void test3()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("** Code de page : ", (-136));
      String string0 = services_HTTP_Result0.toString();
      assertEquals("**** Resultat : \n** Fonctionnement : false\n** Temps : 0 ms\n** Poid de la page : 0 octets\n** Code de page : 0\n** Erreur g\u00E9n\u00E9r\u00E9e : **URL Mal Form\u00E9** (java.net.MalformedURLException: Invalid port number :-136) **.\n****", string0);
  }
