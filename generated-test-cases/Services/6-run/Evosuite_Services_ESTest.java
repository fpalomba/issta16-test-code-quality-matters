...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://U3Wg_&}");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "U3Wg_&}");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("U3Wg_&}", (-1));
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://:285");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**Erreur d'E/S** (java.io.IOException: Remote address/port is not opened: org.evosuite.runtime.vnet.EndPointInfo@1e76006b) **");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("", 285);
  ...
  public void test2()  throws Throwable  {
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testPOP3((String) null, 75);
  ...
  public void test3()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS((String) null, 75);
