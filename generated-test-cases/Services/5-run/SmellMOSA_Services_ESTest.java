...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://*$1gL Mal Fo \u00E9*~* (:36");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "*$1gL Mal Fo \u00E9*~* (");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("*$1gL Mal Fo \u00E9*~* (", 36);
  ...
  public void test3()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://JTOl2Vb!b5Oh>\"2:36");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "*$1gL Mal Fo \u00E9*~* (");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("JTOl2Vb!b5Oh>\"2", 36);
      assertEquals(0L, services_HTTP_Result0.time);
      assertTrue(services_HTTP_Result0.works);
      assertEquals((-1), services_HTTP_Result0.code);
      assertEquals(20, services_HTTP_Result0.page_weight);
      ...
      Services.HTTP_Result services_HTTP_Result1 = Services.testHTTP("*$1gL Mal Fo \u00E9*~* (", 36);
