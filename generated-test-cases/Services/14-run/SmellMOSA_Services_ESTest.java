...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("", (-5108));
      ...
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://htFs:191");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**URL Mal Form\u00E9** (java.net.MalformedURLException: Invalid port number :-5108) **");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result1 = Services.testHTTP("htFs", 191);
  ...
  public void test1()  throws Throwable  {
      ...
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://htFs:191");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "**Erreur d'E/S** (java.io.IOException: Remote address/port is not opened: org.evosuite.runtime.vnet.EndPointInfo@d390f53) **");
      assertTrue(boolean0);
  ...
  public void test4()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://*rreur d'E/S** (:0");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "*rreur d'E/S** (");
      assertTrue(boolean0);
      
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("*rreur d'E/S** (", 0);
      assertEquals(0L, services_HTTP_Result0.time);
