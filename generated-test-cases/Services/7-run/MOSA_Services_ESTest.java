...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://~XmMD1+'kBIk;h'P*S$:36");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "`_+Prx^hwE}hc!Q5']u");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("~XmMD1+'kBIk;h'P*S$", 36);
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://XH;x%r3C(94s_m0-!X :322");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "6}^dgZ{V");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("XH;x%r3C(94s_m0-!X ", 322);
      assertEquals(0L, services_HTTP_Result0.time);
  ...
  public void test2()  throws Throwable  {
      Services.SIMPLE_Result services_SIMPLE_Result0 = Services.testPOP3("wXO#>|QV:gv[% j&R", 128);
