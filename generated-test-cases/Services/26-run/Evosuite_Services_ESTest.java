...
public class Services_ESTest extends Services_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("https://vyrc~jLYr=t$Qk:0");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "vyrc~jLYr=t$Qk");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTPS("vyrc~jLYr=t$Qk", 0);
  ...
  public void test1()  throws Throwable  {
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://([!93<]6E^DN7HjmEzY:0");
      boolean boolean0 = NetworkHandling.createRemoteTextFile(evoSuiteURL0, "([!93<]6E^DN7HjmEzY");
      Services.HTTP_Result services_HTTP_Result0 = Services.testHTTP("([!93<]6E^DN7HjmEzY", 0);
      assertEquals(0L, services_HTTP_Result0.time);
  ...
  public void test4()  throws Throwable  {
      ...
      assertEquals("**** Resultat : \n** Fonctionnement : false\n** Temps : 0 ms\n** Poid de la page : 0 octets\n** Code de page : 0\n** Erreur g\u00E9n\u00E9r\u00E9e : **Erreur d'E/S** (org.evosuite.runtime.mock.java.lang.MockThrowable: Could not find: ([!93<]6E^DN7HjmEzY) **.\n****", string0);
  }
