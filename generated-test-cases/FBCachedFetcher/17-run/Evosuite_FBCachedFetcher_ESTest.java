...
public class FBCachedFetcher_ESTest extends FBCachedFetcher_ESTest_scaffolding {
   ...
   * Goal 3. org.firebirdsql.jdbc.FBCachedFetcher.absolute(IZ)Z: I105 Branch 35 IFEQ L208 - false
   * Goal 4. org.firebirdsql.jdbc.FBCachedFetcher.isBeforeFirst()Z: I14 Branch 42 IF_ICMPGE L267 - true
   * Goal 5. org.firebirdsql.jdbc.FBCachedFetcher.isAfterLast()Z: I10 Branch 46 IF_ICMPLE L276 - false
   */

  @Test
  public void test08()  throws Throwable  {
      LinkedList<byte[][]> linkedList0 = new LinkedList<byte[][]>();
      HashIndex<byte[][]> hashIndex0 = new HashIndex<byte[][]>(6573);
      byte[][] byteArray0 = new byte[21][6];
      boolean boolean0 = hashIndex0.add(byteArray0);
      boolean boolean1 = linkedList0.addAll((Collection<? extends byte[][]>) hashIndex0);
      FBCachedFetcher fBCachedFetcher0 = new FBCachedFetcher(linkedList0, (FBObjectListener.FetcherListener) null);
      // Undeclared exception!
      try {
        boolean boolean2 = fBCachedFetcher0.absolute(6573);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      ArrayList<byte[][]> arrayList0 = new ArrayList<byte[][]>();
      byte[][] byteArray0 = new byte[21][10];
      boolean boolean0 = arrayList0.add(byteArray0);
      FBCachedFetcher fBCachedFetcher0 = new FBCachedFetcher(arrayList0, (FBObjectListener.FetcherListener) null);
      // Undeclared exception!
      try {
   ...
   * Goal 2. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I164 Branch 9 IFEQ L59 - true
   */
   ...
   * Goal 2. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I62 Branch 1 IF_ICMPGE L41 - false
   * Goal 3. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I75 Branch 2 IFNE L42 - false
   * Goal 4. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I84 Branch 3 IFNE L42 - false
   * Goal 5. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I93 Branch 4 IFEQ L42 - true
   * Goal 6. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I112 Branch 5 IFEQ L45 - true
   * Goal 7. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I134 Branch 6 IFNE L52 - true
   * Goal 8. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I151 Branch 7 IFNE L57 - false
   * Goal 9. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I157 Branch 8 IFNE L57 - false
   * Goal 10. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I164 Branch 9 IFEQ L59 - false
   * Goal 11. org.firebirdsql.jdbc.FBCachedFetcher.<init>(Lorg/firebirdsql/gds/impl/GDSHelper;IILorg/firebirdsql/gds/impl/AbstractIscStmtHandle;Lorg/firebirdsql/jdbc/FBObjectListener$FetcherListener;Z)V: I173 Branch 10 IF_ICMPLE L59 - false
   */
  ...
  public void test15()  throws Throwable  {
      ...
      FBCachedFetcher fBCachedFetcher0 = null;
      try {
        fBCachedFetcher0 = new FBCachedFetcher((GDSHelper) null, (-44), (-1055), isc_stmt_handle_impl0, (FBObjectListener.FetcherListener) null, true);
        fail("Expecting exception: NullPointerException");
