...
public class OutputFormat_ESTest extends OutputFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[9] = "-padText";
      stringArray0[10] = "-padText";
      stringArray0[11] = "-padText";
      stringArray0[12] = "-padText";
      stringArray0[13] = "-padText";
      stringArray0[14] = "-padText";
      stringArray0[15] = "-padText";
      stringArray0[16] = ";1f";
  ...
  public void test05()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("%h:%m:%s%z", true);
  ...
  public void test06()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat();
      String[] stringArray0 = new String[9];
      stringArray0[7] = "-expandEmpty-xhtml\n";
  ...
  public void test08()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("%Y-%M%z", true);
  ...
  public void test11()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("ebNg;a!x)#ekY6Z", false, "ebNg;a!x)#ekY6Z");
  ...
  public void test12()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("%Y-%M%z", true);
      outputFormat0.setIndent("%Y-%M%z");
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertFalse(outputFormat0.isSuppressDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertEquals("%Y-%M%z", outputFormat0.getIndent());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertFalse(outputFormat0.isOmitEncoding());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals("-expandEmpty-xhtml\n", outputFormat0.getEncoding());
  }
  ...
  public void test19()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat(".;1:");
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertFalse(outputFormat0.isSuppressDeclaration());
  ...
  public void test20()  throws Throwable  {
      ...
      assertEquals(287, outputFormat0.getNewLineAfterNTags());
  }
   ...
   * Goal 5. org.dom4j.io.OutputFormat.setIndent(Ljava/lang/String;)V: I6 Branch 2 IFNULL L350 - true
   ...
   * Goal 10. org.dom4j.io.OutputFormat.parseOptions([Ljava/lang/String;I)I: I62 Branch 11 IFLE L484 - false
   */
