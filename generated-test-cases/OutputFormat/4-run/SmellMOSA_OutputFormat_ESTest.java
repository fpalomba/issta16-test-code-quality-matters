...
public class OutputFormat_ESTest extends OutputFormat_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invali ttri-ute qu.te char_cter (");
  ...
  public void test07()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtmlInvlid attribte quoe  haracter (");
  ...
  public void test08()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtmlInvlidatribte qX   haracter (");
      outputFormat0.setEncoding("-xhtmlInvlidatribte qX   haracter (");
      assertEquals("-xhtmlInvlidatribte qX   haracter (", outputFormat0.getEncoding());
  }
  ...
  public void test09()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invali ttriaute qu>te char_cter (");
      String string0 = outputFormat0.getIndent();
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertFalse(outputFormat0.isOmitEncoding());
      assertEquals("Invali ttriaute qu>te char_cter (", string0);
      assertFalse(outputFormat0.isSuppressDeclaration());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertFalse(outputFormat0.isExpandEmptyElements());
  }
  ...
  public void test11()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invlid attribui_ quote cRarTcer (");
  ...
  public void test12()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invlid attrbui_ quote chrTcr (");
  ...
  public void test17()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtmlInvliyatribte qX   haracter (", false);
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
  ...
  public void test23()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("InvDli tri-0te to ciar_cZe ");
  ...
  public void test24()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invlid attribui_ uote charTcer (");
  ...
  public void test25()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat(" sJ])'", true, " sJ])'");
  ...
  public void test26()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat();
      outputFormat0.setIndent("InvDli8tri-ute q9.to ciar_cte (");
      assertFalse(outputFormat0.isOmitEncoding());
      assertEquals("InvDli8tri-ute q9.to ciar_cte (", outputFormat0.getIndent());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertFalse(outputFormat0.isSuppressDeclaration());
  ...
  public void test27()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invlid attibte quoe  haracter (", true, "Invlid attibte quoe  haracter (");
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertFalse(outputFormat0.isOmitEncoding());
      assertFalse(outputFormat0.isSuppressDeclaration());
   ...
   * Goal 3. org.dom4j.io.OutputFormat.setXHTML(Z)V: root-Branch
   * Goal 4. org.dom4j.io.OutputFormat.setExpandEmptyElements(Z)V: root-Branch
   * Goal 5. org.dom4j.io.OutputFormat.setIndent(Z)V: I6 Branch 4 IFEQ L364 - true
   * Goal 6. org.dom4j.io.OutputFormat.parseOptions([Ljava/lang/String;I)I: I11 Branch 8 IF_ICMPGE L479 - true
  ...
  public void test30()  throws Throwable  {
      ...
      String[] stringArray0 = new String[8];
      stringArray0[0] = "-expandEmptyInvalid attribu_ quote charTctr (";
      stringArray0[1] = "-expandEmptyInvalid attribu_ quote charTctr (";
      stringArray0[2] = "-xhtml)TQR)pX+T";
      stringArray0[3] = "-xhtml)TQR)pX+T";
      outputFormat0.setIndent(false);
      stringArray0[4] = "-lineSeparator";
      stringArray0[6] = "-expandEmptyInvalid attribu_ quote charTctr (";
      stringArray0[7] = "-xhtml)TQR)pX+T";
      int int0 = outputFormat0.parseOptions(stringArray0, 0);
   ...
   * Goal 2. org.dom4j.io.OutputFormat.isSuppressDeclaration()Z: root-Branch
   */

  @Test
  public void test31()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Invlid attribui_ quote charTcer (");
  ...
  public void test34()  throws Throwable  {
      ...
      stringArray0[0] = "Invalid atribu_ qote charTctr (";
      int int0 = outputFormat0.parseOptions(stringArray0, 0);
      assertFalse(outputFormat0.isOmitEncoding());
      assertFalse(outputFormat0.isSuppressDeclaration());
      assertFalse(outputFormat0.isExpandEmptyElements());
