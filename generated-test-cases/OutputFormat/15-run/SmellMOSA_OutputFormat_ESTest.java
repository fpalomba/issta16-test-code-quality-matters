...
public class OutputFormat_ESTest extends OutputFormat_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-expandEmptyorg.apache.xerces.jaxp.datatype.DurationIm%l");
      String[] stringArray0 = new String[15];
      stringArray0[0] = "-expandEmptyorg.apache.xerces.jaxp.datatype.DurationIm%l";
      // Undeclared exception!
      try {
        int int0 = outputFormat0.parseOptions(stringArray0, 0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      ...
      stringArray0[2] = "-xhtml-lineSepaator";
      // Undeclared exception!
      try {
        int int0 = outputFormat0.parseOptions(stringArray0, 2);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("I+valfd ttribu6e quote char7cter (");
      assertFalse(outputFormat0.isSuppressDeclaration());
  ...
  public void test30()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("Inva;id ttbud q&te charae 6");
  ...
  public void test31()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat();
      outputFormat0.setIndent("-expandEmptyInva;id ttbud q&te charae 6");
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertFalse(outputFormat0.isSuppressDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertEquals("-expandEmptyInva;id ttbud q&te charae 6", outputFormat0.getIndent());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertFalse(outputFormat0.isOmitEncoding());
  }
  ...
  public void test34()  throws Throwable  {
      ...
      assertFalse(outputFormat0.isSuppressDeclaration());
      assertFalse(outputFormat0.isOmitEncoding());
      assertEquals("I+valfd ttribu6e quote char7cter (", string0);
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
  }
  ...
  public void test36()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("I+valid atribte qot charc6er (");
  ...
  public void test39()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("I+valid atribte qot charc6er (");
      outputFormat0.setEncoding("I+valid atribte qot charc6er (");
      assertEquals("I+valid atribte qot charc6er (", outputFormat0.getEncoding());
  }
  ...
  public void test40()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat();
      String[] stringArray0 = new String[1];
      int int0 = outputFormat0.parseOptions(stringArray0, 3072);
      // Undeclared exception!
      try {
        int int1 = outputFormat0.parseOptions(stringArray0, (-3291));
