...
public class OutputFormat_ESTest extends OutputFormat_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtlInalid ttibute quot cracter A");
  ...
  public void test05()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-htlIn\"alid atribuHe qote  harac`er A");
  ...
  public void test07()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("xhtlInAaYd attribste qNote char-cte A");
  ...
  public void test11()  throws Throwable  {
      ...
      int int0 = outputFormat0.parseOptions(stringArray0, 66);
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertFalse(outputFormat0.isSuppressDeclaration());
  ...
  public void test19()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtlInvvlid attribuHe q8ote  a1acte A", true);
      assertFalse(outputFormat0.isSuppressDeclaration());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
  ...
  public void test20()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhlInvalid attribXte uoe chacte A");
  ...
  public void test22()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtlInvalid ttribute quote character A");
  ...
  public void test23()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat(" GqnN@4)&Yx/ b<zXs(");
      outputFormat0.setLineSeparator(" GqnN@4)&Yx/ b<zXs(");
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertFalse(outputFormat0.isSuppressDeclaration());
  ...
  public void test25()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-htlIn\"alid atribuHe qote  harac`er A");
      outputFormat0.setIndent("-htlIn\"alid atribuHe qote  harac`er A");
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertEquals("-htlIn\"alid atribuHe qote  harac`er A", outputFormat0.getIndent());
      assertFalse(outputFormat0.isOmitEncoding());
      assertFalse(outputFormat0.isSuppressDeclaration());
  }
   ...
   * Goal 6. org.dom4j.io.OutputFormat.parseOptions([Ljava/lang/String;I)I: I237 Branch 19 IFLE L500 - true
   */
   ...
   * Goal 2. org.dom4j.io.OutputFormat.isExpandEmptyElements()Z: root-Branch
   */

  @Test
  public void test28()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-x!tlInva`id atribuHe q8ote  harac`er A", true, "-x!tlInva`id atribuHe q8ote  harac`er A");
   ...
   * Goal 11. org.dom4j.io.OutputFormat.parseOptions([Ljava/lang/String;I)I: I196 Branch 17 IFLE L496 - false
   */
  ...
  public void test32()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtlInvaYid attibute qoe character A");
  ...
  public void test33()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("htlIn\"alid atrbuHe qote  harac`er A");
      String string0 = outputFormat0.getIndent();
      assertFalse(outputFormat0.isExpandEmptyElements());
      assertTrue(outputFormat0.isNewLineAfterDeclaration());
      assertEquals("UTF-8", outputFormat0.getEncoding());
      assertEquals("htlIn\"alid atrbuHe qote  harac`er A", string0);
      assertFalse(outputFormat0.isOmitEncoding());
      assertFalse(outputFormat0.isSuppressDeclaration());
  }
   ...
   * Goal 2. org.dom4j.io.OutputFormat.setAttributeQuoteCharacter(C)V: I7 Branch 6 IF_ICMPEQ L462 - true
   */
  ...
  public void test35()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtlIn{aYid attriute qNote characte A");
  ...
  public void test36()  throws Throwable  {
      OutputFormat outputFormat0 = new OutputFormat("-xhtlInvaYid attribute qNote character A");
