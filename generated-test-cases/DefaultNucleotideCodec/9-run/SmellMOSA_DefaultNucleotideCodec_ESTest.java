...
public class DefaultNucleotideCodec_ESTest extends DefaultNucleotideCodec_ESTest_scaffolding {
   ...
   * Goal 5. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I75 Branch 9 IFEQ L405 - true
   */
  ...
  public void test00()  throws Throwable  {
      ...
      Range range0 = Range.ofLength((long) (byte)44);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        Nucleotide nucleotide0 = defaultNucleotideCodec0.decode(byteArray0, 42L);
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // index 42 corresponds to encodedIndex 25  encodedglyph length is 5
         //
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      DefaultNucleotideCodec defaultNucleotideCodec0 = DefaultNucleotideCodec.INSTANCE;
      Range range0 = Range.ofLength(1065090L);
      assertFalse(range0.isEmpty());
      assertNotNull(range0);
      ...
      try {
        ...
        fail("Expecting exception: IndexOutOfBoundsException");
         ...
         //
         // range [ 0 .. 1065089 ]/0B is out of range of sequence which is only [ 0 .. -1 ]/0B
         //
      }
  }
  ...
  public void test09()  throws Throwable  {
      ...
      int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (int) (byte)126);
      assertArrayEquals(new byte[] {(byte)0, (byte) (-57), (byte)0, (byte)0, (byte) (-57), (byte)0, (byte)0, (byte)0}, byteArray0);
      assertEquals(0, int0);
      assertEquals(0, defaultNucleotideCodec0.ordinal());
      assertEquals("INSTANCE", defaultNucleotideCodec0.toString());
      assertEquals("INSTANCE", defaultNucleotideCodec0.name());
  ...
  public void test14()  throws Throwable  {
      ...
      DefaultNucleotideCodec defaultNucleotideCodec0 = DefaultNucleotideCodec.INSTANCE;
      int int0 = defaultNucleotideCodec0.getNumberOfGapsUntil(byteArray0, (int) (byte)27);
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        int int0 = defaultNucleotideCodec0.getUngappedOffsetFor(byteArray0, (int) (byte) (-7));
   ...
   * Goal 8. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I26 Branch 7 IFEQ L399 - true
   ...
   * Goal 11. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I69 Branch 8 IFEQ L405 - false
   * Goal 12. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I75 Branch 9 IFEQ L405 - false
   */
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (int) (byte) (-34));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
