...
public class DefaultNucleotideCodec_ESTest extends DefaultNucleotideCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (int) (byte) (-16));
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)1, (byte)80}, byteArray0);
      assertEquals(1, int0);
      assertEquals("INSTANCE", defaultNucleotideCodec0.name());
      assertEquals("INSTANCE", defaultNucleotideCodec0.toString());
  ...
  public void test03()  throws Throwable  {
      ...
      boolean boolean0 = defaultNucleotideCodec0.isGap(byteArray0, (int) (byte)9);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)1, (byte)80}, byteArray0);
      ...
      int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (int) (byte)9);
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)1, (byte)80}, byteArray0);
      assertEquals(0, int0);
      assertEquals("INSTANCE", defaultNucleotideCodec0.toString());
      assertEquals("INSTANCE", defaultNucleotideCodec0.name());
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        Nucleotide nucleotide1 = defaultNucleotideCodec0.decode(byteArray0, (-41L));
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // index can not be negative: -41
         //
      }
  }
  ...
  public void test06()  throws Throwable  {
      ...
      int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (int) (byte) (-14));
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)1, (byte)0}, byteArray0);
      assertEquals(1, int0);
      assertEquals("INSTANCE", defaultNucleotideCodec0.name());
      assertEquals("INSTANCE", defaultNucleotideCodec0.toString());
  ...
  public void test09()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: IndexOutOfBoundsException");
         ...
         //
         // range [ -1847 .. -1847 ]/0B is out of range of sequence which is only [ 0 .. -1 ]/0B
         //
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      int int0 = defaultNucleotideCodec0.getNumberOfGapsUntil(byteArray0, (int) (byte)113);
  ...
  public void test12()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[17];
      Nucleotide nucleotide0 = defaultNucleotideCodec0.decode(byteArray0, 17L);
      assertEquals(Nucleotide.Gap, nucleotide0);
      assertEquals("Gap", nucleotide0.name());
      assertEquals("-", nucleotide0.toString());
      assertEquals(11, nucleotide0.ordinal());
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        byte[] byteArray1 = defaultNucleotideCodec0.encode(513, iterator0);
  ...
  public void test19()  throws Throwable  {
      DefaultNucleotideCodec defaultNucleotideCodec0 = DefaultNucleotideCodec.INSTANCE;
      byte[] byteArray0 = new byte[4];
      boolean boolean0 = defaultNucleotideCodec0.isGap(byteArray0, (-3727));
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0}, byteArray0);
      assertFalse(boolean0);
      
      int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (-3727));
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)0}, byteArray0);
      assertEquals(0, int0);
  }
  ...
  /*
   * 11 covered goals:
   * Goal 1. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec.isEven(J)Z: I10 Branch 17 IFNE L214 - true
   ...
   * Goal 7. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I26 Branch 7 IFEQ L399 - true
   ...
   * Goal 10. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I69 Branch 8 IFEQ L405 - false
   * Goal 11. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec$IteratorImpl.next()Lorg/jcvi/jillion/core/residue/nt/Nucleotide;: I75 Branch 9 IFEQ L405 - false
   */
