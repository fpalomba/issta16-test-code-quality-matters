...
public class DefaultNucleotideCodec_ESTest extends DefaultNucleotideCodec_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals("INSTANCE", defaultNucleotideCodec0.name());
      assertEquals("INSTANCE", defaultNucleotideCodec0.toString());
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)5, (byte)0, (byte)5, (byte)0}, byteArray0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try {
        byte[] byteArray1 = defaultNucleotideCodec0.encode(3393, iterator0);
  ...
  public void test09()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: IndexOutOfBoundsException");
         ...
         //
         // range [ -41 .. -41 ]/0B is out of range of sequence which is only [ 0 .. -1 ]/0B
         //
      }
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: IndexOutOfBoundsException");
         ...
         //
         // range [ 43 .. 43 ]/0B is out of range of sequence which is only [ 0 .. 0 ]/0B
         //
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertArrayEquals(new byte[] {(byte)0, (byte)0, (byte)0, (byte)4, (byte)0, (byte)4}, byteArray0);
  }
   ...
   * Goal 2. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec.getNumberOfGapsUntil([BI)I: I17 Branch 26 IFEQ L317 - true
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(0, int0);
      assertArrayEquals(new byte[] {(byte)0, (byte)6, (byte)0, (byte)0, (byte)0, (byte)6, (byte)0, (byte)0, (byte)0, (byte)0}, byteArray0);
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        Nucleotide nucleotide0 = defaultNucleotideCodec0.decode(byteArray0, (long) (byte) (-79));
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // index can not be negative: -79
         //
      }
  }
  ...
  public void test18()  throws Throwable  {
      byte[] byteArray0 = new byte[16];
      DefaultNucleotideCodec defaultNucleotideCodec0 = DefaultNucleotideCodec.INSTANCE;
      int int0 = defaultNucleotideCodec0.getGappedOffsetFor(byteArray0, (int) (byte) (-79));
      assertEquals(0, int0);
  }
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        Nucleotide nucleotide1 = defaultNucleotideCodec0.decode(byteArray0, (long) (byte)7);
        fail("Expecting exception: IndexOutOfBoundsException");
   ...
   * Goal 10. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec.getGapOffsets([B)Ljava/util/List;: I23 Branch 18 IFEQ L245 - false
   * Goal 11. org.jcvi.jillion.core.residue.nt.DefaultNucleotideCodec.getGapOffsets([B)Ljava/util/List;: I32 Branch 19 IF_ACMPNE L246 - true
  ...
  public void test23()  throws Throwable  {
      ...
      boolean boolean0 = defaultNucleotideCodec0.isGap(byteArray0, (-3608));
      assertFalse(boolean0);
      assertEquals(0, defaultNucleotideCodec0.ordinal());
      assertEquals("INSTANCE", defaultNucleotideCodec0.name());
      assertEquals("INSTANCE", defaultNucleotideCodec0.toString());
