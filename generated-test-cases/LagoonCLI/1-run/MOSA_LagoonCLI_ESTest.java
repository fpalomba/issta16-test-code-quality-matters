...
public class LagoonCLI_ESTest extends LagoonCLI_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/*P4$-v:J{tHK");
      boolean boolean0 = FileSystemHandling.appendLineToFile(evoSuiteFile0, "Syntax:\nnu.staldal.lagoon.LagoonCLI <property_file> [<interval>|build|force]\nnu.staldal.lagoon.LagoonCLI <sitemap_file> [<interval>|build|force]");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "*P4$-v:J{tHK";
  ...
  public void test1()  throws Throwable  {
      ...
      String[] stringArray0 = new String[1];
      stringArray0[0] = "*P4$-v:J{tHK.sitemap";
      LagoonCLI.main(stringArray0);
  }
