...
public class LagoonCLI_ESTest extends LagoonCLI_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      stringArray0[0] = "?gn2zJbT61.sitemap.sitemap";
      LagoonCLI.main(stringArray0);
  }
  ...
  public void test4()  throws Throwable  {
      String[] stringArray0 = new String[1];
      stringArray0[0] = "NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearnp <: (CD=year <: __)) : =root <- =yearnp";
      LagoonCLI lagoonCLI0 = new LagoonCLI();
      assertNotNull(lagoonCLI0);
      
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan\\.|Feb\\.|Mar\\.|Apr\\.|Aug\\.|Sep\\.|Sept\\.|Oct\\.|Nov\\.|Dec\\./)) <2 (NP=yearnp <: (CD=year <: __)) : =root <- =yearnp");
      boolean boolean0 = FileSystemHandling.appendStringToFile(evoSuiteFile0, "NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearnp <: (CD=year <: __)) : =root <- =yearnp");
      assertTrue(boolean0);
   ...
   * Goal 5. nu.staldal.lagoon.LagoonCLI.main([Ljava/lang/String;)V: I529 Branch 12 IFEQ L188 - true
   */
