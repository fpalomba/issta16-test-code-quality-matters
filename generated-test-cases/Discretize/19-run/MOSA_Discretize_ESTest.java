...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("_ziW}BZ/ao%R");
  ...
  public void test02()  throws Throwable  {
      Discretize discretize0 = new Discretize("4vF<t");
      String string0 = discretize0.getBinRangesString(786);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString(7421);
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("_ziW}BZ/ao%R");
      double[] doubleArray0 = discretize0.getCutPoints(1338);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test06()  throws Throwable  {
      ...
      Instances instances0 = new Instances("EiT/:)QhT[T2L~9pH`&", arrayList0, 786);
      try {
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("N;h$}$30-PaHyML", arrayList0, 3236);
      try {
  ...
  public void test15()  throws Throwable  {
      ...
      stringArray0[0] = "*=+JXO[0 Vo@v<?m]";
      stringArray0[1] = "[";
      stringArray0[2] = "?<]T4I%";
      stringArray0[3] = "Testing with batch size:  ";
      stringArray0[4] = "";
      stringArray0[5] = "JE53|aQm<~";
      ...
      try {
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: *=+JXO[0 Vo@v<?m] [ ?<]T4I% Testing with batch size:   JE53|aQm<~ Number of bins. ' 
         // Filter options:
         // 
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("0,2jT");
  ...
  public void test20()  throws Throwable  {
      Discretize discretize0 = new Discretize("43)^1?fc9'");
  ...
  public void test24()  throws Throwable  {
      Discretize discretize0 = new Discretize("_ziW}Z/ao%R");
   ...
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.<init>(Ljava/lang/String;)V: root-Branch
   * Goal 6. weka.filters.unsupervised.attribute.Discretize.getFindNumBins()Z: root-Branch
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.setUseEqualFrequency(Z)V: root-Branch
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.setDesiredWeightOfInstancesPerInterval(D)V: root-Branch
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.getBins()I: root-Branch
   * Goal 10. weka.filters.unsupervised.attribute.Discretize.getInvertSelection()Z: root-Branch
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.setMakeBinary(Z)V: root-Branch
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.main([Ljava/lang/String;)V: root-Branch
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.setInvertSelection(Z)V: root-Branch
   * Goal 14. weka.filters.unsupervised.attribute.Discretize.getUseEqualFrequency()Z: root-Branch
   * Goal 15. weka.filters.unsupervised.attribute.Discretize.getAttributeIndices()Ljava/lang/String;: root-Branch
   * Goal 16. weka.filters.unsupervised.attribute.Discretize.setBins(I)V: root-Branch
   * Goal 17. weka.filters.unsupervised.attribute.Discretize.setFindNumBins(Z)V: root-Branch
   * Goal 18. weka.filters.unsupervised.attribute.Discretize.getUseBinNumbers()Z: root-Branch
   * Goal 19. weka.filters.unsupervised.attribute.Discretize.getMakeBinary()Z: root-Branch
   * Goal 20. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 21. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   * Goal 22. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - false
   * Goal 23. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - false
   * Goal 24. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - false
   * Goal 25. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I137 Branch 5 IFNULL L280 - true
   * Goal 26. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - true
   * Goal 27. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I45 Branch 7 IFEQ L301 - true
   * Goal 28. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - true
   * Goal 29. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   * Goal 30. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - true
   * Goal 31. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - true
   * Goal 32. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - false
   */
