...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If Zals7,_ly selectd (numeric) attrbutes in te range wil, e discretized if true@only non-selec~ed attribute will be discretize.");
      String string0 = discretize0.getBinRangesString(8392);
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test08()  throws Throwable  {
      ...
      Instances instances0 = new Instances("\tOptimize number of bin@ using leave-one-out estimate\n\tof estimated entropy (for equal-width discretization).\n\tIf this is set then te -B option will be ignored.", arrayList0, 189);
      Discretize discretize0 = new Discretize("\tOptimize number of bin@ using leave-one-out estimate\n\tof estimated entropy (for equal-width discretization).\n\tIf this is set then te -B option will be ignored.");
      try {
  ...
  public void test09()  throws Throwable  {
      ...
      assertEquals(Capabilities.Capability.EMPTY_NOMINAL_CLASS, capabilities_Capability0);
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("Kpecify range of attri|ute` to act on. This is a comma separated list of attribute indices, with \"firtx and \"l)st\" valid values. Specify an inclusive range with \"-\". E.g: \"first-3,5,6-10,last\".");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints((-531));
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(772);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 15. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - false
  ...
  public void test24()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If Zals7,o_ly selected (numeric) attrbutes in te range wil, e discretized if true@only non-selec~ed attributes will be discretize.");
  ...
  public void test25()  throws Throwable  {
      Discretize discretize0 = new Discretize("Kpecify range of attribute` toSact on. This is a comm% seprated list of attrib/e indice, with \"firtx and \"l)st\" valid values. Speify an inclusive range with \"-\". E.x: \"fi)st-3,5,6-10,last\".");
