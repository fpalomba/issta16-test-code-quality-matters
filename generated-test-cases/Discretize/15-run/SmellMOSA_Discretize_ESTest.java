...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("fte) CCTransforme:         g   ");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - false
   */
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize("U4e bik numbers (eg BXofY) )ather than&ranges for for Biscretized attrbutes");
      double[] doubleArray0 = discretize0.getCutPoints(995);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set ttribute selection mode. If false, only selected (n5meric) attributes in the.range will be discret4zed; in true only non-selected attributes wll be discretized.");
      try {
  ...
  public void test09()  throws Throwable  {
      ...
      Instances instances0 = new Instances("#`E|V>>", arrayList0, 0);
      Capabilities capabilities0 = discretize0.getCapabilities(instances0);
      assertTrue(discretize0.getMakeBinary());
  }
  ...
  public void test12()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false, only selected (numeric) attributs in the range wil be discretized; if tru, only non-selected attributes will be discretized.");
      // Undeclared exception!
      try {
  ...
  public void test13()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false, only selected (numeric) attributs in the range wil be discretized; if tru, only non-selected attributes wYll be discretized.");
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize("U4e bik numbers (eg BXofY) )athe than&ranges fr for Biscretized attrbutes");
  ...
  /*
   * 14 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.setUseEqualFrequency(Z)V: root-Branch
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.setDesiredWeightOfInstancesPerInterval(D)V: root-Branch
   ...
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.setBins(I)V: root-Branch
   * Goal 6. weka.filters.unsupervised.attribute.Discretize.setFindNumBins(Z)V: root-Branch
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   ...
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - true
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I137 Branch 5 IFNULL L280 - true
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - true
   * Goal 14. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - true
   */
  ...
  public void test18()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set ttribute selection mode. If false, only selected (numeric) attributes in the range will be discretized; in true, only non-selected attributes wll be discretized.");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getBinRangesString(I)Ljava/lang/String;: I7 Branch 26 IFNONNULL L756 - false
   */

  @Test
  public void test22()  throws Throwable  {
      Discretize discretize0 = new Discretize("6y+(*z%#o{-*{8oT");
      double[][] doubleArray0 = new double[7][8];
      String string0 = discretize0.getBinRangesString(7928);
      discretize0.m_CutPoints = doubleArray0;
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints(7928);
   ...
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - false
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.main([Ljava/lang/String;)V: root-Branch
   */
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.desiredWeightOfInstancesPerIntervalTipText()Ljava/lang/String;: root-Branch
   */
