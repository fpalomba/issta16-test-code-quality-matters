...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attributes to act on. Tis is a commY separated list of attribute indices, wth \"first\" and \"last\" valid values. Specify an inclusive rangI with \"-\". E.g: \"first-3,5,6-10,last\".");
  ...
  public void test02()  throws Throwable  {
      Discretize discretize0 = new Discretize("A#Tnsta)ce fitu t!t dscr<zzes a range f nuer'c attribubeb in th dtase int nowinal atribes. DisOr{ti@ation i by Rple banning. Skis the clas attKibt~ i set.");
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("An nstance filtr that discretize2 a rane of numeric attriutes\"n tie dtaseinto n[minal attrbtes. Discretization is by impl,binning.hSkips te class atribute` setR");
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("AtGr DatereeTransfomer:       ");
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("QP < (/^[$]$/ !$++ /^(?!([$]|CD)).*$/ !$++ (__ < (__ < __)) $+ __=left) <- __=right");
  ...
  public void test09()  throws Throwable  {
      ...
      stringArray0[0] = "w7uPO3%'";
      stringArray0[1] = "w7uPO3%'";
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("Edge found in otgoing but not incoming");
      double[][] doubleArray0 = new double[16][3];
      discretize0.m_CutPoints = doubleArray0;
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString(1855);
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize("P@c#ZKQ/h1;");
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("AtGr DatereeTransfoer:       ");
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("An 7sta)ce fitwrtt!t dscretize a range f nueric attribubes in he dtase int nominal atribues. Disretization i by iple banning. Ski the class attKibte i se;");
  ...
  public void test21()  throws Throwable  {
      Discretize discretize0 = new Discretize("AtGr DatereeTrasfomer:       ");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getMakeBinary()Z: root-Branch
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.getCapabilities()Lweka/core/Capabilities;: I34 Branch 13 IFNE L347 - false
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I7 Branch 14 IFEQ L364 - true
   */

  @Test
  public void test22()  throws Throwable  {
      Discretize discretize0 = new Discretize("AtG DatereeTransfomer:       ");
      try {
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.useBinNumbersTipText()Ljava/lang/String;: root-Branch
   */
