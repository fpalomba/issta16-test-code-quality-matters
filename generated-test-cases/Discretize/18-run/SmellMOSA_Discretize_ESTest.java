...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tSpecifies listoE cluns to Didcretie.Firs and last are alid indexes.\n\t(default: first-l5st)");
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute se%ection mode. If falNe, only select$d ({umeric) attributes (n the ran]e will be d{scretized; if true, only non-selected attribtes will7be iscretized.");
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tOptimize number5of *ins using leave-one-1ut estimate\n\tof estimated entropy (for equal-width discretization).\n\tIf this is set then the -B option will be ignored.");
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString((int) (byte)0);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tOptimize number5of *ins using leave-one-1ut estimate\n\tof estimated entropy (for equal-w;dth discretization).\n\tIf this is set then the -z option will be ignored.");
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("LonM dnea     ");
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize("Tst canot heck forcycles in ree foma. (classe not ava#lable)");
      String[] stringArray0 = discretize0.getOptions();
      try {
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize(" \tLong dniamea     ");
   ...
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.setBins(I)V: root-Branch
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.setFindNumBins(Z)V: root-Branch
   * Goal 6. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - true
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - true
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - true
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I137 Branch 5 IFNULL L280 - true
   */
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.getCapabilities()Lweka/core/Capabilities;: I34 Branch 13 IFNE L347 - true
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I7 Branch 14 IFEQ L364 - false
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I13 Branch 15 IFEQ L364 - true
   */
  ...
  public void test12()  throws Throwable  {
      ...
      String[] stringArray0 = discretize0.getOptions();
      Attribute attribute0 = new Attribute("", 6745);
      Instances instances0 = attribute0.relation(6745);
      try {
  ...
  /*
   * 2 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   */
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false, only select$d (numeric) attributes (n the ran]e will be d{scretized; if true, only non-selected attributes will7be iscretized.");
      try {
        boolean boolean0 = discretize0.setInputFormat((Instances) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(4);
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tOptimize number5of *ins usin leave-one-1ut estimate\n\tof estimated entropy (for equal-width discretization).\n\tIf this is set then the -B option will be ignored.");
  ...
  public void test18()  throws Throwable  {
      ...
      try {
        double[] doubleArray1 = discretize0.getCutPoints(249);
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false, only selct$d numeric) attributes(n the ran]e will be d{scretized; if true, onl non-selected attributes will[be iscretized.");
      // Undeclared exception!
      try {
  ...
  /*
   * 2 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.setInvertSelection(Z)V: root-Branch
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - false
   */
  ...
  public void test25()  throws Throwable  {
      ...
      Instances instances0 = new Instances("O(8-~,s w", arrayList0, 0);
      try {
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - false
   */
  ...
  public void test28()  throws Throwable  {
      Discretize discretize0 = new Discretize("5et attrib_te seletion mode. If flse,only 4electd (nume1ic) attributes ( the ran]e will be d{scretized; if true,only non-sefected attributesuwill7be discretized.");
