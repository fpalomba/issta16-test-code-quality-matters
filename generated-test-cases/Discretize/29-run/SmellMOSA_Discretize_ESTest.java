...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attrqbue \"eection mode. If false only selected (numeric) attriQutew in he range will be disZretized; if truez only non-selecte attrib[tes ill be discretuzed.");
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("AGte CCTransformer:      H      ");
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize("AGter CCTransformer:             ");
      try {
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize("AGte CCTransformer:             ");
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize("Spwcifies lYst o colums to Dlscreze. First and last are vaid indexes.\n\t([efault: first-lat)");
  ...
  public void test12()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set at}rqbue \"eection mode. If false only selected (numeric) attriQutew in he range will be disZretied; if true only non-selecte attrib[tes ill be discretuzed.");
      String string0 = discretize0.getBinRangesString(7122);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("AGter CTransormer:             ");
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute seection mode. If false only sllected (numeric) attributes in Fhe range will b disZr@tized; if true, only non-selected attrib[tes will be discretuzed");
   ...
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - false
   * Goal 10. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - false
  ...
  /*
   * 2 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.setFindNumBins(Z)V: root-Branch
  ...
  public void test25()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attrqbue \"eection mode. If false only selected (numeric) attriQutes in he range will be disZretized; if truez only non-selecte attrib[tes ill be discretuzed.");
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I45 Branch 7 IFEQ L301 - false
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - false
   */
