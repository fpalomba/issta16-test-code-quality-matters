...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString(943);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - true
   */
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("Optimize (umber of eqwal-width bins using leave-one-out. Doesn't work for equal-frequency binning");
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(14);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test12()  throws Throwable  {
      ...
      stringArray0[0] = ";zClCX>>.";
      stringArray0[1] = ";zClCX>>.";
      stringArray0[2] = ";zClCX>>.";
      stringArray0[3] = "-R";
      stringArray0[4] = ";zClCX>>.";
      stringArray0[5] = ";zClCX>>.";
      try {
        Filter.filterFile((Filter) discretize0, stringArray0);
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: ;zClCX>>. ;zClCX>>. ;zClCX>>. ;zClCX>>. 
         // Filter options:
         // 
         // -unset-class-temporarily
         // \tUnsets the class index temporarily before the filter is
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize("RKWGt?t");
      discretize0.setMakeBinary(true);
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("RKWGt?t", arrayList0, 5828);
      try {
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set aFtriute selecto ode. |f lse, only selcted (numei) atabutesin the (ng will be discretized;if tue, only on-_elecef attribues will be dsc=tized");
      // Undeclared exception!
      try {
   ...
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - true
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I45 Branch 7 IFEQ L301 - true
   * Goal 10. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - true
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - true
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - false
   * Goal 14. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - false
   */
  ...
  public void test20()  throws Throwable  {
      Discretize discretize0 = new Discretize("An insance filer that discretizes:a range ob n\"meric Etributes in th dawas   ino ominal attributes. Discretization ps by simple binning. Skips7the class attributM if st.");
      String[] stringArray0 = new String[3];
      stringArray0[0] = "An insance filer that discretizes:a range ob n\"meric Etributes in th dawas   ino ominal attributes. Discretization ps by simple binning. Skips7the class attributM if st.";
      stringArray0[1] = "-B";
      stringArray0[2] = "An insance filer that discretizes:a range ob n\"meric Etributes in th dawas   ino ominal attributes. Discretization ps by simple binning. Skips7the class attributM if st.";
      try {
        Filter.filterFile((Filter) discretize0, stringArray0);
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // For input string: \"An insance filer that discretizes:a range ob n\"meric Etributes in th dawas   ino ominal attributes. Discretization ps by simple binning. Skips7the class attributM if st.\"
         // Filter options:
         // 
         // -unset-class-temporarily
         // \tUnsets the class index temporarily before the filter is
  ...
  public void test25()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attributes tolact on. This is a comma separated list of attribute indices, with \"first\" and \"lastR valid values. Specify an inclusive range with \"-\". E.g: \"first-3,5,6-10,last\".");
      try {
  ...
  public void test27()  throws Throwable  {
      Discretize discretize0 = new Discretize("Kn instance filter that discretizes a range of numeric attributes in the dataset into nominal attributes. DiscretizQtion is by simple binning. Skips the class attribute if set.");
  ...
  public void test28()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attributes to act on. This is a comma separated list of attribute indices, with \"first\" and \"lastR valid values. Specify an inclusive rangeowith \"-\". E.g: \"first-3,5,6-10,last\".");
      try {
