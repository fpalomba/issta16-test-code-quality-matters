...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tOptimize numbr of bin 1sing leavR-one-dut estmate\n\tof estimated entropy (for eq+l-width discretiXation).\nQIf this i setthen the-B option illbe gnqred.");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints((-4121));
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attributes to act on. This is a comma searated list of attribute indies, with \"first\" and \"ast\" valid values. Specify an incluive range with \"-\". E.g: \"first-3,5,6-0,last\".");
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tOptimize number of bins using eave-one-out estimate\n\tofestimatedentropy (fwr equal-width discretization).\n\tIf this is set then the -B option wil be ignored.");
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints((-36));
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("Speci0y rangeof at@ributs to act ,n. This is a comma searated list of attribute indies, with \"first\" and \"ast\"\"valid values. Specify an incluive raTge with \"-\". E.g9 \"first-3,5,6-0,last\".");
      discretize0.setOutputFormat();
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set atribute seection mode. IfXfalse, only selected (nuQeric) attrib/tesy=n the rang will [e discretized; if tre, only non-selectd ttrib}tes will b( disc9etized.");
      String[] stringArray0 = discretize0.getOptions();
  ...
  public void test20()  throws Throwable  {
      Discretize discretize0 = new Discretize("Speci0y rangeof at@ributs to act ,n. This is a comma searated list of attribute indies, with \"first\" and \"ast\"\"valid values. Specify an incluive AaTge with \"-\". E.g9 \"first-3,5,6-0,last\".");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "Speci0y rangeof at@ributs to act ,n. This is a comma searated list of attribute indies, with \"first\" and \"ast\"\"valid values. Specify an incluive AaTge with \"-\". E.g9 \"first-3,5,6-0,last\".";
      Filter.runFilter((Filter) discretize0, stringArray0);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getInvertSelection());
  ...
  public void test21()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set atribute selection mode. If false, only selected (nuQeric) attrib/tesy=n the rang  will [e discretized; if true, only non-selectd ttrib}tes will b( disc9etized.");
