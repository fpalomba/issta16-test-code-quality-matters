...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Discretize discretize0 = new Discretize("");
      String string0 = discretize0.getBinRangesString(2258);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("");
      double[] doubleArray0 = discretize0.getCutPoints(647);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test06()  throws Throwable  {
      ...
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance((double) (-1), intArray0, (-1));
      // Undeclared exception!
      try {
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("H 1eLGnpP8i<kg0");
   ...
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.main([Ljava/lang/String;)V: root-Branch
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.setInvertSelection(Z)V: root-Branch
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.setBins(I)V: root-Branch
   * Goal 10. weka.filters.unsupervised.attribute.Discretize.setFindNumBins(Z)V: root-Branch
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - true
   * Goal 14. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - true
   * Goal 15. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - true
   * Goal 16. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I137 Branch 5 IFNULL L280 - true
   */

  @Test
  public void test28()  throws Throwable  {
      String[] stringArray0 = new String[9];
      stringArray0[0] = "H 1eLGnpP8i<kg0";
      stringArray0[1] = "H 1eLGnpP8i<kg0";
      stringArray0[2] = "H 1eLGnpP8i<kg0";
      stringArray0[3] = "H 1eLGnpP8i<kg0";
      stringArray0[4] = "Make resulting attributes binary.";
      stringArray0[5] = "Make resulting attributes binary.";
      stringArray0[6] = "H 1eLGnpP8i<kg0";
      stringArray0[7] = "Make resulting attributes binary.";
      stringArray0[8] = "Make resulting attributes binary.";
      Discretize.main(stringArray0);
  }
}
