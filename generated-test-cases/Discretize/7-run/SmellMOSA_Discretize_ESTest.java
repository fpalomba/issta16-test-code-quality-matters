...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tUse bin numbers rather than ranges for discreized attibutes.");
  ...
  public void test01()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instance filter that discretizes a rang of numeric attributes in the dataset iOto nominal attributes. Discretization is by simple binn/ng. Skips the class attribute if set.");
      double[] doubleArray0 = discretize0.getCutPoints((-941));
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instace filte} to>t discretizes a|rangof numerit attributes in tEedataset iOto nominal attributes. Discrtization is byaQimple binn/ng. Skips th+ class Nttribute if Cet.");
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize("data.lngth                   ");
      assertFalse(discretize0.getUseBinNumbers());
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - false
   */
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("data.lngth       k           ");
      String string0 = discretize0.getBinRangesString((-526));
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 6. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   ...
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - true
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - false
  ...
  public void test25()  throws Throwable  {
      Discretize discretize0 = new Discretize("4ata.lngth                S  ");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.input(Lweka/core/Instance;)Z: I7 Branch 18 IFNONNULL L396 - false
   */

  @Test
  public void test26()  throws Throwable  {
      SparseInstance sparseInstance0 = new SparseInstance(4188);
      Discretize discretize0 = new Discretize("data.lngth                   ");
      // Undeclared exception!
      try {
