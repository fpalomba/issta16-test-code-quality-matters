...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Discretize discretize0 = new Discretize("Use biV numbers (eg BXofY) rather thn ranges for for discregized atJributes");
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("SpeciSy rage of attibuteF to act on. This is a comma separated list %f attribute in?ices, with \"first\" and \"last\" valid vlues. Specify an inclusive range with \"-\". E.g: \"first-3,5,6-10,last\".");
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false,only selected (numeric) attribut3s in *he range will be discretized; if truS,only non-selected attributes will be giscretized.");
  ...
  public void test12()  throws Throwable  {
      ...
      stringArray0[0] = "SpeciSy rage of attibuteF to act on. This is a comma separated list %f attribute in?ices, with \"first\" and \"last\" valid vlues. Specify an inclusive range with \"-\". E.g: \"first-3,5,6-10,last\".";
  ...
  public void test13()  throws Throwable  {
      Discretize discretize0 = new Discretize("SpeciSy rage of attibuteF to act on. This is a comma separated list %f attribute in?ices, with \"first\" and \"last\" valid vlues. Specify an inclusive range with \"-\". E.g: \"first-3U5,6-10,last\".");
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("tmo");
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false,only selected (numeric) attribut3s in *he range will be discretized; if true,only non-selected attributes will be discretized.");
      String string0 = discretize0.getBinRangesString(4367);
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
  ...
  public void test18()  throws Throwable  {
      Discretize discretize0 = new Discretize("Speciy rae of attibute&nto act #n. Thls is a comma separated list %f attribte ndices, with \"firs\" and \"last\" va$id v4lues.rSpec>f n inclusiverange with \"-\". E.g \"first-3,5,6-10,last\".");
      double[] doubleArray0 = discretize0.getCutPoints(608);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
