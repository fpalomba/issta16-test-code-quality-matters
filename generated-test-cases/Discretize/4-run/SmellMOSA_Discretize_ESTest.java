...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instance filter tht discretizes a r\"nge of numerc attributes in the?ataset into eomina attribuEs. Discretizati,n is by simple binning. ips the class attrbute if set.");
  ...
  public void test02()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attributes to act on4 This is a comma separated list of attribute indices, with \"first\" a9d \"last\" valid values. SpecifT an inclusive range with \"-\".BE.g: \"first-3,5,6-10,last\".");
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attributes to act on4 This is a comma separated list of attribute indices, with \"first\" a9d \"last\" valid values. Specify an inclusive range with \"-\".BE.g: \"first-3,5,6-10,last\".");
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("w@{U)\"Lk#\"LR ;K;1dN");
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize("After combineConjp:               ");
      try {
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("Aftr combineConjp:               ");
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(1669);
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
  ...
  public void test12()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instance filter tht discretizes a r\"nge of numerc attributes in the?ataset into eomina attributEs. Discretizati,n is by simple binning. ips the class attrbute if set.");
  ...
  public void test13()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instance filter tht discretizes a r\"nge of numerc attributes in the?ataset into eomina attribuEs. Discretizati,n is by simple binning. ips the class attrbute if set.");
      String string0 = discretize0.getBinRangesString(3086);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify raXge of attributes to act on4 This ?s a comma separated list of attri'ute indices, with \"first\" a9d \"last\" valid values. Specify an inclusive range with \"-\".BE.g: \"first-3,5,6-10,last\".");
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attrbvte slection\"mode. I ualse, onl selected (numeric) attr_bute in the raAge will be discretized; if true, only non-sele#ted attributes will be d3scretized.");
  ...
  public void test18()  throws Throwable  {
      ...
      Instances instances0 = new Instances("-D", arrayList0, 5707);
      try {
  ...
  public void test20()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attrbvte slection\"mode. I ualse, onl selected (numeric) attr_bute in the raA^e will be discretized; if true, only non-sele#ted attributes will be d3scretized.");
   ...
   * Goal 15. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 16. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   * Goal 17. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - false
   * Goal 18. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - false
   * Goal 19. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - false
   * Goal 20. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I137 Branch 5 IFNULL L280 - true
   * Goal 21. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - true
   * Goal 22. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I45 Branch 7 IFEQ L301 - true
   * Goal 23. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - true
   * Goal 24. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   * Goal 25. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - true
   * Goal 26. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - true
   * Goal 27. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - false
   */

  @Test
  public void test23()  throws Throwable  {
      Discretize discretize0 = new Discretize("Us#bin numbes rather than ranges for discrized ttributes");
      String[] stringArray0 = discretize0.getOptions();
      try {
  ...
  public void test24()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute slection mode. I false, onl selected (numeric) attributes in the range will be discretized; if true, only non-selected attributes will be discretized.");
  ...
  /*
   * 3 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.getMakeBinary()Z: root-Branch
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getCapabilities()Lweka/core/Capabilities;: I34 Branch 13 IFNE L347 - false
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I7 Branch 14 IFEQ L364 - true
   */
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.binsTipText()Ljava/lang/String;: root-Branch
   */

  @Test
  public void test27()  throws Throwable  {
      Discretize discretize0 = new Discretize("Afr combfneConjp:              8");
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.main([Ljava/lang/String;)V: root-Branch
   */
