...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Instances instances0 = new Instances("F.", arrayList0, 6616);
      try {
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("data.length                   ");
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("Use bin numbrs rather than ranges for discretized attributes.");
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("QP < (CC $- __=r1 $+ __=l2 ?$-- /^[$+|CC$/=lnm ?$++ /^[$]|CC$/=rnum) <1 __=l1 < __=r2 !< (__ < (__ < __))");
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize("\tOptimize number of bins using leave-one-out estimate\n\tof estimated entropy (for equl-width discretzation).\n\tIf this is et the the -B option will be ignored.");
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false, only selected (numeric) attributes in the range will be discretized; if true, oly non-selected attributes will be discretized.");
  ...
  public void test12()  throws Throwable  {
      Discretize discretize0 = new Discretize("ta.lngth                  ");
      double[] doubleArray0 = discretize0.getCutPoints((-3300));
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize("CONJP < (CC <: /^(?i:but)$/ [ ($+ (R=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i:also|rather)$/))) ])");
      String[] stringArray0 = new String[2];
      stringArray0[0] = "CONJP < (CC <: /^(?i:but)$/ [ ($+ (R=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i:also|rather)$/))) ])";
      stringArray0[1] = "CONJP < (CC <: /^(?i:but)$/ [ ($+ (R=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i:also|rather)$/))) ])";
      Filter.runFilter((Filter) discretize0, stringArray0);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertFalse(discretize0.getInvertSelection());
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("CONJP < (CC <: /^(?i:but)$/ [ ($+ (RBhead <: ^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i:also|rather)/)J) ])");
      // Undeclared exception!
      try {
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("vata.lngth                   ");
  ...
  public void test21()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints(3629);
  ...
  /*
   * 2 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   ...
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - false
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - true
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - true
  ...
  public void test24()  throws Throwable  {
      Discretize discretize0 = new Discretize("CONJP < (CC <: /^(?f:but)$/ [ $+ (RB=head <: /^(?i:also|rather)$/)) | (+ (ADP=head <: (RB <: /^(?ialso|rather)$/)))])");
  ...
  public void test26()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Instances instances0 = new Instances("data.length                   ", arrayList0, 0);
      try {
        boolean boolean0 = discretize0.setInputFormat(instances0);
        fail("Expecting exception: Exception");
  ...
  public void test29()  throws Throwable  {
      Discretize discretize0 = new Discretize("Use bin nmbrs rather than rangs for discretized attributes.");
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.setAttributeIndicesArray([I)V: root-Branch
   */

  @Test
  public void test30()  throws Throwable  {
      Discretize discretize0 = new Discretize("-ata.length                   ");
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.getBinRangesString(I)Ljava/lang/String;: I7 Branch 26 IFNONNULL L756 - false
   */
