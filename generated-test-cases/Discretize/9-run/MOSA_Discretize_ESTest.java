...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  /*
   * 11 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I40 Branch 39 IFEQ L823 - false
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I48 Branch 40 IF_ICMPEQ L823 - false
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I56 Branch 41 IFEQ L826 - true
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I73 Branch 42 IFNE L828 - false
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.calculateCutPointsByEqualWidthBinning(I)V: I19 Branch 43 IF_ICMPGE L847 - true
   * Goal 6. weka.filters.unsupervised.attribute.Discretize.calculateCutPointsByEqualWidthBinning(I)V: I112 Branch 48 IF_ICMPLE L864 - false
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.calculateCutPointsByEqualWidthBinning(I)V: I119 Branch 49 IFLE L864 - true
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I65 Branch 82 IFEQ L1054 - false
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I73 Branch 83 IF_ICMPEQ L1054 - false
   * Goal 10. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I88 Branch 84 IFNE L1058 - false
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I95 Branch 85 IFNONNULL L1060 - false
   */
  ...
  public void test01()  throws Throwable  {
      ...
      ProtectedProperties protectedProperties0 = new ProtectedProperties(seqClassifierFlags0.props);
      Attribute attribute0 = new Attribute((String) null, protectedProperties0);
      boolean boolean0 = arrayList0.add(attribute0);
      Instances instances0 = new Instances("re-skin", arrayList0, 118807);
      Discretize discretize0 = new Discretize();
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("L+}XW-6`N\";\"-Q+<");
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(224);
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      SparseInstance sparseInstance0 = new SparseInstance((-1730.808562313), doubleArray0);
      // Undeclared exception!
      try {
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - true
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - true
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - true
   */
  ...
  public void test11()  throws Throwable  {
      ...
      stringArray0[1] = "";
      stringArray0[2] = "9Yg$)[9m0nt_^+ (]:K";
      stringArray0[3] = "Lu3B5";
   ...
   * Goal 19. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I7 Branch 14 IFEQ L364 - true
   * Goal 20. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I62 Branch 16 IFEQ L374 - true
   * Goal 21. weka.filters.unsupervised.attribute.Discretize.batchFinished()Z: I7 Branch 21 IFNONNULL L423 - true
   * Goal 22. weka.filters.unsupervised.attribute.Discretize.batchFinished()Z: I35 Branch 22 IFNONNULL L426 - false
   * Goal 23. weka.filters.unsupervised.attribute.Discretize.batchFinished()Z: I56 Branch 23 IF_ICMPGE L434 - true
   * Goal 24. weka.filters.unsupervised.attribute.Discretize.batchFinished()Z: I88 Branch 24 IFEQ L441 - true
   * Goal 25. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I21 Branch 37 IFLT L822 - true
   * Goal 26. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I21 Branch 37 IFLT L822 - false
   * Goal 27. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I31 Branch 38 IFEQ L823 - false
   * Goal 28. weka.filters.unsupervised.attribute.Discretize.calculateCutPoints()V: I40 Branch 39 IFEQ L823 - true
   * Goal 29. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I7 Branch 79 IFNONNULL L1047 - true
   * Goal 30. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I46 Branch 80 IF_ICMPGE L1053 - true
   * Goal 31. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I46 Branch 80 IF_ICMPGE L1053 - false
   * Goal 32. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I56 Branch 81 IFEQ L1054 - false
   * Goal 33. weka.filters.unsupervised.attribute.Discretize.setOutputFormat()V: I65 Branch 82 IFEQ L1054 - true
   */
  ...
  public void test24()  throws Throwable  {
      ...
      Properties properties0 = new Properties();
      SeqClassifierFlags seqClassifierFlags0 = new SeqClassifierFlags(properties0);
      Attribute attribute0 = new Attribute("Lu3B5", seqClassifierFlags0.comboProps, 3);
      boolean boolean0 = arrayList0.add(attribute0);
      Instances instances0 = new Instances("re-skin", arrayList0, 118807);
      Discretize discretize0 = new Discretize();
      assertFalse(discretize0.getMakeBinary());
