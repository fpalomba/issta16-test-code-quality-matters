...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("NbeOVX7R[");
      boolean boolean0 = discretize0.isNewBatch();
      discretize0.m_MakeBinary = true;
      HashIndex<Attribute> hashIndex0 = new HashIndex<Attribute>();
      DeltaIndex<Attribute> deltaIndex0 = new DeltaIndex<Attribute>((Index<Attribute>) hashIndex0, (Index<Attribute>) hashIndex0);
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>((Collection<? extends Attribute>) deltaIndex0);
      Instances instances0 = new Instances("NbeOVX7R[", arrayList0, 207);
      try {
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "-M";
      stringArray0[1] = "(VP (VP (VBZ Try) (NP (NP (DT this) (NN wine)) (CC and) (NP (DT these) (NNS snails)))) (PUNCT .))";
      try {
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // For input string: \"(VP (VP (VBZ Try) (NP (NP (DT this) (NN wine)) (CC and) (NP (DT these) (NNS snails)))) (PUNCT .))\"
         // Filter options:
         // 
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString(1916);
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("(VP (VP (VBZ Try) (NP (NP (DT this) (NN wine)) (CC and) (NP (DT Rhese) (NNS snails)))) (PUNCT .))");
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(30);
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  }
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(2737);
      // Undeclared exception!
      try {
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize("X%NbeOVX7R[");
      boolean boolean0 = discretize0.isNewBatch();
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of attribut(s to act on. This is a com0a separated list of attribute indices,wieh \"first\"Vand \"last\" valid values. Specify an inclusive range with \"-\". E.g: \"first-3,5,6-10,last\".");
  ...
  public void test27()  throws Throwable  {
      Discretize discretize0 = new Discretize("X%NbOVX-[");
      boolean boolean0 = discretize0.isNewBatch();
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test28()  throws Throwable  {
      ...
      Attribute attribute0 = new Attribute("4Ae");
      boolean boolean0 = arrayList0.add(attribute0);
      Instances instances0 = new Instances("4Ae", arrayList0, 207);
      Discretize discretize0 = new Discretize();
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - false
  ...
  public void test31()  throws Throwable  {
      Discretize discretize0 = new Discretize("(VP (VP (VBZ Try) (NP (NP (DT this) (NN wine)M (CC and) (NP (DT these) $NNS snails)))) (PUNCT .))");
