...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("5m's");
  ...
  public void test02()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString(6201);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints((-368));
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("wJU~,NETl;h<>>%\"M!");
  ...
  public void test06()  throws Throwable  {
      BinarySparseInstance binarySparseInstance0 = new BinarySparseInstance(574);
      Discretize discretize0 = new Discretize("edu.stanford.nlp.util.HashIndex");
      // Undeclared exception!
      try {
  ...
  public void test07()  throws Throwable  {
      ...
      Instances instances0 = new Instances("Use bin numbers (eg BXofY) rather than ranges for for discretized attributes", arrayList0, 5480);
      try {
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize("unbar");
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - false
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I85 Branch 3 IFEQ L267 - false
