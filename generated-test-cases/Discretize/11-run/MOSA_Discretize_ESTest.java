...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = discretize0.getBinRangesString((-1310));
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString((-780));
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("V");
      double[] doubleArray0 = discretize0.getCutPoints(1379);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("h!%=m0{v2h\"A}LEGxXG");
      double[][] doubleArray0 = new double[10][1];
      discretize0.m_CutPoints = doubleArray0;
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints((-625));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("]++MP9");
      double[] doubleArray0 = new double[8];
      SparseInstance sparseInstance0 = new SparseInstance((double) 160, doubleArray0);
      // Undeclared exception!
      try {
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize("dZot");
      try {
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize("l%<0o2};oVdT\"6zF[");
  ...
  public void test15()  throws Throwable  {
      ...
      try {
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: Make resulting attributes binary. of An instance filter that discretizes a range of numeric attributes in the dataset into nominal attributes. Discretization is by simple binning. Skips the class attribute if set. Make resulting attributes binary. Make resulting attributes binary. first-last first-last 
         // Filter options:
         // 
  ...
  public void test18()  throws Throwable  {
      Discretize discretize0 = new Discretize(",1!c!vbBo");
  ...
  public void test23()  throws Throwable  {
      Discretize discretize0 = new Discretize("n}-(4 bnAs");
  ...
  public void test24()  throws Throwable  {
      Discretize discretize0 = new Discretize("qa<&1qz+E;MTG\"j=");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.attributeIndicesTipText()Ljava/lang/String;: root-Branch
   */
