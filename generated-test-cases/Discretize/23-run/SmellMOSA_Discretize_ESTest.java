...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specifo rnge of attribues io ac on. This i a comma separa~ed lit of atCrbute Andices, with =first\" and \"last\" valVd values Specify Wn iclueive range wiQh \"-\". E.g first-3,5,6l1',laet\".");
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("/^UCP/=cp [ <, /JJ|ADJP/=adjp | ( <1 DT <2 /^Jo|ADJ/=adjp ) | <- (ADJP=adjp < (JJR < /^(?:younger|older)$/)) | <, /^N/=np | ( <1 DT <2 /^N/=np ) |  <, /^ADVP/=advp ]");
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection moda. Iffalse, only selected (numeric) attributes in the range will be discretized3 if rue,only non-selected attributes will be discretized.");
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString((-920));
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specifo range of attribues io ac on. This i a comma separa~ed list of attrbute Andices, with first\" and \"lwst\" valVd values Speify an iclueve range wiQh \"-\". E.g: \"first-3,5,6l1',last\".");
  ...
  public void test13()  throws Throwable  {
      Discretize discretize0 = new Discretize("/^UCP/=ucp [ <, /^JJ|ADJP/=adjp | ( <1 DT <2 /^Jo|ADJP/=adjp ) | <- (ADJP=adjp < (JJR < /^(?i:younger|older)$/)) | <, /^N/=np | ( <1 DT <2 /^N/=np ) |  <, /^ADVP/=advp ]");
      double[] doubleArray0 = discretize0.getCutPoints((-3044));
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test24()  throws Throwable  {
      ...
      stringArray0[0] = "/'UCP/=cp [ <, /^JJ|ADJP/=adjp | (0<1 DT <2 /^Jo|ADJP/=adjp ) | <- (ADJP=adjp < (JJR < /^(?i:youner|older)$/)) | <, /^N/=np | ( <1 DT <2 /^N/=np ) |  <, /^ADP/=dvp ]";
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.binsTipText()Ljava/lang/String;: root-Branch
   */
