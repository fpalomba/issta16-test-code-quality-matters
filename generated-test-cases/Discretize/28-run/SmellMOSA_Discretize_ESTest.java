...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("An inst;nce filter that discretizes a range)of nu.eric attributes in the dataset int nominal attributes. Discretization is bysimple binning. Skips the class attribute if set.");
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("exportFeatures");
      double[][] doubleArray0 = new double[9][6];
      discretize0.m_CutPoints = doubleArray0;
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints(62);
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize("Spbcify rngeof attributes to act on. Th6s is a comma separatd}li't ofattibute indices, with\"first\" and \"last\" valid values. Specify an inclusive range with \"-\". E.o: \"first-3,5,6-10,last\".");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "Spbcify rngeof attributes to act on. Th6s is a comma separatd}li't ofattibute indices, with\"first\" and \"last\" valid values. Specify an inclusive range with \"-\". E.o: \"first-3,5,6-10,last\".";
      try {
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: Spbcify rngeof attributes to act on. Th6s is a comma separatd}li't ofattibute indices, with\"first\" and \"last\" valid values. Specify an inclusive range with \"-\". E.o: \"first-3,5,6-10,last\". 
         // Filter options:
         // 
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize("P=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec.) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)");
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("        push(objecsToInstance(filered[i], getOutputFor5at()));\n");
      // Undeclared exception!
      try {
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize("Spbcify rangeof attributes to act on. Th6s is a comma sepaDated}li't ofattibute indices, with \"first\" and \"last\" valid valus. Specify an inclusive range with \"-\". E.o: \"first-3,5,6-10,last\".");
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("NP=root <1 (NP=monthdayroot <, (NNP=month <: /January|February|March|April|May|June|July|August|September|Octobr|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./) <2 (CD=day <: __)) <2 (/^,$/=co{ma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=rsot <- =yearroot) : (=monthdayroot <- =day)");
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize("        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n");
      String[] stringArray0 = new String[7];
      stringArray0[0] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      stringArray0[1] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      stringArray0[2] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      stringArray0[3] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      stringArray0[4] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      stringArray0[5] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      stringArray0[6] = "        pushlobjectsoInstance(filtered[i], getOutputFormat()));\n";
      try {
        Filter.filterFile((Filter) discretize0, stringArray0);
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options:         pushlobjectsoInstance(filtered[i], getOutputFormat()));
         //          pushlobjectsoInstance(filtered[i], getOutputFormat()));
         //          pushlobjectsoInstance(filtered[i], getOutputFormat()));
         //          pushlobjectsoInstance(filtered[i], getOutputFormat()));
         //          pushlobjectsoInstance(filtered[i], getOutputFormat()));
         //          pushlobjectsoInstance(filtered[i], getOutputFormat()));
  ...
  public void test12()  throws Throwable  {
      Discretize discretize0 = new Discretize("P=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec.) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=Pear <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)");
      String string0 = discretize0.getBinRangesString(9060);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test13()  throws Throwable  {
      ...
      Instances instances0 = new Instances("Spbcify rangeof attributes to act on. Th6s is a comma sepaDated}li't ofattibute indices, with \"first\" and \"last\" valid valus. Specify an inclusive range with \"-\". E.o: \"first-3,5,6-10,last\".", arrayList0, 2713);
      try {
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("        push(objectsToInstance(filtered[i], getOutputFormat()));\n");
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instnce filter that discretizes a range)of nu.eric attributes in the dataset int nominal attributes. Discretization is bysimple binning. Skips the class attribute if set.");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I45 Branch 7 IFEQ L301 - false
   */
  ...
  public void test22()  throws Throwable  {
      Discretize discretize0 = new Discretize("P=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)");
      double[] doubleArray0 = discretize0.getCutPoints(5);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I62 Branch 16 IFEQ L374 - true
   */
  ...
  public void test23()  throws Throwable  {
      ...
      ArrayList<Attribute> arrayList0 = new ArrayList<Attribute>();
      Attribute attribute0 = new Attribute("If st to true: eqalfrequency binning will e used instead vf e;ualRwidth binning.", 146);
      boolean boolean0 = arrayList0.add(attribute0);
      Instances instances0 = new Instances("If st to true: eqalfrequency binning will e used instead vf e;ualRwidth binning.", arrayList0, 146);
  ...
  /*
   * 1 covered goal:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - true
   */
   ...
   * Goal 24. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - false
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.globalInfo()Ljava/lang/String;: root-Branch
   */
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.attributeIndicesTipText()Ljava/lang/String;: root-Branch
   */
