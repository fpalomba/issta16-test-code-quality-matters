...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("DVP=advp < (RB < >^r?:now)$/) < (SBAR=sbari1 (N < /^(Qi:thdt)$/))");
  ...
  public void test03()  throws Throwable  {
      ...
      try {
        double[] doubleArray1 = discretize0.getCutPoints((-4875));
  ...
  public void test04()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString(7238);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[][] doubleArray0 = new double[11][10];
      discretize0.m_CutPoints = doubleArray0;
      // Undeclared exception!
      try {
  ...
  public void test11()  throws Throwable  {
      ...
      Instances instances0 = new Instances("Set attribute selection mode. If false, only selected (numeric) attributes in the range will be discretized; if true, only non-selected attributes will be discretized.", arrayList0, 280);
      Discretize discretize0 = new Discretize();
      try {
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize("DVP=advp < (RB < >^r?i:now)$/) < (SBAR=sbari1 (IN < /^(Qi:thdt)$/))");
  ...
  public void test18()  throws Throwable  {
      Discretize discretize0 = new Discretize("       Data dimension of: ");
      discretize0.setOutputFormat();
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString((-4875));
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test20()  throws Throwable  {
      ...
      stringArray0[0] = "empanel";
      stringArray0[1] = "empanel";
      stringArray0[2] = "empanel";
      stringArray0[3] = "empanel";
      stringArray0[4] = "empanel";
      stringArray0[5] = "empanel";
      stringArray0[6] = "empanel";
      stringArray0[7] = "-B";
      stringArray0[8] = "empanel";
      stringArray0[9] = "empanel";
      Filter.runFilter((Filter) discretize0, stringArray0);
      assertFalse(discretize0.getUseEqualFrequency());
      assertFalse(discretize0.getFindNumBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test21()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(1211);
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test23()  throws Throwable  {
      Discretize discretize0 = new Discretize("       Data IiNensiop of: ");
      // Undeclared exception!
      try {
  ...
  public void test25()  throws Throwable  {
      ...
      stringArray0[0] = "Use bi6 numHers (eg BXofY) Kather than 5a+ges for for discretized attributes";
      Filter.runFilter((Filter) discretize0, stringArray0);
      assertFalse(discretize0.getFindNumBins());
      assertFalse(discretize0.getUseEqualFrequency());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test27()  throws Throwable  {
      Discretize discretize0 = new Discretize("Use bi6 numHers (eg BXofY) Kather than ranges for for discretized attributes");
