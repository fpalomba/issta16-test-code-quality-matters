...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("After moveRB:                     ");
  ...
  public void test01()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode If false, onlyselected (numeric) attributes in the range will be discretized; if true, only non-selected attributes will be discretized.");
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = discretize0.getBinRangesString((-24));
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test05()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instance fiqtr tat kscreizes a ran6euofVnueric at)rDbtesin h` dattset into nomBnal atdribte. qiscretzaion is by simple bDnting. kips he class ttribute f qet.");
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize("Use bin numbers (eg BXofY) rather than ranges for for discret,zed attributes");
  ...
  public void test14()  throws Throwable  {
      Discretize discretize0 = new Discretize("Specify range of at6ributs to act on. This is a commasep9rated list o attKibute ndices, with \"first\" ad \"lastM validhvals. SpecifyNa|inclusive range with Y-\". E.g: \"first-3,5,6-s0,las \".");
  ...
  public void test15()  throws Throwable  {
      Discretize discretize0 = new Discretize("Aftermovev:                   ");
  ...
  public void test19()  throws Throwable  {
      Discretize discretize0 = new Discretize("Upecify rane of atributes to act on. This is a comma separated list of attibute indies, with \"first\" nd\"las\" valid values. SpecifyNan inclusive range with Y-\". E.g: \"first-3,5,6-10,lat\".");
   ...
   * Goal 7. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - true
   * Goal 8. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I53 Branch 2 IFEQ L260 - false
   ...
   * Goal 15. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - false
   */
  ...
  public void test22()  throws Throwable  {
      ...
      try {
        Filter.filterFile((Filter) discretize0, stringArray1);
   ...
   * Goal 9. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - true
   * Goal 10. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I45 Branch 7 IFEQ L301 - true
   * Goal 11. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I59 Branch 8 IFEQ L304 - false
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   * Goal 13. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - true
   * Goal 14. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I101 Branch 11 IFEQ L313 - true
   * Goal 15. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I157 Branch 12 IFGT L322 - false
   */
  ...
  public void test24()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If false, onlyselected (numeric) attributes in the range will be discretized; if true, only non-selected attributes will be discretized.");
      double[] doubleArray0 = discretize0.getCutPoints(3082);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - true
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.listOptions()Ljava/util/Enumeration;: I18 Branch 1 IFEQ L154 - false
   */

  @Test
  public void test25()  throws Throwable  {
      Discretize discretize0 = new Discretize("AftermoveRB:                     ");
      String[] stringArray0 = new String[1];
      try {
   ...
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.setInputFormat(Lweka/core/Instances;)Z: I7 Branch 14 IFEQ L364 - true
   */
