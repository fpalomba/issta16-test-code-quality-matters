...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
   ...
   * Goal 25. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - false
  ...
  public void test01()  throws Throwable  {
      ...
      stringArray0[0] = "An instance filter that discretizes a range of numericattibutes in t}e dataset into nominal attributes. Discretiation is by simple binning= Skips the class attribuZe if set.";
      try {
        Filter.filterFile((Filter) discretize0, stringArray0);
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: An instance filter that discretizes a range of numericattibutes in t}e dataset into nominal attributes. Discretiation is by simple binning= Skips the class attribuZe if set. 
         // Filter options:
         // 
         // -unset-class-temporarily
         // \tUnsets the class index temporarily before the filter is
  ...
  public void test03()  throws Throwable  {
      ...
      Discretize discretize0 = new Discretize("G)`,paU{p,H\"0IT>:");
      boolean boolean0 = capabilities_Capability0.isClass();
      discretize0.setMakeBinary(true);
      double[] doubleArray0 = new double[9];
      int[] intArray0 = new int[13];
      SparseInstance sparseInstance0 = new SparseInstance((double) 0, doubleArray0, intArray0, 228);
      Instances instances0 = sparseInstance0.dataset();
      try {
  ...
  public void test06()  throws Throwable  {
      ...
      try {
        double[] doubleArray1 = discretize0.getCutPoints((-467));
  ...
  public void test08()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(396);
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test09()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString(248);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  ...
  public void test13()  throws Throwable  {
      Discretize discretize0 = new Discretize("sA'cBO5SKYX,-H9$]Dz");
  ...
  public void test14()  throws Throwable  {
      ...
      SparseInstance sparseInstance0 = new SparseInstance(4740.1894, doubleArray0);
      Instances instances0 = sparseInstance0.dataset();
      try {
  ...
  public void test18()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String[] stringArray0 = new String[6];
      stringArray0[0] = "\nGeneral Nptions:\n\n-h\n\tGet help on available options.\n-i <filename>\n\tThe file containing first input instances.\n-o <filename>\n\tThe file first output instances wiUl be written to.\n-r <filename>\n\tThe file containing second input instances.\n-s <filename>\n\tThe file second output instances will be written to.\n-c <class index>\n\tThe number of the attribute to use as the class.\n\tfirst\" and \"last\" are also valid entries.\n\tIf not supplied then no class is assigned.\n";
      stringArray0[1] = "\nGeneral Nptions:\n\n-h\n\tGet help on available options.\n-i <filename>\n\tThe file containing first input instances.\n-o <filename>\n\tThe file first output instances wiUl be written to.\n-r <filename>\n\tThe file containing second input instances.\n-s <filename>\n\tThe file second output instances will be written to.\n-c <class index>\n\tThe number of the attribute to use as the class.\n\tfirst\" and \"last\" are also valid entries.\n\tIf not supplied then no class is assigned.\n";
      stringArray0[2] = "\nGeneral Nptions:\n\n-h\n\tGet help on available options.\n-i <filename>\n\tThe file containing first input instances.\n-o <filename>\n\tThe file first output instances wiUl be written to.\n-r <filename>\n\tThe file containing second input instances.\n-s <filename>\n\tThe file second output instances will be written to.\n-c <class index>\n\tThe number of the attribute to use as the class.\n\tfirst\" and \"last\" are also valid entries.\n\tIf not supplied then no class is assigned.\n";
      stringArray0[3] = "\nGeneral Nptions:\n\n-h\n\tGet help on available options.\n-i <filename>\n\tThe file containing first input instances.\n-o <filename>\n\tThe file first output instances wiUl be written to.\n-r <filename>\n\tThe file containing second input instances.\n-s <filename>\n\tThe file second output instances will be written to.\n-c <class index>\n\tThe number of the attribute to use as the class.\n\tfirst\" and \"last\" are also valid entries.\n\tIf not supplied then no class is assigned.\n";
      stringArray0[4] = "\nGeneral Nptions:\n\n-h\n\tGet help on available options.\n-i <filename>\n\tThe file containing first input instances.\n-o <filename>\n\tThe file first output instances wiUl be written to.\n-r <filename>\n\tThe file containing second input instances.\n-s <filename>\n\tThe file second output instances will be written to.\n-c <class index>\n\tThe number of the attribute to use as the class.\n\tfirst\" and \"last\" are also valid entries.\n\tIf not supplied then no class is assigned.\n";
  ...
  /*
   * 2 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I87 Branch 10 IFEQ L310 - true
  ...
  public void test29()  throws Throwable  {
      ...
      Instances instances0 = new Instances("&6e3WYXSmEF#YkUf", arrayList0, 0);
      Discretize discretize0 = new Discretize();
      try {
   ...
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.getMakeBinary()Z: root-Branch
   * Goal 5. weka.filters.unsupervised.attribute.Discretize.getCapabilities()Lweka/core/Capabilities;: I34 Branch 13 IFNE L347 - true
   */
  ...
  public void test30()  throws Throwable  {
      ...
      assertEquals((-1.0), discretize1.getDesiredWeightOfInstancesPerInterval(), 0.01D);
  }
}
