...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("       Batches per pass througI Rata:  ");
  ...
  public void test06()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString(292);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test11()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(2566);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test12()  throws Throwable  {
      ...
      stringArray0[0] = "Spscify range of attributs tM act on. Th5s is a comma separted lUst of attrbute indices, with \"firs`\" ?nd \" ast\" vali alues. pcify an inclusive fMnge with \"-\". E.g: \"first-3,5,6-10,last\".";
      try {
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: Spscify range of attributs tM act on. Th5s is a comma separted lUst of attrbute indices, with \"firs`\" ?nd \" ast\" vali alues. pcify an inclusive fMnge with \"-\". E.g: \"first-3,5,6-10,last\". 
         // Filter options:
         // 
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString(2275);
  ...
  public void test21()  throws Throwable  {
      Discretize discretize0 = new Discretize("Error loading classifier fro jar fil (most likey you are not running this code from a jar file or te named classifier is not stored in the jar file)");
      String[] stringArray0 = discretize0.getOptions();
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints(220);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.batchFinished()Z: I7 Branch 21 IFNONNULL L423 - false
   */
   ...
   * Goal 12. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - false
