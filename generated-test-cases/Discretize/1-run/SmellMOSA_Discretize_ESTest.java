...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
   ...
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.setOptions([Ljava/lang/String;)V: I114 Branch 4 IFEQ L274 - false
   */
  ...
  public void test02()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If fal+e, only selected (numeric) attributes n the range will be discretized; if tQu6, only non-s3lected attributes will bediscretized.");
  ...
  public void test17()  throws Throwable  {
      ...
      stringArray0[0] = "push(objectsToInstance(filtered[i],getOutptFormat()));";
      stringArray0[1] = "push(objectsToInstance(filtered[i],getOutptFormat()));";
      stringArray0[2] = "-M";
      stringArray0[3] = "push(objectsToInstance(filtered[i],getOutptFormat()));";
      stringArray0[4] = "-M";
      stringArray0[5] = "-M";
      stringArray0[6] = "push(objectsToInstance(filtered[i],getOutptFormat()));";
      stringArray0[7] = "push(objectsToInstance(filtered[i],getOutptFormat()));";
      stringArray0[8] = "push(objectsToInstance(filtered[i],getOutptFormat()));";
      try {
        Filter.filterFile((Filter) discretize0, stringArray0);
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // For input string: \"push(objectsToInstance(filtered[i],getOutptFormat()));\"
         // Filter options:
         // 
         // -unset-class-temporarily
         // \tUnsets the class index temporarily before the filter is
  ...
  /*
   * 11 covered goals:
   * Goal 1. weka.filters.unsupervised.attribute.Discretize.setDesiredWeightOfInstancesPerInterval(D)V: root-Branch
   * Goal 2. weka.filters.unsupervised.attribute.Discretize.setMakeBinary(Z)V: root-Branch
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.setInvertSelection(Z)V: root-Branch
  ...
  public void test20()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      String string0 = discretize0.getBinRangesString(144);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test25()  throws Throwable  {
      Discretize discretize0 = new Discretize("Use bin numbers (eg BXofY) rather an ranges for for discretized attributes");
  ...
  public void test26()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attribute selection mode. If fals, only selected (numeric) attributes in the range will be discretized; if tQu6, only non-selected attributes will be dicretized.");
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - true
   */

  @Test
  public void test28()  throws Throwable  {
      Discretize discretize0 = new Discretize("        JushobjectsToInstance(fl1eNe%&i], getOututF_rsat());");
      assertFalse(discretize0.getUseBinNumbers());
   ...
   * Goal 14. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I73 Branch 9 IFEQ L307 - false
  ...
  public void test29()  throws Throwable  {
      Discretize discretize0 = new Discretize("Sfecify rang of attributes to acK on. Thih is a comma separated list of attriBute indices,/with Mfirst\" and\"last\" val.d ulues. Specify an inclusive r.ng1 with \"-\". Eg: \"first-3,5,6-10,last\".");
   ...
   * Goal 3. weka.filters.unsupervised.attribute.Discretize.getCutPoints(I)[D: I7 Branch 25 IFNONNULL L741 - false
   */

  @Test
  public void test30()  throws Throwable  {
      Discretize discretize0 = new Discretize();
      double[] doubleArray0 = discretize0.getCutPoints(194);
      assertFalse(discretize0.getMakeBinary());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getUseBinNumbers());
