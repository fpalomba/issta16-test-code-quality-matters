...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Discretize discretize0 = new Discretize("%p&IYfRKI2 ^/& ");
      String string0 = discretize0.getBinRangesString(202);
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getMakeBinary());
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test03()  throws Throwable  {
      Discretize discretize0 = new Discretize("bp&IYfRKI2 ^/& ");
      double[] doubleArray0 = discretize0.getCutPoints(3164);
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test05()  throws Throwable  {
      ...
      DenseInstance denseInstance0 = new DenseInstance((double) 202, doubleArray0);
      // Undeclared exception!
      try {
  ...
  public void test13()  throws Throwable  {
      ...
      stringArray0[0] = "|~m";
      stringArray0[1] = "|~m";
      stringArray0[2] = "After collapse multi conj:";
      stringArray0[3] = "After collapse multi conj:";
      stringArray0[4] = "|~m";
      stringArray0[5] = "|~m";
      try {
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // 
         // Illegal options: |~m |~m After collapse multi conj: After collapse multi conj: |~m |~m 
         // Filter options:
         // 
