...
public class Discretize_ESTest extends Discretize_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Discretize discretize0 = new Discretize("An instance filter that discretizes a range ofjnumeric attributes in the dataset into nomina attributes. Discretization is b simple binning. Skips the class attribu+e if set.");
  ...
  public void test07()  throws Throwable  {
      Discretize discretize0 = new Discretize("Set attibtW selection mode. If false, only selected (numeric) atributes in t:e range will be discretized; if true, only non-selectd attriutes will be discretized.");
      discretize0.setOutputFormat();
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getUseBinNumbers());
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        double[] doubleArray1 = discretize0.getCutPoints(907);
  ...
  public void test10()  throws Throwable  {
      Discretize discretize0 = new Discretize("ftrchangebarTPP:             ");
  ...
  public void test16()  throws Throwable  {
      Discretize discretize0 = new Discretize("fter changeSbarTPP:             ");
  ...
  public void test17()  throws Throwable  {
      Discretize discretize0 = new Discretize("U|[\"pe zW");
      String string0 = discretize0.getBinRangesString((-2564));
      assertFalse(discretize0.getUseBinNumbers());
      assertEquals(10, discretize0.getBins());
      assertEquals((-1.0), discretize0.getDesiredWeightOfInstancesPerInterval(), 0.01D);
      assertFalse(discretize0.getMakeBinary());
  ...
  public void test22()  throws Throwable  {
      Discretize discretize0 = new Discretize("7Q-iXXT{rF");
      double[][] doubleArray0 = new double[18][7];
      discretize0.m_CutPoints = doubleArray0;
      // Undeclared exception!
      try {
        String string0 = discretize0.getBinRangesString(161);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test23()  throws Throwable  {
      Discretize discretize0 = new Discretize("Optim\"ze number of equal-width bins usipg leave-one-out. Doesnt work for eq5al-freuency binning");
      try {
   ...
   * Goal 4. weka.filters.unsupervised.attribute.Discretize.<init>(Ljava/lang/String;)V: root-Branch
   ...
   * Goal 25. weka.filters.unsupervised.attribute.Discretize.getOptions()[Ljava/lang/String;: I22 Branch 6 IF_ICMPGE L298 - false
  ...
  public void test29()  throws Throwable  {
      Discretize discretize0 = new Discretize("fter chajge`barT_P:             ");
