...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("u(Wb?:HYf", true);
  ...
  public void test01()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("PreIcrementxpression", true);
      simpleNode0.dump("zSs?w$-8Nth$", (Writer) mockFileWriter0);
  ...
  public void test02()  throws Throwable  {
      ...
      MockFileWriter mockFileWriter0 = new MockFileWriter("ClassOrInterfaceDeclaration", true);
      boolean boolean0 = arrayList0.add(">=");
      simpleNode0.dump("qN!~aD&~W}uX", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test03()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(0);
      simpleNode0.setIdentifier("<=");
      MockFileWriter mockFileWriter0 = new MockFileWriter("CompilationUnit", true);
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter((Writer) mockFileWriter0, true);
      simpleNode0.dump("d><2qxTz", (Writer) mockPrintWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("<<");
      MockFileWriter mockFileWriter0 = new MockFileWriter("C=-^=p<~k(0,", false);
      simpleNode0.dump("nullTypeDeclaration", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test05()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(0);
      simpleNode0.setIdentifier("<");
      MockFileWriter mockFileWriter0 = new MockFileWriter("C=^=Gp<~k0,", false);
      simpleNode0.dump("nullCompilationUnit", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      MockFile mockFile0 = new MockFile("ResultType");
      MockFileWriter mockFileWriter0 = new MockFileWriter((File) mockFile0, true);
      simpleNode0.dump("VariableDeclaratorId", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test07()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(27);
      simpleNode0.setIdentifier("");
      MockFileWriter mockFileWriter0 = new MockFileWriter("Initializer", true);
      simpleNode0.dump("Initializer", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test08()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(27);
      simpleNode0.setIdentifier("{");
      MockFileWriter mockFileWriter0 = new MockFileWriter("Initializer", false);
      simpleNode0.dump("Initializer", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      simpleNode0.setIdentifier(";");
      MockFileWriter mockFileWriter0 = new MockFileWriter("ExclusiveOrExpression", false);
      simpleNode0.dump(";", (Writer) mockFileWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals("ResultTypeVariableDeclaratorId : VariableDeclaratorId", string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      SimpleNode simpleNode0 = new SimpleNode(javaParser0, 1100);
  ...
  public void test14()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((-1401));
  ...
  public void test15()  throws Throwable  {
      ...
      simpleNode0.jjtAddChild((Node) null, 1586);
      assertEquals(1587, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test16()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(44);
      simpleNode0.jjtAddChild((Node) simpleNode0, 44);
      simpleNode0.jjtAddChild((Node) simpleNode0, 44);
  ...
  public void test17()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(2397);
   ...
   * Goal 12. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I136 Branch 15 IFLE L121 - false
