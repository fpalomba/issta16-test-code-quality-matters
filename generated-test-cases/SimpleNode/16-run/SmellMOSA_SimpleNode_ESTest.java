...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try {
        simpleNode0.dump("*rshft", (Writer) stringWriter0);
  ...
  public void test01()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((int) (byte)20);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
      
      simpleNode0.setIdentifier("|q.v(yo");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      
      StringWriter stringWriter0 = new StringWriter((int) (byte)20);
      assertEquals("", stringWriter0.toString());
      assertNotNull(stringWriter0);
      
      BufferedWriter bufferedWriter0 = new BufferedWriter((Writer) stringWriter0, (int) (byte)20);
      assertEquals("", stringWriter0.toString());
      assertNotNull(bufferedWriter0);
      
      simpleNode0.dump("|q.v(yo", (Writer) bufferedWriter0);
      assertEquals("<ArrayInitializer>\n  <identifier>|q.v(yo</identifier>\n</Arra", stringWriter0.toString());
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test05()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(1831);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
  ...
  public void test08()  throws Throwable  {
      ...
      simpleNode0.jjtAddChild((Node) simpleNode0, 1102);
      assertEquals(1103, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      simpleNode0.dump("After moveRB:                     ", (Writer) stringWriter0);
      assertEquals("", stringWriter0.toString());
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      String string0 = simpleNode0.toString("After moveRB:                     ");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(string0);
      assertEquals("After moveRB:                     VariableDeclaratorId", string0);
  }
   ...
   * Goal 13. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I149 Branch 16 IFLE L124 - false
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        Node node0 = simpleNode0.jjtGetChild(1102);
