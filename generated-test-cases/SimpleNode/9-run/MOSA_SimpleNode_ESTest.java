...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      JavaParser javaParser0 = new JavaParser("jFuX,hk5S7=o}K~KW)");
      SimpleNode simpleNode0 = new SimpleNode(javaParser0, 6276);
      ...
      MockFile mockFile0 = (MockFile)objectBank_PathToFileFunction0.apply("jFuX,hk5S7=o}K~KW)");
      MockFileWriter mockFileWriter0 = new MockFileWriter((File) mockFile0, false);
      simpleNode1.dump("|6VEFt", (Writer) mockFileWriter0);
      assertEquals(6, simpleNode1.jjtGetNumChildren());
  }
  ...
  public void test01()  throws Throwable  {
      ...
      StringWriter stringWriter0 = new StringWriter(9325);
      simpleNode0.dump("NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearnp <: (CD=year <: __)) : =root <- =yearnp", (Writer) stringWriter0);
  ...
  public void test03()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("<=");
      StringWriter stringWriter0 = new StringWriter(3421);
  ...
  public void test06()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("<");
      StringWriter stringWriter0 = new StringWriter(2906);
      simpleNode0.dump("<", (Writer) stringWriter0);
  ...
  public void test07()  throws Throwable  {
      ...
      simpleNode0.setIdentifier(">");
      StringWriter stringWriter0 = new StringWriter(9325);
      simpleNode0.dump("NP=root <1 (NP <: (NNP=month <: /January|February|March|Ap$il|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (P=yearnp <: (CD=year <: __)) : =root <- =yearnp", (Writer) stringWriter0);
  ...
  public void test08()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("");
      ObjectBank.PathToFileFunction objectBank_PathToFileFunction0 = new ObjectBank.PathToFileFunction();
      MockFile mockFile0 = (MockFile)objectBank_PathToFileFunction0.apply("ly:hB^ezu?");
      MockFileWriter mockFileWriter0 = new MockFileWriter((File) mockFile0, false);
      simpleNode0.dump("jFuX,hk5S7=o}K~KW)", (Writer) mockFileWriter0);
  ...
  public void test12()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("");
      StringWriter stringWriter0 = new StringWriter(9339);
      simpleNode0.dump("NP=root <1 (NP<: (NNP=month <: /January|February|March|Ap$il|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (P=yearnp <: (CD=year <: __)) : =root <- =yearnp", (Writer) stringWriter0);
  ...
  public void test17()  throws Throwable  {
      JavaParser javaParser0 = new JavaParser(".#Miw~");
      SimpleNode simpleNode0 = new SimpleNode(javaParser0, 0);
      simpleNode0.jjtAddChild((Node) null, 0);
      simpleNode0.jjtAddChild((Node) null, 2321);
      assertEquals(2322, simpleNode0.jjtGetNumChildren());
  }
   ...
   * Goal 10. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I107 Branch 12 IFLE L114 - false
   * Goal 11. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I114 Branch 13 IFGT L114 - false
   ...
   * Goal 16. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I175 Branch 18 IFLE L130 - true
   * Goal 17. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I188 Branch 19 IFLE L133 - false
   * Goal 18. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I201 Branch 20 IFGT L136 - false
   * Goal 19. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I208 Branch 21 IFLE L136 - true
