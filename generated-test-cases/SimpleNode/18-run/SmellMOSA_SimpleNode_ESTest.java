...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("Tt[vs&I&emT~=QEin");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      ...
      simpleNode0.dump("Tt[vs&I&emT~=QEin", (Writer) charArrayWriter0);
      assertEquals(92, charArrayWriter0.size());
      assertEquals("<VariableDeclaratorId>\n  <identifier>Tt[vs&I&emT~=QEin</identifier>\n</VariableDeclaratorId>\n", charArrayWriter0.toString());
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      simpleNode0.jjtAddChild(nodeArray0[7], 8299);
      assertEquals(8300, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test03()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((int) (byte)125);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
      
      simpleNode0.dump("w-nonl set spans $ trees which use Co [Label", (Writer) null);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      simpleNode0.dump("outslwel", (Writer) stringWriter0);
      assertEquals(7, simpleNode0.jjtGetNumChildren());
  ...
  public void test07()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(1617);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
      
      simpleNode0.jjtAddChild((Node) simpleNode0, 1617);
      assertEquals(1618, simpleNode0.jjtGetNumChildren());
  ...
  public void test08()  throws Throwable  {
      ...
      simpleNode0.dump("MatrixIX", (Writer) stringWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  ...
  public void test09()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((int) (byte) (-113));
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
  ...
  public void test11()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((int) (byte) (-97));
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
      
      // Undeclared exception!
      try {
        Node node0 = simpleNode0.jjtGetChild((int) (byte) (-97));
  ...
  public void test12()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("invalid format: ||");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      
      String string0 = simpleNode0.toString("invalid format: ||");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertEquals("invalid format: ||CompilationUnit : invalid format: ||", string0);
  ...
  public void test13()  throws Throwable  {
      ...
      simpleNode0.dump("invalid format: ||", (Writer) charArrayWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertEquals(83, charArrayWriter0.size());
      assertEquals("<CompilationUnit>\n  <identifier>invalid format: ||</identifier>\n</CompilationUnit>\n", charArrayWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((int) (byte) (-71));
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
  ...
  public void test15()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((int) (byte) (-98));
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        simpleNode0.dump("zfX!x2Gr<QB", (Writer) stringWriter0);
