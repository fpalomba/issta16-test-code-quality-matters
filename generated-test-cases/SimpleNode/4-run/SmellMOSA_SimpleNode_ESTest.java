...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)objectBank_PathToFileFunction0.apply("CompilationUnit : <");
      ...
      assertEquals("CompilationUnit : <", mockFile0.toString());
      ...
      simpleNode0.dump("CompilationUnit : <", (Writer) mockPrintWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertEquals(0L, mockFile0.getTotalSpace());
      assertEquals("CompilationUnit : <", mockFile0.getName());
      assertEquals(1392409281320L, mockFile0.lastModified());
  ...
  public void test03()  throws Throwable  {
      ...
      OutputStreamWriter outputStreamWriter0 = new OutputStreamWriter((OutputStream) pipedOutputStream0, charset0);
      assertEquals(0, pipedInputStream0.available());
      assertEquals("UTF-8", charset0.toString());
      assertTrue(charset0.isRegistered());
      assertEquals("UTF-8", charset0.name());
  ...
  public void test04()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((-3587));
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
  ...
  public void test05()  throws Throwable  {
      ...
      simpleNode0.jjtAddChild((Node) simpleNode1, 12);
      assertEquals(13, simpleNode0.jjtGetNumChildren());
      assertEquals(0, simpleNode1.jjtGetNumChildren());
  ...
  public void test06()  throws Throwable  {
      ...
      String string0 = simpleNode0.toString("Can't rturn head of null orleaf Tree.");
      assertEquals("Can't rturn head of null orleaf Tree.Modifiers", string0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      simpleNode0.setIdentifier(">j-.-|:\"N");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      
      String string0 = simpleNode0.toString();
      assertEquals("Literal : >j-.-|:\"N", string0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(string0);
      
      MockPrintStream mockPrintStream0 = new MockPrintStream("Literal : >j-.-|:\"N");
      assertNotNull(mockPrintStream0);
      
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter((OutputStream) mockPrintStream0);
      assertNotNull(mockPrintWriter0);
      
      simpleNode0.dump(">j-.-|:\"N", (Writer) mockPrintWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      simpleNode0.dump("d", (Writer) mockPrintWriter0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertTrue(mockFile0.canExecute());
      assertEquals("CompilationUnit : <=", mockFile0.toString());
      assertFalse(mockFile0.isAbsolute());
  ...
  public void test11()  throws Throwable  {
      ...
      simpleNode0.setIdentifier("@\"my~");
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      
      String string0 = simpleNode0.toString();
      assertEquals("TypeBound : @\"my~", string0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(string0);
      
      MockFile mockFile0 = (MockFile)MockFile.createTempFile("@\"my~", "TypeBound : @\"my~");
      assertEquals("/var/folders/ff/jvqmt14176q7vr5d_h1h729c0000gn/T", mockFile0.getParent());
      assertTrue(mockFile0.isAbsolute());
      assertTrue(mockFile0.canExecute());
      assertFalse(mockFile0.isHidden());
      assertEquals(0L, mockFile0.getFreeSpace());
      assertEquals("/var/folders/ff/jvqmt14176q7vr5d_h1h729c0000gn/T/@\"my~0TypeBound : @\"my~", mockFile0.toString());
      assertEquals(0L, mockFile0.getUsableSpace());
      assertTrue(mockFile0.canWrite());
      assertEquals("@\"my~0TypeBound : @\"my~", mockFile0.getName());
      assertFalse(mockFile0.isDirectory());
      assertEquals(0L, mockFile0.length());
      assertTrue(mockFile0.exists());
      assertTrue(mockFile0.isFile());
      ...
      simpleNode0.dump("@\"my~", (Writer) mockPrintWriter0);
      assertEquals("/var/folders/ff/jvqmt14176q7vr5d_h1h729c0000gn/T", mockFile0.getParent());
      assertTrue(mockFile0.isAbsolute());
      assertTrue(mockFile0.canExecute());
      assertFalse(mockFile0.isHidden());
   ...
   * Goal 14. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I136 Branch 15 IFLE L121 - false
  ...
  public void test14()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((-826));
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      assertNotNull(simpleNode0);
      
      boolean boolean0 = simpleNode0.identifiers.add("`:N<<>xGOU?/");
      assertTrue(boolean0);
      assertEquals(0, simpleNode0.jjtGetNumChildren());
      
      // Undeclared exception!
      try {
        simpleNode0.dump("`:N<<>xGOU?/", (Writer) null);
