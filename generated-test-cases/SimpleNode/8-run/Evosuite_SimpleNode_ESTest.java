...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try {
        simpleNode0.dump("  <identifier>", (Writer) mockPrintWriter0);
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)MockFile.createTempFile("Literal", "Literal");
      MockFileWriter mockFileWriter0 = new MockFileWriter((File) mockFile0, true);
      simpleNode0.dump("Literal", (Writer) mockFileWriter0);
  ...
  public void test04()  throws Throwable  {
      ...
      simpleNode0.setIdentifier(">");
      MockFile mockFile0 = new MockFile("VariableDeclaratorId", "m{:\"");
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter((File) mockFile0);
   ...
   * Goal 3. com.soops.CEN4010.JMCA.JParser.SimpleNode.dump(Ljava/lang/String;Ljava/io/Writer;)V: I95 Branch 11 IFGT L111 - true
   */
  ...
  public void test09()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(5166);
      simpleNode0.jjtAddChild((Node) simpleNode0, 5166);
      simpleNode0.jjtAddChild((Node) simpleNode0, 5166);
      assertEquals(5167, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      Node[] nodeArray0 = new Node[2];
      simpleNode0.children = nodeArray0;
      simpleNode0.jjtAddChild(nodeArray0[0], 5166);
      assertEquals(5167, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test14()  throws Throwable  {
      JavaParser javaParser0 = new JavaParser("eat");
      SimpleNode simpleNode0 = new SimpleNode(javaParser0, 12);
      String string0 = simpleNode0.toString("eat");
      assertEquals("eatTypeParameter", string0);
  }
  ...
  public void test15()  throws Throwable  {
      JavaParser javaParser0 = new JavaParser("eat");
      SimpleNode simpleNode0 = new SimpleNode(javaParser0, 12);
      simpleNode0.setIdentifier("eat");
      String string0 = simpleNode0.toString("eat");
      assertEquals("eatTypeParameter : eat", string0);
  }
