...
public class SimpleNode_ESTest extends SimpleNode_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(2198);
      simpleNode0.id = 2198;
      simpleNode0.jjtAddChild((Node) simpleNode0, 2960);
      simpleNode0.id = 0;
      CharArrayWriter charArrayWriter0 = new CharArrayWriter();
      // Undeclared exception!
      try {
        simpleNode0.dump("5|x[wQAR/*CA~N'", (Writer) charArrayWriter0);
  ...
  public void test01()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(2198);
      simpleNode0.id = 2198;
      simpleNode0.jjtAddChild((Node) null, 2198);
      simpleNode0.id = 0;
      CharArrayWriter charArrayWriter0 = new CharArrayWriter();
      simpleNode0.dump("5|x[wQAR/*CA~N'", (Writer) charArrayWriter0);
      assertEquals(2199, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)objectBank_PathToFileFunction0.apply("gs");
      MockFileWriter mockFileWriter0 = new MockFileWriter((File) mockFile0);
      simpleNode0.dump("gs", (Writer) mockFileWriter0);
  ...
  public void test04()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode(2198);
      simpleNode0.id = 2198;
      simpleNode0.setIdentifier("5|x[wQAR/*CA~N'");
      simpleNode0.id = 0;
      CharArrayWriter charArrayWriter0 = new CharArrayWriter();
      simpleNode0.dump("5|x[wQAR/*CA~N'", (Writer) charArrayWriter0);
      assertEquals(80, charArrayWriter0.size());
      assertEquals("<CompilationUnit>\n  <identifier>5|x[wQAR/*CA~N'</identifier>\n</CompilationUnit>\n", charArrayWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("CompilationUnit : 5|x[wQAR/*CA~N'", string0);
  }
  ...
  public void test08()  throws Throwable  {
      SimpleNode simpleNode0 = new SimpleNode((-984));
  ...
  public void test10()  throws Throwable  {
      ...
      simpleNode0.jjtAddChild((Node) null, 2198);
      simpleNode0.jjtAddChild((Node) simpleNode0, 2960);
      assertEquals(2961, simpleNode0.jjtGetNumChildren());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        Node node0 = simpleNode0.jjtGetChild(1584);
