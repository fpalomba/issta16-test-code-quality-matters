...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("A LaqQXl k Fn", "A LaqQXl k Fn", (InetAddress) inet4Address0);
      assertNotNull(usernamePasswordToken0);
      assertEquals("127.0.0.1", inet4Address0.getHostAddress());
      assertFalse(inet4Address0.isMCSiteLocal());
      assertFalse(inet4Address0.isMCNodeLocal());
      ...
      assertFalse(inet4Address0.isMCOrgLocal());
      assertTrue(inet4Address0.isLoopbackAddress());
      assertEquals("A LaqQXl k Fn", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      ...
      assertEquals("A LaqQXl k Fn", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - A LaqQXl k Fn, rememberMe=false (/127.0.0.1)", string0);
  }
  ...
  public void test10()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("7J >a UQX@ ek i%F", "7J >a UQX@ ek i%F");
      assertNotNull(usernamePasswordToken0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("7J >a UQX@ ek i%F", usernamePasswordToken0.getUsername());
      
      usernamePasswordToken0.setUsername("7J >a UQX@ ek i%F");
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("7J >a UQX@ ek i%F", usernamePasswordToken0.getUsername());
  }
  ...
  public void test11()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("7d ka qX@ e F", "7d ka qX@ e F");
      assertNotNull(usernamePasswordToken0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("7d ka qX@ e F", usernamePasswordToken0.getUsername());
