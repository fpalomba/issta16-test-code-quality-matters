...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("Nz{WuN)i7#+47{m3sl5", charArray0, (InetAddress) inet4Address0);
      assertFalse(inet4Address0.isAnyLocalAddress());
      assertFalse(inet4Address0.isMCOrgLocal());
      assertFalse(inet4Address0.isMCSiteLocal());
      assertFalse(inet4Address0.isMCGlobal());
      ...
      assertFalse(inet4Address0.isMCNodeLocal());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("Nz{WuN)i7#+47{m3sl5", usernamePasswordToken0.getUsername());
      assertNotNull(usernamePasswordToken0);
  ...
  public void test05()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("5g   ", "5g   ", (InetAddress) inet4Address0);
      assertEquals("/192.168.1.42", inet4Address0.toString());
      assertEquals("192.168.1.42", inet4Address0.getHostAddress());
      assertFalse(inet4Address0.isMCGlobal());
      assertFalse(inet4Address0.isMCLinkLocal());
      ...
      assertFalse(inet4Address0.isLinkLocalAddress());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("5g   ", usernamePasswordToken0.getUsername());
      assertNotNull(usernamePasswordToken0);
      ...
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("5g   ", usernamePasswordToken0.getUsername());
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - 5g   , rememberMe=false (/192.168.1.42)", string0);
  ...
  public void test12()  throws Throwable  {
      ...
      assertEquals("_   ", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
  ...
  public void test14()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("_@b   ", "_@b   ");
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
      
      usernamePasswordToken0.setUsername("_@b   ");
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
}
