...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      assertEquals("}5[  ", usernamePasswordToken0.getUsername());
  ...
  public void test06()  throws Throwable  {
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.getByName(" )Z ");
      assertFalse(inet4Address0.isMCGlobal());
      assertFalse(inet4Address0.isMulticastAddress());
      assertFalse(inet4Address0.isSiteLocalAddress());
      assertFalse(inet4Address0.isMCSiteLocal());
      ...
      assertEquals("200.42.42.0", inet4Address0.getHostAddress());
      assertFalse(inet4Address0.isLinkLocalAddress());
      assertEquals(" )Z /200.42.42.0", inet4Address0.toString());
      assertFalse(inet4Address0.isMCOrgLocal());
      assertNotNull(inet4Address0);
      
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken(" )Z ", " )Z ", (InetAddress) inet4Address0);
      assertFalse(inet4Address0.isMCGlobal());
      assertFalse(inet4Address0.isMulticastAddress());
      assertFalse(inet4Address0.isSiteLocalAddress());
      assertFalse(inet4Address0.isMCSiteLocal());
      ...
      assertEquals(" )Z /200.42.42.0", inet4Address0.toString());
      assertFalse(inet4Address0.isMCOrgLocal());
      assertEquals(" )Z ", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
      ...
      assertEquals("org.jsecurity.authc.UsernamePasswordToken -  )Z , rememberMe=false ( )Z /200.42.42.0)", string0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("[/Q v ", charArray0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("[/Q v ", usernamePasswordToken0.getUsername());
      assertArrayEquals(new char[] {'\u0000', '\u0000'}, charArray0);
      assertNotNull(usernamePasswordToken0);
  }
  ...
  public void test08()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("d}5[   ", "d}5[   ");
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("d}5[   ", usernamePasswordToken0.getUsername());
      assertNotNull(usernamePasswordToken0);
