...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("e X ", charArray0, false);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("e X ", usernamePasswordToken0.getUsername());
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000', '\u0000', '\u0000'}, charArray0);
      assertNotNull(usernamePasswordToken0);
  }
  ...
  public void test05()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("& X ", charArray0);
      assertEquals("& X ", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000', '\u0000', '\u0000', '\u0000'}, charArray0);
      assertNotNull(usernamePasswordToken0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken(", remCm5rMe", charArray0, (InetAddress) inet4Address0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals(", remCm5rMe", usernamePasswordToken0.getUsername());
      assertEquals("/192.168.1.42", inet4Address0.toString());
      assertFalse(inet4Address0.isMCNodeLocal());
      assertFalse(inet4Address0.isLinkLocalAddress());
      assertFalse(inet4Address0.isMCOrgLocal());
  ...
  public void test14()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("&L (5 ", "&L (5 ");
      assertEquals("&L (5 ", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
