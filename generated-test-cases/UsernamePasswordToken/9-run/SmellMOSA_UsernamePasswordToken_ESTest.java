...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  /*
   * 1 covered goal:
   * Goal 1. org.jsecurity.authc.UsernamePasswordToken.getCredentials()Ljava/lang/Object;: root-Branch
   */
  ...
  public void test02()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("U reqS! SM", "U reqS! SM");
      assertNotNull(usernamePasswordToken0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("U reqS! SM", usernamePasswordToken0.getUsername());
      
      usernamePasswordToken0.setUsername("U reqS! SM");
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("U reqS! SM", usernamePasswordToken0.getUsername());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.getByName("^-woY42t 4vKp");
      ...
      assertEquals("^-woY42t 4vKp/200.42.42.0", inet4Address0.toString());
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("^-woY42t 4vKp", charArray0, (InetAddress) inet4Address0);
      assertNotNull(usernamePasswordToken0);
      assertFalse(inet4Address0.isMCNodeLocal());
      assertFalse(inet4Address0.isMCLinkLocal());
      assertFalse(inet4Address0.isAnyLocalAddress());
      ...
      assertFalse(inet4Address0.isSiteLocalAddress());
      assertFalse(inet4Address0.isLinkLocalAddress());
      assertEquals("^-woY42t 4vKp", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
  ...
  public void test06()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("4, rS! M", "4, rS! M");
      assertNotNull(usernamePasswordToken0);
      assertEquals("4, rS! M", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - h &-` , rememberMe=false", string0);
  ...
  public void test13()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("A .< H)!\"M", "A .< H)!\"M", false, (InetAddress) inet4Address0);
      assertNotNull(usernamePasswordToken0);
      assertEquals("/192.168.1.42", inet4Address0.toString());
      assertEquals("192.168.1.42", inet4Address0.getHostAddress());
      assertFalse(inet4Address0.isMCNodeLocal());
      ...
      assertFalse(inet4Address0.isAnyLocalAddress());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("A .< H)!\"M", usernamePasswordToken0.getUsername());
      ...
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("A .< H)!\"M", usernamePasswordToken0.getUsername());
      assertArrayEquals(new char[] {'A', ' ', '.', '<', ' ', 'H', ')', '!', '\"', 'M'}, charArray0);
  }
