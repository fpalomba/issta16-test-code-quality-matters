...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("` Ffq44 *gpG4", "` Ffq44 *gpG4");
      assertEquals("` Ffq44 *gpG4", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
      
      usernamePasswordToken0.setUsername("` Ffq44 *gpG4");
      assertEquals("` Ffq44 *gpG4", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("XKnk3[Fj],quZPNqWhT", charArray0, (InetAddress) inet4Address0);
      assertEquals("XKnk3[Fj],quZPNqWhT", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertFalse(inet4Address0.isSiteLocalAddress());
      assertFalse(inet4Address0.isLinkLocalAddress());
      assertFalse(inet4Address0.isMCLinkLocal());
  ...
  public void test04()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("EV|: #WF?sylVBBP ", charArray0, true);
      assertTrue(usernamePasswordToken0.isRememberMe());
      assertEquals("EV|: #WF?sylVBBP ", usernamePasswordToken0.getUsername());
      assertNotNull(usernamePasswordToken0);
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000', '\u0000', '\u0000'}, charArray0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("9E ( ", charArray0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("9E ( ", usernamePasswordToken0.getUsername());
      assertNotNull(usernamePasswordToken0);
      assertArrayEquals(new char[] {'\u0000', '\u0000'}, charArray0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("tfq454 ;Hg:G4", "tfq454 ;Hg:G4", (InetAddress) inet4Address0);
      assertEquals("tfq454 ;Hg:G4", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertFalse(inet4Address0.isLoopbackAddress());
      assertFalse(inet4Address0.isMCNodeLocal());
      assertFalse(inet4Address0.isMCOrgLocal());
      ...
      String string0 = usernamePasswordToken0.toString();
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - tfq454 ;Hg:G4, rememberMe=false (/192.168.1.42)", string0);
      assertEquals("tfq454 ;Hg:G4", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertFalse(inet4Address0.isLoopbackAddress());
      assertFalse(inet4Address0.isMCNodeLocal());
