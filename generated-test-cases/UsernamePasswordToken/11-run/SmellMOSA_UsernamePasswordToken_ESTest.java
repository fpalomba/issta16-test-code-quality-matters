...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("6.lwq S dx mm", "6.lwq S dx mm");
      assertNotNull(usernamePasswordToken0);
      assertEquals("6.lwq S dx mm", usernamePasswordToken0.getUsername());
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("6.lwq$S dx mm", "6.lwq$S dx mm", (InetAddress) inet4Address0);
      assertNotNull(usernamePasswordToken0);
      assertFalse(inet4Address0.isMCGlobal());
      assertFalse(inet4Address0.isMCOrgLocal());
      assertEquals("/192.168.1.42", inet4Address0.toString());
      ...
      String string0 = usernamePasswordToken0.toString();
      assertNotNull(string0);
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - 6.lwq$S dx mm, rememberMe=false (/192.168.1.42)", string0);
      assertFalse(inet4Address0.isMCGlobal());
      assertFalse(inet4Address0.isMCOrgLocal());
      assertEquals("/192.168.1.42", inet4Address0.toString());
      assertFalse(inet4Address0.isMCLinkLocal());
  ...
  public void test04()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("e9xfEUsQ{O", charArray0, false);
      assertNotNull(usernamePasswordToken0);
      assertEquals("e9xfEUsQ{O", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals("j    ", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
