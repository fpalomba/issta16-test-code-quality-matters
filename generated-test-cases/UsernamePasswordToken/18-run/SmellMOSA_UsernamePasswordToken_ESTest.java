...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("etd]Y9", charArray0, true);
      assertNotNull(usernamePasswordToken0);
      assertArrayEquals(new char[] {'\u0000'}, charArray0);
      assertTrue(usernamePasswordToken0.isRememberMe());
      assertEquals("etd]Y9", usernamePasswordToken0.getUsername());
  }
  ...
  public void test04()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("v:B7&;|C ", "v:B7&;|C ", true);
      assertNotNull(usernamePasswordToken0);
      assertTrue(usernamePasswordToken0.isRememberMe());
      assertEquals("v:B7&;|C ", usernamePasswordToken0.getUsername());
  ...
  public void test05()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("zd4lu /)6:", charArray0, (InetAddress) inet4Address0);
      assertNotNull(usernamePasswordToken0);
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000'}, charArray0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("zd4lu /)6:", usernamePasswordToken0.getUsername());
      assertFalse(inet4Address0.isMCLinkLocal());
      assertEquals("192.168.1.42", inet4Address0.getHostAddress());
      assertFalse(inet4Address0.isLinkLocalAddress());
      assertEquals("/192.168.1.42", inet4Address0.toString());
  ...
  public void test06()  throws Throwable  {
      ...
      usernamePasswordToken0.setUsername("Djdg5    >Kq6&^~+");
      assertEquals("Djdg5    >Kq6&^~+", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("v'B7];|C ", "v'B7];|C ", (InetAddress) inet4Address0);
      assertNotNull(usernamePasswordToken0);
      assertEquals("v'B7];|C ", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("127.0.0.1", inet4Address0.getHostAddress());
      ...
      assertFalse(inet4Address0.isAnyLocalAddress());
      assertFalse(inet4Address0.isMCGlobal());
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - v'B7];|C , rememberMe=false (/127.0.0.1)", string0);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("o6(/F&dq-K yhKUP", charArray0);
      assertNotNull(usernamePasswordToken0);
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000', '\u0000'}, charArray0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("o6(/F&dq-K yhKUP", usernamePasswordToken0.getUsername());
  }
  ...
  public void test10()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("Cnj9u'Dv\"F6+ ]", "Cnj9u'Dv\"F6+ ]");
      assertNotNull(usernamePasswordToken0);
      assertEquals("Cnj9u'Dv\"F6+ ]", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
