...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.getByName(", rememberMe=");
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("", ", rememberMe=", true, (InetAddress) inet4Address0);
      String string0 = usernamePasswordToken0.toString();
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - , rememberMe=true (, rememberMe=/200.42.42.0)", string0);
   ...
   * Goal 4. org.jsecurity.authc.UsernamePasswordToken.toString()Ljava/lang/String;: I43 Branch 7 IFNULL L363 - true
   */

  @Test
  public void test01()  throws Throwable  {
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.anyLocalAddress();
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("l", "l", true, (InetAddress) inet4Address0);
      assertTrue(usernamePasswordToken0.isRememberMe());
  ...
  public void test02()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("0g", charArray0, (InetAddress) inet4Address0);
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("nF3L<ktJ'&H", charArray0);
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test05()  throws Throwable  {
      ...
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.getLocalHost();
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("0g", charArray0, (InetAddress) inet4Address0);
      usernamePasswordToken0.setUsername("8BNWzl@xI6|");
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("evl8)", charArray0, true);
