...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.getByName(".8|^oj+;7,m");
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("", "a_.3$g]GE{4#o@U", (InetAddress) inet4Address0);
      String string0 = usernamePasswordToken0.toString();
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - , rememberMe=false (.8|^oj+;7,m/200.42.42.0)", string0);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken(".;>8|^oj+;$7,m", charArray0);
  ...
  public void test05()  throws Throwable  {
      Inet4Address inet4Address0 = (Inet4Address)MockInetAddress.getByName(".8|^oj+;7,m");
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("", "a_.3$g]GE{4#o@U", (InetAddress) inet4Address0);
      usernamePasswordToken0.setUsername("lmtj UaY~FJy");
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("gF(4kh>", charArray0, (InetAddress) inet4Address0);
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
