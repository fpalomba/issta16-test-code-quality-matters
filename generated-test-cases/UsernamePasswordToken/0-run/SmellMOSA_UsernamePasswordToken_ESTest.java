...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken(":JY$Nd", charArray0, true);
      assertEquals(":JY$Nd", usernamePasswordToken0.getUsername());
  ...
  public void test02()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("pI ", "pI ");
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("pI ", usernamePasswordToken0.getUsername());
      assertNotNull(usernamePasswordToken0);
      
      String string0 = usernamePasswordToken0.toString();
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - pI , rememberMe=false", string0);
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertEquals("pI ", usernamePasswordToken0.getUsername());
  ...
  public void test03()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("LO+B+NmWH\\8n", charArray0);
      assertEquals("LO+B+NmWH\\8n", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000', '\u0000', '\u0000', '\u0000', '\u0000', '\u0000', '\u0000'}, charArray0);
      assertNotNull(usernamePasswordToken0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("LO+B+NmWH\\8n", charArray0, (InetAddress) inet4Address0);
      assertEquals("LO+B+NmWH\\8n", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertFalse(inet4Address0.isMCGlobal());
      assertFalse(inet4Address0.isMulticastAddress());
