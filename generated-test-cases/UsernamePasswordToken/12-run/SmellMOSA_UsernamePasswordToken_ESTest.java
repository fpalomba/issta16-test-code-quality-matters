...
public class UsernamePasswordToken_ESTest extends UsernamePasswordToken_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken(") qvsPGo}i)GnAC38", ") qvsPGo}i)GnAC38", (InetAddress) inet4Address0);
      assertEquals(") qvsPGo}i)GnAC38", usernamePasswordToken0.getUsername());
      ...
      assertEquals("org.jsecurity.authc.UsernamePasswordToken - ) qvsPGo}i)GnAC38, rememberMe=false (/192.168.1.42)", string0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("E?$+qU [aS@wkSq:t", charArray0, (InetAddress) inet4Address0);
      assertFalse(inet4Address0.isMCNodeLocal());
      assertEquals("/192.168.1.42", inet4Address0.toString());
      assertFalse(inet4Address0.isMulticastAddress());
      assertTrue(inet4Address0.isSiteLocalAddress());
      ...
      assertFalse(inet4Address0.isLoopbackAddress());
      assertEquals("192.168.1.42", inet4Address0.getHostAddress());
      assertEquals("E?$+qU [aS@wkSq:t", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
  ...
  public void test06()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("    @c[yEIo", "    @c[yEIo");
      assertEquals("    @c[yEIo", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
      ...
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(string0);
      assertEquals("org.jsecurity.authc.UsernamePasswordToken -     @c[yEIo, rememberMe=false", string0);
  }
  ...
  public void test07()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("    3@c[yEIo", "    3@c[yEIo");
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
      
      usernamePasswordToken0.setUsername("    3@c[yEIo");
      assertFalse(usernamePasswordToken0.isRememberMe());
  }
  ...
  public void test10()  throws Throwable  {
      char[] charArray0 = new char[5];
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("E? =U [S@wkS,:t", charArray0);
      assertEquals("E? =U [S@wkS,:t", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
      assertArrayEquals(new char[] {'\u0000', '\u0000', '\u0000', '\u0000', '\u0000'}, charArray0);
  }
  ...
  public void test11()  throws Throwable  {
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("    @c[yEIro", "    @c[yEIro");
      assertEquals("    @c[yEIro", usernamePasswordToken0.getUsername());
      assertFalse(usernamePasswordToken0.isRememberMe());
      assertNotNull(usernamePasswordToken0);
  ...
  public void test13()  throws Throwable  {
      ...
      UsernamePasswordToken usernamePasswordToken0 = new UsernamePasswordToken("$ ~8", charArray0, true);
      assertEquals("$ ~8", usernamePasswordToken0.getUsername());
