...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketSendBufferSize(1492);
      String string0 = advancedSettings0.toXML("ISO-8859-1");
      assertEquals(1492, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test01()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketReceiveBufferSize((-4860));
      String string0 = advancedSettings0.toXML(")3");
      assertEquals(-4860, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test02()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML(")3");
      assertEquals(")3<advanced-settings>\n)3\t<charset>ISO-8859-1</charset>\n)3\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n)3\t<byte-buffer-size>65536</byte-buffer-size>\n)3\t<backlog>0</backlog>\n)3\t<socket-linger>-1</socket-linger>\n)3\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n)3\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n)3\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n)3\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n)3\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n)3\t<performance-preferences-latency>0</performance-preferences-latency>\n)3\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n)3\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n)3\t<client-socket-traffic-class></client-socket-traffic-class>\n)3</advanced-settings>\n", string0);
  ...
  public void test04()  throws Throwable  {
      ...
      String string1 = advancedSettings0.toXML(")3");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals(")3<advanced-settings>\n)3\t<charset>ISO-8859-1</charset>\n)3\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n)3\t<byte-buffer-size>65536</byte-buffer-size>\n)3\t<backlog>0</backlog>\n)3\t<socket-linger>-1</socket-linger>\n)3\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n)3\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n)3\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n)3\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n)3\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n)3\t<performance-preferences-latency>0</performance-preferences-latency>\n)3\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n)3\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n)3</advanced-settings>\n", string1);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(543, advancedSettings0.getBacklog());
  }
  ...
  public void test09()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-778));
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(-1, advancedSettings0.getSocketLinger());
  ...
  public void test11()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize((-69));
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
  ...
  public void test12()  throws Throwable  {
      ...
      try {
        advancedSettings0.setCharset("LUt");
  ...
  public void test17()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth((-751));
      assertEquals(-751, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test21()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesConnectionTime((-1882));
      assertEquals(-1882, advancedSettings0.getPerformancePreferencesConnectionTime());
  }
  ...
  public void test24()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite(543);
      assertEquals(543, advancedSettings0.getMaxThreadsForNioWrite());
  }
}
