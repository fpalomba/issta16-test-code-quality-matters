...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketSendBufferSize(926);
      String string0 = advancedSettings0.toXML("");
      assertEquals(926, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test01()  throws Throwable  {
      ...
      assertEquals(824, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test03()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientIdentifier("7NIp7");
      assertEquals("7NIp7", advancedSettings0.getClientIdentifier());
  }
  ...
  public void test05()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog(3541);
      assertEquals(3541, advancedSettings0.getBacklog());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      try {
        advancedSettings0.setCharset("sL:");
  ...
  public void test13()  throws Throwable  {
      ...
      assertEquals("\t<socket-linger><advanced-settings>\n\t<socket-linger>\t<charset>ISO-8859-1</charset>\n\t<socket-linger>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<socket-linger>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<socket-linger>\t<backlog>0</backlog>\n\t<socket-linger>\t<socket-linger>-1</socket-linger>\n\t<socket-linger>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<socket-linger>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<socket-linger>\t<qsobject-pool-maker></qsobject-pool-maker>\n\t<socket-linger>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<socket-linger>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<socket-linger>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<socket-linger>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<socket-linger>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<socket-linger></advanced-settings>\n", string0);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("\t<socket-linger>");
      assertEquals("\t<socket-linger><advanced-settings>\n\t<socket-linger>\t<charset>ISO-8859-1</charset>\n\t<socket-linger>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<socket-linger>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<socket-linger>\t<backlog>0</backlog>\n\t<socket-linger>\t<socket-linger>-1</socket-linger>\n\t<socket-linger>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<socket-linger>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<socket-linger>\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n\t<socket-linger>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<socket-linger>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<socket-linger>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<socket-linger>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<socket-linger>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<socket-linger>\t<client-socket-traffic-class></client-socket-traffic-class>\n\t<socket-linger></advanced-settings>\n", string0);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
