...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketReceiveBufferSize((-1202));
      String string0 = advancedSettings0.toXML("");
      assertEquals(-1202, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("\t<lient-socket-traffic-class>");
      assertEquals("\t<lient-socket-traffic-class><advanced-settings>\n\t<lient-socket-traffic-class>\t<charset>ISO-8859-1</charset>\n\t<lient-socket-traffic-class>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<lient-socket-traffic-class>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<lient-socket-traffic-class>\t<backlog>0</backlog>\n\t<lient-socket-traffic-class>\t<socket-linger>-1</socket-linger>\n\t<lient-socket-traffic-class>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<lient-socket-traffic-class>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<lient-socket-traffic-class>\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n\t<lient-socket-traffic-class>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<lient-socket-traffic-class>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<lient-socket-traffic-class>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<lient-socket-traffic-class>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<lient-socket-traffic-class>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<lient-socket-traffic-class>\t<client-socket-traffic-class>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-socket-traffic-class>\n\t<lient-socket-traffic-class></advanced-settings>\n", string0);
   ...
   * Goal 2. org.quickserver.util.xmlreader.AdvancedSettings.toXML(Ljava/lang/String;)Ljava/lang/String;: I246 Branch 12 IFEQ L294 - true
   */
  ...
  public void test03()  throws Throwable  {
      ...
      String string1 = advancedSettings0.toXML("\t<lient-socket-traffic-class>");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("\t<lient-socket-traffic-class><advanced-settings>\n\t<lient-socket-traffic-class>\t<charset>ISO-8859-1</charset>\n\t<lient-socket-traffic-class>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<lient-socket-traffic-class>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<lient-socket-traffic-class>\t<backlog>0</backlog>\n\t<lient-socket-traffic-class>\t<socket-linger>-1</socket-linger>\n\t<lient-socket-traffic-class>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<lient-socket-traffic-class>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<lient-socket-traffic-class>\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n\t<lient-socket-traffic-class>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<lient-socket-traffic-class>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<lient-socket-traffic-class>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<lient-socket-traffic-class>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<lient-socket-traffic-class>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<lient-socket-traffic-class></advanced-settings>\n", string1);
  }
  ...
  public void test07()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog(2328);
      assertEquals(2328, advancedSettings0.getBacklog());
  }
  ...
  public void test08()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-221));
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  ...
  public void test09()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize(2328);
      assertEquals(2328, advancedSettings0.getByteBufferSize());
  }
  ...
  public void test10()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize((-1084));
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertEquals(0, advancedSettings0.getBacklog());
  ...
  public void test16()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth((-2193));
      assertEquals(-2193, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      assertEquals(3640, advancedSettings0.getPerformancePreferencesLatency());
  }
  ...
  public void test19()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketSendBufferSize((-1698));
      String string0 = advancedSettings0.toXML("");
      assertEquals(-1698, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test21()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesConnectionTime((-2673));
      assertEquals(-2673, advancedSettings0.getPerformancePreferencesConnectionTime());
  }
  ...
  public void test23()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setSocketLinger(3199);
      assertEquals(3199, advancedSettings0.getSocketLinger());
  }
  ...
  public void test24()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite((-1698));
      assertEquals(-1698, advancedSettings0.getMaxThreadsForNioWrite());
  }
}
