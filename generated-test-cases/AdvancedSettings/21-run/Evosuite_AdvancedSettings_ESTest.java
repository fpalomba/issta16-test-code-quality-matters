...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("\t<performance-preferences-bandwidth>");
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML(">p7CPJXCWw!`qbD!&");
      assertEquals(-351, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test03()  throws Throwable  {
      ...
      String string1 = advancedSettings0.toXML("\t<performance-preferences-bandwidth>");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("\t<performance-preferences-bandwidth><advanced-settings>\n\t<performance-preferences-bandwidth>\t<charset>ISO-8859-1</charset>\n\t<performance-preferences-bandwidth>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<performance-preferences-bandwidth>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<performance-preferences-bandwidth>\t<backlog>0</backlog>\n\t<performance-preferences-bandwidth>\t<socket-linger>-1</socket-linger>\n\t<performance-preferences-bandwidth>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<performance-preferences-bandwidth>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<performance-preferences-bandwidth>\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n\t<performance-preferences-bandwidth>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<performance-preferences-bandwidth>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<performance-preferences-bandwidth>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<performance-preferences-bandwidth>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<performance-preferences-bandwidth>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<performance-preferences-bandwidth></advanced-settings>\n", string1);
  }
  ...
  public void test10()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize((-198));
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  ...
  public void test15()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setQSObjectPoolMaker("3OoZ.gI>/A:ai%");
      assertEquals(65536, advancedSettings0.getByteBufferSize());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(-1, advancedSettings0.getSocketLinger());
   ...
   * Goal 14. org.quickserver.util.xmlreader.AdvancedSettings.setClientSocketTrafficClass(Ljava/lang/String;)V: root-Branch
   ...
   * Goal 19. org.quickserver.util.xmlreader.AdvancedSettings.toXML(Ljava/lang/String;)Ljava/lang/String;: I204 Branch 10 IFNULL L283 - false
  ...
  public void test16()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML(">p7CPJXCWw!`qbD!&");
      assertEquals(">p7CPJXCWw!`qbD!&<advanced-settings>\n>p7CPJXCWw!`qbD!&\t<charset>ISO-8859-1</charset>\n>p7CPJXCWw!`qbD!&\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n>p7CPJXCWw!`qbD!&\t<byte-buffer-size>65536</byte-buffer-size>\n>p7CPJXCWw!`qbD!&\t<backlog>0</backlog>\n>p7CPJXCWw!`qbD!&\t<socket-linger>-1</socket-linger>\n>p7CPJXCWw!`qbD!&\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n>p7CPJXCWw!`qbD!&\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n>p7CPJXCWw!`qbD!&\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n>p7CPJXCWw!`qbD!&\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n>p7CPJXCWw!`qbD!&\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n>p7CPJXCWw!`qbD!&\t<performance-preferences-latency>0</performance-preferences-latency>\n>p7CPJXCWw!`qbD!&\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n>p7CPJXCWw!`qbD!&\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n>p7CPJXCWw!`qbD!&\t<client-socket-traffic-class></client-socket-traffic-class>\n>p7CPJXCWw!`qbD!&</advanced-settings>\n", string0);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
  ...
  public void test17()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth((-3620));
      assertEquals(-3620, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test18()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesLatency(112);
      assertEquals(112, advancedSettings0.getPerformancePreferencesLatency());
  }
