...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketTrafficClass("=RW(waLY5Aeo");
      String string0 = advancedSettings0.toXML("PT-dRt2VR_4-B");
      assertEquals("PT-dRt2VR_4-B<advanced-settings>\nPT-dRt2VR_4-B\t<charset>ISO-8859-1</charset>\nPT-dRt2VR_4-B\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\nPT-dRt2VR_4-B\t<byte-buffer-size>65536</byte-buffer-size>\nPT-dRt2VR_4-B\t<backlog>0</backlog>\nPT-dRt2VR_4-B\t<socket-linger>-1</socket-linger>\nPT-dRt2VR_4-B\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\nPT-dRt2VR_4-B\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\nPT-dRt2VR_4-B\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\nPT-dRt2VR_4-B\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\nPT-dRt2VR_4-B\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\nPT-dRt2VR_4-B\t<performance-preferences-latency>0</performance-preferences-latency>\nPT-dRt2VR_4-B\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\nPT-dRt2VR_4-B\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\nPT-dRt2VR_4-B\t<client-socket-traffic-class>=RW(waLY5Aeo</client-socket-traffic-class>\nPT-dRt2VR_4-B</advanced-settings>\n", string0);
  ...
  public void test04()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientIdentifier("){%#}TK{<]Kwwd1H");
      assertEquals("){%#}TK{<]Kwwd1H", advancedSettings0.getClientIdentifier());
  }
  ...
  public void test07()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-2152));
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(65536, advancedSettings0.getByteBufferSize());
      assertEquals(0, advancedSettings0.getBacklog());
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        advancedSettings0.setCharset("N::75C");
   ...
   * Goal 3. org.quickserver.util.xmlreader.AdvancedSettings.toXML(Ljava/lang/String;)Ljava/lang/String;: I225 Branch 11 IFEQ L289 - true
   */
  ...
  public void test14()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("LSdC6QGw.-X");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("LSdC6QGw.-X<advanced-settings>\nLSdC6QGw.-X\t<charset>ISO-8859-1</charset>\nLSdC6QGw.-X\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\nLSdC6QGw.-X\t<byte-buffer-size>65536</byte-buffer-size>\nLSdC6QGw.-X\t<backlog>0</backlog>\nLSdC6QGw.-X\t<socket-linger>-1</socket-linger>\nLSdC6QGw.-X\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\nLSdC6QGw.-X\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\nLSdC6QGw.-X\t<qsobject-pool-maker></qsobject-pool-maker>\nLSdC6QGw.-X\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\nLSdC6QGw.-X\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\nLSdC6QGw.-X\t<performance-preferences-latency>0</performance-preferences-latency>\nLSdC6QGw.-X\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\nLSdC6QGw.-X\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\nLSdC6QGw.-X</advanced-settings>\n", string0);
  }
  ...
  public void test22()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite(1094);
      assertEquals(1094, advancedSettings0.getMaxThreadsForNioWrite());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("LSdC6QGw.-X");
      assertEquals(1094, advancedSettings0.getClientSocketReceiveBufferSize());
  }
}
