...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketSendBufferSize(921);
      String string0 = advancedSettings0.toXML("#");
      assertEquals(921, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML(" 4,YE&o^+&%]m7%(I");
      assertEquals(" 4,YE&o^+&%]m7%(I<advanced-settings>\n 4,YE&o^+&%]m7%(I\t<charset>ISO-8859-1</charset>\n 4,YE&o^+&%]m7%(I\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n 4,YE&o^+&%]m7%(I\t<byte-buffer-size>65536</byte-buffer-size>\n 4,YE&o^+&%]m7%(I\t<backlog>0</backlog>\n 4,YE&o^+&%]m7%(I\t<socket-linger>-1</socket-linger>\n 4,YE&o^+&%]m7%(I\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n 4,YE&o^+&%]m7%(I\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n 4,YE&o^+&%]m7%(I\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n 4,YE&o^+&%]m7%(I\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n 4,YE&o^+&%]m7%(I\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n 4,YE&o^+&%]m7%(I\t<performance-preferences-latency>0</performance-preferences-latency>\n 4,YE&o^+&%]m7%(I\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n 4,YE&o^+&%]m7%(I\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n 4,YE&o^+&%]m7%(I\t<client-socket-traffic-class></client-socket-traffic-class>\n 4,YE&o^+&%]m7%(I</advanced-settings>\n", string0);
  ...
  public void test03()  throws Throwable  {
      ...
      String string1 = advancedSettings0.toXML("\t<debug-non-blocking-mode>");
      assertEquals("\t<debug-non-blocking-mode><advanced-settings>\n\t<debug-non-blocking-mode>\t<charset>ISO-8859-1</charset>\n\t<debug-non-blocking-mode>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<debug-non-blocking-mode>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<debug-non-blocking-mode>\t<backlog>0</backlog>\n\t<debug-non-blocking-mode>\t<socket-linger>-1</socket-linger>\n\t<debug-non-blocking-mode>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<debug-non-blocking-mode>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<debug-non-blocking-mode>\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n\t<debug-non-blocking-mode>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<debug-non-blocking-mode>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<debug-non-blocking-mode>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<debug-non-blocking-mode>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<debug-non-blocking-mode>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<debug-non-blocking-mode></advanced-settings>\n", string1);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
  ...
  public void test07()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog(2052);
      assertEquals(2052, advancedSettings0.getBacklog());
  }
  ...
  public void test08()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-1511));
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
  ...
  public void test09()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize(2449);
      assertEquals(2449, advancedSettings0.getByteBufferSize());
  }
  ...
  public void test10()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize((-373));
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(0, advancedSettings0.getBacklog());
  ...
  public void test16()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth(994);
      assertEquals(994, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test20()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesConnectionTime(994);
      assertEquals(994, advancedSettings0.getPerformancePreferencesConnectionTime());
  }
  ...
  public void test23()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite((-373));
      assertEquals(-373, advancedSettings0.getMaxThreadsForNioWrite());
  }
  ...
  public void test24()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketReceiveBufferSize((-373));
      String string0 = advancedSettings0.toXML("\t<debug-non-blocking-mode>");
      assertEquals(-373, advancedSettings0.getClientSocketReceiveBufferSize());
  }
}
