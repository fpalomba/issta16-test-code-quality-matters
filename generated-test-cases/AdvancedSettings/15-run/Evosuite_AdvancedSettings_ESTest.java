...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketReceiveBufferSize(208);
      String string0 = advancedSettings0.toXML("IU=ZU");
      assertEquals(208, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test01()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketTrafficClass("%w$sC");
      String string0 = advancedSettings0.toXML("%w$sC");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("%w$sC<advanced-settings>\n%w$sC\t<charset>ISO-8859-1</charset>\n%w$sC\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n%w$sC\t<byte-buffer-size>65536</byte-buffer-size>\n%w$sC\t<backlog>0</backlog>\n%w$sC\t<socket-linger>-1</socket-linger>\n%w$sC\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n%w$sC\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n%w$sC\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n%w$sC\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n%w$sC\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n%w$sC\t<performance-preferences-latency>0</performance-preferences-latency>\n%w$sC\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n%w$sC\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n%w$sC\t<client-socket-traffic-class>%w$sC</client-socket-traffic-class>\n%w$sC</advanced-settings>\n", string0);
  }
  ...
  public void test04()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientIdentifier("j]axI]&Y");
      assertEquals("j]axI]&Y", advancedSettings0.getClientIdentifier());
  }
  ...
  public void test07()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-1949));
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  ...
  public void test08()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize(3475);
      assertEquals(3475, advancedSettings0.getByteBufferSize());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        advancedSettings0.setCharset("V29vUnob");
  ...
  public void test14()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setQSObjectPoolMaker("IU=ZU");
      String string0 = advancedSettings0.toXML("IU=ZU");
      assertEquals("IU=ZU<advanced-settings>\nIU=ZU\t<charset>ISO-8859-1</charset>\nIU=ZU\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\nIU=ZU\t<byte-buffer-size>65536</byte-buffer-size>\nIU=ZU\t<backlog>0</backlog>\nIU=ZU\t<socket-linger>-1</socket-linger>\nIU=ZU\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\nIU=ZU\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\nIU=ZU\t<qsobject-pool-maker>IU=ZU</qsobject-pool-maker>\nIU=ZU\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\nIU=ZU\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\nIU=ZU\t<performance-preferences-latency>0</performance-preferences-latency>\nIU=ZU\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\nIU=ZU\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\nIU=ZU</advanced-settings>\n", string0);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
  ...
  public void test15()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth((-3053));
      assertEquals(-3053, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      assertEquals(3, advancedSettings0.getPerformancePreferencesLatency());
  }
  ...
  public void test18()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketSendBufferSize(3475);
      String string0 = advancedSettings0.toXML("IU=ZU");
      assertEquals(3475, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test22()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setSocketLinger((-2096));
      assertEquals(-2096, advancedSettings0.getSocketLinger());
  }
  ...
  public void test23()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite((-2096));
      assertEquals(-2096, advancedSettings0.getMaxThreadsForNioWrite());
  }
}
