...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientIdentifier("9^y=.V[2@u[.");
      assertEquals("9^y=.V[2@u[.", advancedSettings0.getClientIdentifier());
  }
  ...
  public void test05()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog(2955);
      assertEquals(2955, advancedSettings0.getBacklog());
  }
  ...
  public void test06()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-2658));
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(65536, advancedSettings0.getByteBufferSize());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals(-1, advancedSettings0.getSocketLinger());
  ...
  public void test13()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setQSObjectPoolMaker("6A]npIMN");
      String string0 = advancedSettings0.toXML("</byte-buffer-size>\n");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("</byte-buffer-size>\n<advanced-settings>\n</byte-buffer-size>\n\t<charset>ISO-8859-1</charset>\n</byte-buffer-size>\n\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n</byte-buffer-size>\n\t<byte-buffer-size>65536</byte-buffer-size>\n</byte-buffer-size>\n\t<backlog>0</backlog>\n</byte-buffer-size>\n\t<socket-linger>-1</socket-linger>\n</byte-buffer-size>\n\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n</byte-buffer-size>\n\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n</byte-buffer-size>\n\t<qsobject-pool-maker>6A]npIMN</qsobject-pool-maker>\n</byte-buffer-size>\n\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n</byte-buffer-size>\n\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n</byte-buffer-size>\n\t<performance-preferences-latency>0</performance-preferences-latency>\n</byte-buffer-size>\n\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n</byte-buffer-size>\n\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n</byte-buffer-size>\n</advanced-settings>\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketTrafficClass("6A]npIMN");
      String string0 = advancedSettings0.toXML("</byte-buffer-size>\n");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("</byte-buffer-size>\n<advanced-settings>\n</byte-buffer-size>\n\t<charset>ISO-8859-1</charset>\n</byte-buffer-size>\n\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n</byte-buffer-size>\n\t<byte-buffer-size>65536</byte-buffer-size>\n</byte-buffer-size>\n\t<backlog>0</backlog>\n</byte-buffer-size>\n\t<socket-linger>-1</socket-linger>\n</byte-buffer-size>\n\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n</byte-buffer-size>\n\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n</byte-buffer-size>\n\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n</byte-buffer-size>\n\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n</byte-buffer-size>\n\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n</byte-buffer-size>\n\t<performance-preferences-latency>0</performance-preferences-latency>\n</byte-buffer-size>\n\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n</byte-buffer-size>\n\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n</byte-buffer-size>\n\t<client-socket-traffic-class>6A]npIMN</client-socket-traffic-class>\n</byte-buffer-size>\n</advanced-settings>\n", string0);
  }
  ...
  public void test16()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesLatency((-1968));
      assertEquals(-1968, advancedSettings0.getPerformancePreferencesLatency());
  }
  ...
  public void test22()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setSocketLinger((-1787));
      assertEquals(-1787, advancedSettings0.getSocketLinger());
  }
  ...
  public void test23()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite((-1802));
      assertEquals(-1802, advancedSettings0.getMaxThreadsForNioWrite());
  }
}
