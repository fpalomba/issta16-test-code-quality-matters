...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketSendBufferSize((-396));
      String string0 = advancedSettings0.toXML((String) null);
      assertEquals(-396, advancedSettings0.getClientSocketSendBufferSize());
  }
   ...
   * Goal 3. org.quickserver.util.xmlreader.AdvancedSettings.toXML(Ljava/lang/String;)Ljava/lang/String;: I204 Branch 10 IFNULL L283 - true
   */

  @Test
  public void test02()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      String string0 = advancedSettings0.toXML("U6O}uxw:w Ml");
      String string1 = advancedSettings0.toXML("-d[i2Gm`m^V2.N:5hg1");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("-d[i2Gm`m^V2.N:5hg1<advanced-settings>\n-d[i2Gm`m^V2.N:5hg1\t<charset>ISO-8859-1</charset>\n-d[i2Gm`m^V2.N:5hg1\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n-d[i2Gm`m^V2.N:5hg1\t<byte-buffer-size>65536</byte-buffer-size>\n-d[i2Gm`m^V2.N:5hg1\t<backlog>0</backlog>\n-d[i2Gm`m^V2.N:5hg1\t<socket-linger>-1</socket-linger>\n-d[i2Gm`m^V2.N:5hg1\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n-d[i2Gm`m^V2.N:5hg1\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n-d[i2Gm`m^V2.N:5hg1\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n-d[i2Gm`m^V2.N:5hg1\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n-d[i2Gm`m^V2.N:5hg1\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n-d[i2Gm`m^V2.N:5hg1\t<performance-preferences-latency>0</performance-preferences-latency>\n-d[i2Gm`m^V2.N:5hg1\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n-d[i2Gm`m^V2.N:5hg1\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n-d[i2Gm`m^V2.N:5hg1</advanced-settings>\n", string1);
  }
  ...
  public void test04()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientIdentifier("-d[i2Gm`m^V2.N:5hg1");
      assertEquals("-d[i2Gm`m^V2.N:5hg1", advancedSettings0.getClientIdentifier());
  }
  ...
  public void test07()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-1630));
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
  ...
  public void test08()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize(1658);
      assertEquals(1658, advancedSettings0.getByteBufferSize());
  }
  ...
  public void test09()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize((-1630));
      assertEquals(65536, advancedSettings0.getByteBufferSize());
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals(0, advancedSettings0.getBacklog());
  ...
  public void test14()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setQSObjectPoolMaker("VJEi8/dyTz/:Y\"G.E");
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(65536, advancedSettings0.getByteBufferSize());
      assertEquals(-1, advancedSettings0.getSocketLinger());
  ...
  public void test16()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth(702);
      assertEquals(702, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test20()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesConnectionTime(702);
      assertEquals(702, advancedSettings0.getPerformancePreferencesConnectionTime());
  }
  ...
  public void test22()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setSocketLinger((-1270));
      assertEquals(-1270, advancedSettings0.getSocketLinger());
  }
