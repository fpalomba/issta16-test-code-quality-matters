...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize(1337);
      assertEquals(1337, advancedSettings0.getByteBufferSize());
  }
  ...
  public void test13()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("^Uo]d8[> |!Eb)z");
      assertEquals("^Uo]d8[> |!Eb)z<advanced-settings>\n^Uo]d8[> |!Eb)z\t<charset>ISO-8859-1</charset>\n^Uo]d8[> |!Eb)z\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n^Uo]d8[> |!Eb)z\t<byte-buffer-size>65536</byte-buffer-size>\n^Uo]d8[> |!Eb)z\t<backlog>0</backlog>\n^Uo]d8[> |!Eb)z\t<socket-linger>-1</socket-linger>\n^Uo]d8[> |!Eb)z\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n^Uo]d8[> |!Eb)z\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n^Uo]d8[> |!Eb)z\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n^Uo]d8[> |!Eb)z\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n^Uo]d8[> |!Eb)z\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n^Uo]d8[> |!Eb)z\t<performance-preferences-latency>0</performance-preferences-latency>\n^Uo]d8[> |!Eb)z\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n^Uo]d8[> |!Eb)z\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n^Uo]d8[> |!Eb)z\t<client-socket-traffic-class>\t<performance-preferences-latency></client-socket-traffic-class>\n^Uo]d8[> |!Eb)z</advanced-settings>\n", string0);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
  ...
  public void test15()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesLatency(4461);
      assertEquals(4461, advancedSettings0.getPerformancePreferencesLatency());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML((String) null);
      assertEquals(21, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      assertEquals(-1729, advancedSettings0.getPerformancePreferencesConnectionTime());
  }
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("Wr-ophs=5@`");
