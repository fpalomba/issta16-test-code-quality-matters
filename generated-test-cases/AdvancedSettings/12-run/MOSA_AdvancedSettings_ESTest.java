...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketSendBufferSize(2872);
      String string0 = advancedSettings0.toXML("");
      assertEquals(2872, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test01()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketReceiveBufferSize(122);
      String string0 = advancedSettings0.toXML((String) null);
      assertEquals(122, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test02()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketTrafficClass("<Ss!FZ5DVC7tU=Qpb");
      String string0 = advancedSettings0.toXML("<Ss!FZ5DVC7tU=Qpb");
      assertEquals("<Ss!FZ5DVC7tU=Qpb<advanced-settings>\n<Ss!FZ5DVC7tU=Qpb\t<charset>ISO-8859-1</charset>\n<Ss!FZ5DVC7tU=Qpb\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n<Ss!FZ5DVC7tU=Qpb\t<byte-buffer-size>65536</byte-buffer-size>\n<Ss!FZ5DVC7tU=Qpb\t<backlog>0</backlog>\n<Ss!FZ5DVC7tU=Qpb\t<socket-linger>-1</socket-linger>\n<Ss!FZ5DVC7tU=Qpb\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n<Ss!FZ5DVC7tU=Qpb\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n<Ss!FZ5DVC7tU=Qpb\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n<Ss!FZ5DVC7tU=Qpb\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n<Ss!FZ5DVC7tU=Qpb\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n<Ss!FZ5DVC7tU=Qpb\t<performance-preferences-latency>0</performance-preferences-latency>\n<Ss!FZ5DVC7tU=Qpb\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n<Ss!FZ5DVC7tU=Qpb\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n<Ss!FZ5DVC7tU=Qpb\t<client-socket-traffic-class><Ss!FZ5DVC7tU=Qpb</client-socket-traffic-class>\n<Ss!FZ5DVC7tU=Qpb</advanced-settings>\n", string0);
  ...
  public void test03()  throws Throwable  {
      ...
      String string1 = advancedSettings0.toXML("\t<charset>");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("\t<charset><advanced-settings>\n\t<charset>\t<charset>ISO-8859-1</charset>\n\t<charset>\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\n\t<charset>\t<byte-buffer-size>65536</byte-buffer-size>\n\t<charset>\t<backlog>0</backlog>\n\t<charset>\t<socket-linger>-1</socket-linger>\n\t<charset>\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\n\t<charset>\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\n\t<charset>\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\n\t<charset>\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\n\t<charset>\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\n\t<charset>\t<performance-preferences-latency>0</performance-preferences-latency>\n\t<charset>\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\n\t<charset>\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\n\t<charset></advanced-settings>\n", string1);
  }
  ...
  public void test08()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setBacklog((-1402));
      assertEquals(-1, advancedSettings0.getSocketLinger());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
      assertEquals(0, advancedSettings0.getBacklog());
  ...
  public void test10()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setByteBufferSize((-1083));
      assertEquals(65536, advancedSettings0.getByteBufferSize());
      assertEquals("org.quickserver.net.server.impl.OptimisticClientIdentifier", advancedSettings0.getClientIdentifier());
      assertEquals(0, advancedSettings0.getBacklog());
      assertEquals("ISO-8859-1", advancedSettings0.getCharset());
  ...
  public void test11()  throws Throwable  {
      ...
      try {
        advancedSettings0.setCharset("tYxoAVSbq");
  ...
  public void test20()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesConnectionTime(122);
      assertEquals(122, advancedSettings0.getPerformancePreferencesConnectionTime());
  }
  ...
  public void test22()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setSocketLinger(122);
      assertEquals(122, advancedSettings0.getSocketLinger());
  }
