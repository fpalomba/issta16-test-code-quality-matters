...
public class AdvancedSettings_ESTest extends AdvancedSettings_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      advancedSettings0.setClientSocketReceiveBufferSize((-2630));
      String string0 = advancedSettings0.toXML("m<o2]nO`");
      assertEquals(-2630, advancedSettings0.getClientSocketReceiveBufferSize());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("m<o2]nO`");
      assertEquals("m<o2]nO`<advanced-settings>\nm<o2]nO`\t<charset>ISO-8859-1</charset>\nm<o2]nO`\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\nm<o2]nO`\t<byte-buffer-size>65536</byte-buffer-size>\nm<o2]nO`\t<backlog>0</backlog>\nm<o2]nO`\t<socket-linger>-1</socket-linger>\nm<o2]nO`\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\nm<o2]nO`\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\nm<o2]nO`\t<qsobject-pool-maker></qsobject-pool-maker>\nm<o2]nO`\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\nm<o2]nO`\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\nm<o2]nO`\t<performance-preferences-latency>0</performance-preferences-latency>\nm<o2]nO`\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\nm<o2]nO`\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\nm<o2]nO`</advanced-settings>\n", string0);
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
  }
   ...
   * Goal 4. org.quickserver.util.xmlreader.AdvancedSettings.toXML(Ljava/lang/String;)Ljava/lang/String;: I246 Branch 12 IFEQ L294 - true
   */
  ...
  public void test13()  throws Throwable  {
      ...
      String string0 = advancedSettings0.toXML("m<o2]nO`");
      assertTrue(advancedSettings0.getUseDirectByteBuffer());
      assertEquals("m<o2]nO`<advanced-settings>\nm<o2]nO`\t<charset>ISO-8859-1</charset>\nm<o2]nO`\t<use-direct-byte-buffer>true</use-direct-byte-buffer>\nm<o2]nO`\t<byte-buffer-size>65536</byte-buffer-size>\nm<o2]nO`\t<backlog>0</backlog>\nm<o2]nO`\t<socket-linger>-1</socket-linger>\nm<o2]nO`\t<debug-non-blocking-mode>false</debug-non-blocking-mode>\nm<o2]nO`\t<client-identifier>org.quickserver.net.server.impl.OptimisticClientIdentifier</client-identifier>\nm<o2]nO`\t<qsobject-pool-maker>org.quickserver.util.pool.MakeQSObjectPool</qsobject-pool-maker>\nm<o2]nO`\t<max-threads-for-nio-write>10</max-threads-for-nio-write>\nm<o2]nO`\t<performance-preferences-connection-time>0</performance-preferences-connection-time>\nm<o2]nO`\t<performance-preferences-latency>0</performance-preferences-latency>\nm<o2]nO`\t<performance-preferences-bandwidth>0</performance-preferences-bandwidth>\nm<o2]nO`\t<client-socket-tcp-no-delay>false</client-socket-tcp-no-delay>\nm<o2]nO`\t<client-socket-traffic-class></client-socket-traffic-class>\nm<o2]nO`</advanced-settings>\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setPerformancePreferencesBandwidth((-3179));
      assertEquals(-3179, advancedSettings0.getPerformancePreferencesBandwidth());
  }
  ...
  public void test17()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setClientSocketSendBufferSize((-640));
      String string0 = advancedSettings0.toXML((String) null);
      assertEquals(-640, advancedSettings0.getClientSocketSendBufferSize());
  }
  ...
  public void test22()  throws Throwable  {
      AdvancedSettings advancedSettings0 = new AdvancedSettings();
      advancedSettings0.setMaxThreadsForNioWrite((-1475));
      assertEquals(-1475, advancedSettings0.getMaxThreadsForNioWrite());
  }
}
