...
public class MessageFormatter_ESTest extends MessageFormatter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      List list0 = messageFormatter0.listResources("CONJP < (CC <: /^(?i:but)$ [ $+ (RB=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i@also|rater)$/G)) ])", classLoader0);
  ...
  public void test02()  throws Throwable  {
      ...
      try {
        ResourceBundle resourceBundle0 = messageFormatter0.tryLoad((String) null, "Utok5izable: %s(U+%s, Jecimal: 4s)A- 4hisma be becauseyour tZxt isnt using _OIsa t delimite");
  ...
  public void test06()  throws Throwable  {
      MessageFormatter messageFormatter0 = new MessageFormatter();
      MockThrowable mockThrowable0 = new MockThrowable("Aft1r mveRB:                     ");
      ApplicationException applicationException0 = new ApplicationException((Throwable) mockThrowable0, "Aft1r mveRB:                     ", (Object) mockThrowable0, (Object) messageFormatter0, (Object) mockThrowable0);
      MessageFormatter.LoadBundleError messageFormatter_LoadBundleError0 = new MessageFormatter.LoadBundleError("Aft1r mveRB:                     ", (Throwable) applicationException0);
  }
  ...
  public void test07()  throws Throwable  {
      MessageFormatter messageFormatter0 = new MessageFormatter();
      ApplicationException applicationException0 = new ApplicationException("aft1r mveRB:                   ");
      // Undeclared exception!
      try {
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("(VP (VP (VBZ Try) (NP (NP (DT this) (NN wine)) (CC and) (NP (DT these) (NNS snails)))) (PUNCT .))", (Object) "(VP (VP (VBZ Try) (NP (NP (DT this) (NN wine)) (CC and) (NP (DT these) (NNS snails)))) (PUNCT .))", (Object) messageFormatter0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("CONJP < (CC <: /^(?i:but)$ [ $+ (RB=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i@also|rater)$/G)) ])", (Object) "CONJP < (CC <: /^(?i:but)$ [ $+ (RB=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i@also|rater)$/G)) ])", (Object) "CONJP < (CC <: /^(?i:but)$ [ $+ (RB=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i@also|rater)$/G)) ])", (Object) messageFormatter0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test15()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("CONJP < (CC <: /^(?i:but)$ [ $+ (RB=head <: /^(?i:also|rather)$/)) | ($+ (ADVP=head <: (RB <: /^(?i@also|rater)$/G)) ])");
        fail("Expecting exception: RuntimeException");
   ...
   * Goal 7. com.lts.application.international.MessageFormatter.formatMessage(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;: I55 Branch 7 IF_ACMPNE L307 - false
   */
  ...
  public void test18()  throws Throwable  {
      ...
      try {
        String string0 = messageFormatter0.getMessage("d,>$Cu", objectArray0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.formatMessage("ould not find ani resurce bdle givu MaDes: ", (Object[]) null, (ResourceBundle) null);
        fail("Expecting exception: NullPointerException");
