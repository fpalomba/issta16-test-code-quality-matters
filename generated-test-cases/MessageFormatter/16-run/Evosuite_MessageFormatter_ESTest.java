...
public class MessageFormatter_ESTest extends MessageFormatter_ESTest_scaffolding {
   ...
   * Goal 6. com.lts.application.international.MessageFormatter.listToString(Ljava/util/List;)Ljava/lang/String;: I7 Branch 13 IF_ACMPNE L459 - true
   ...
   * Goal 8. com.lts.application.international.MessageFormatter.listToString(Ljava/util/List;)Ljava/lang/String;: I33 Branch 14 IFEQ L465 - false
   * Goal 9. com.lts.application.international.MessageFormatter.listToString(Ljava/util/List;)Ljava/lang/String;: I44 Branch 15 IFEQ L467 - true
  ...
  public void test03()  throws Throwable  {
      MessageFormatter messageFormatter0 = new MessageFormatter();
      ApplicationException applicationException0 = new ApplicationException("com.lts.application.rrors.repository.GettingEntry");
      // Undeclared exception!
      try {
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("ho|;R", (Object) messageFormatter0, (Object) "ho|;R");
        fail("Expecting exception: RuntimeException");
  ...
  public void test08()  throws Throwable  {
      ...
      try {
        String string0 = messageFormatter0.getMessage("$]=Q=Bp!", objectArray0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("x'64");
        fail("Expecting exception: RuntimeException");
   ...
   * Goal 2. com.lts.application.international.MessageFormatter.buildList([Ljava/lang/Object;)Ljava/util/List;: I13 Branch 1 IF_ACMPEQ L122 - false
   * Goal 3. com.lts.application.international.MessageFormatter.buildList([Ljava/lang/Object;)Ljava/util/List;: I25 Branch 2 IF_ICMPGE L124 - true
   * Goal 4. com.lts.application.international.MessageFormatter.buildList([Ljava/lang/Object;)Ljava/util/List;: I25 Branch 2 IF_ICMPGE L124 - false
   ...
   * Goal 7. com.lts.application.international.MessageFormatter.tryLoad(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ResourceBundle;: I11 Branch 16 IF_ACMPEQ L485 - true
   */
   ...
   * Goal 5. com.lts.application.international.MessageFormatter.getMessage(Ljava/lang/Throwable;)Ljava/lang/String;: I20 Branch 8 IFEQ L372 - true
   */
  ...
  public void test15()  throws Throwable  {
      ...
      PropertyResourceBundle propertyResourceBundle0 = new PropertyResourceBundle((Reader) pushbackReader0);
   ...
   * Goal 3. com.lts.application.international.MessageFormatter$LoadBundleError.<init>(Ljava/lang/String;Ljava/lang/Throwable;)V: root-Branch
   * Goal 4. com.lts.application.international.MessageFormatter.formatMessage(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;: I16 Branch 5 IFEQ L300 - true
   * Goal 5. com.lts.application.international.MessageFormatter.formatMessage(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;: I55 Branch 7 IF_ACMPNE L307 - false
   */
  ...
  public void test16()  throws Throwable  {
      ...
      MessageFormatter.LoadBundleError messageFormatter_LoadBundleError0 = new MessageFormatter.LoadBundleError("this is a fourth message", (Throwable) null);
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("this is a fourth message", (Object) messageFormatter_LoadBundleError0, (Object) messageFormatter0, (Object) byteArray0);
        fail("Expecting exception: RuntimeException");
