...
public class MessageFormatter_ESTest extends MessageFormatter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.formatMessage("Could not fynd ?n eeourceunde give nams: ", (Object[]) null, (ResourceBundle) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test02()  throws Throwable  {
      ...
      try {
        String string0 = messageFormatter0.getMessage(";Zl7~eN @~", objectArray0);
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("  Warning!!  Stanford Parser does not work with categories containing '@' like: ", (Object) "  Warning!!  Stanford Parser does not work with categories containing '@' like: ", (Object) "  Warning!!  Stanford Parser does not work with categories containing '@' like: ");
        fail("Expecting exception: RuntimeException");
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("VP|S|SBAR|SBARQ|SINV|SQ=root < (CC|CONJP $-- !/^(?:``|-LRB-|PRN|PP|ADVP|RB)/) < (/^(?:PRN|``|''|-[LR]RB-|,|:|.)$/ $+ (/^S|SINV$|^(?:A|N|V|PP|PRP|J|W|R)/=target [$-- (CC|CONJP $-- (__ ># =root) !$++ (/^:|,$/ $++ =target)) | $-- (/^:|,$/ $-- (__ ># =root) [!$-- /^CC|CONJP$/ | $++ (=target < (/^,$/ $++ (__ ># =target)))])] ) )", (Object) "VP|S|SBAR|SBARQ|SINV|SQ=root < (CC|CONJP $-- !/^(?:``|-LRB-|PRN|PP|ADVP|RB)/) < (/^(?:PRN|``|''|-[LR]RB-|,|:|.)$/ $+ (/^S|SINV$|^(?:A|N|V|PP|PRP|J|W|R)/=target [$-- (CC|CONJP $-- (__ ># =root) !$++ (/^:|,$/ $++ =target)) | $-- (/^:|,$/ $-- (__ ># =root) [!$-- /^CC|CONJP$/ | $++ (=target < (/^,$/ $++ (__ ># =target)))])] ) )", (Object) "VP|S|SBAR|SBARQ|SINV|SQ=root < (CC|CONJP $-- !/^(?:``|-LRB-|PRN|PP|ADVP|RB)/) < (/^(?:PRN|``|''|-[LR]RB-|,|:|.)$/ $+ (/^S|SINV$|^(?:A|N|V|PP|PRP|J|W|R)/=target [$-- (CC|CONJP $-- (__ ># =root) !$++ (/^:|,$/ $++ =target)) | $-- (/^:|,$/ $-- (__ ># =root) [!$-- /^CC|CONJP$/ | $++ (=target < (/^,$/ $++ (__ ># =target)))])] ) )", (Object) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test16()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        List list0 = messageFormatter0.listResources("  Warnng!!  btanford Parser dos no work with 4tegorie  cotaining '@' lAke: ", (ClassLoader) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test18()  throws Throwable  {
      ApplicationException applicationException0 = new ApplicationException("Cold _ot fynd ~ny resource undleOCive names:", "Cold _ot fynd ~ny resource undleOCive names:");
      MessageFormatter messageFormatter0 = new MessageFormatter();
      // Undeclared exception!
      try {
  ...
  public void test20()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = messageFormatter0.getMessage("VP < (@SBAR=target !$-- @SBAR|S !$-- /^:$/ [ y= @SBAR=sbar | <# @SBAR=sbar ] ) < (/^V/ < /^(?i:ask|asks|asked|asking|know|knows|knew|knowing|specify|specifies|specified|specifying|tell|tells|told|telling|understand|understands|understood|understanding|wonder|wonders|wondered|wondering)$/) [ < (/^V/ < /^(?i:tell|tells|told|tellng)$/) | < (=target !$-- NP) ] : (=sbar < (WHADVP|WHNP < (WRB !< /^(?i:how)$/) !$-- /^(?!RB|ADVP).*$/) !< (S < (VP < TO)))");
        fail("Expecting exception: RuntimeException");
