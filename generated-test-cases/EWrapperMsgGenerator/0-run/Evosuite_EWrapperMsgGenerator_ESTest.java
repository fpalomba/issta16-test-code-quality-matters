...
public class EWrapperMsgGenerator_ESTest extends EWrapperMsgGenerator_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(13, 13, 2061.0, 1.0E-8, (-465.845128783), (double) 13);
      assertEquals("id=13  modelOptComp: vol = 2061.0 delta = 1.0E-8: modelPrice = N/A: pvDividend = 13.0", string0);
  }
  ...
  public void test04()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(386, 0, 1.7976931348623157E308, 1.7976931348623157E308, 1.7976931348623157E308, (double) (-1726));
      assertEquals("id=386  bidSize: vol = N/A delta = N/A", string0);
  }
  ...
  public void test05()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(5331, (-713), (double) (-840), (double) (-713), (double) (-840), (double) (-713));
      assertEquals("id=5331  unknown: vol = N/A delta = N/A", string0);
  }
  ...
  public void test06()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickPrice(1469, 1435, 0.0, 1435);
      assertEquals("id=1469  unknown=0.0  canAutoExecute", string0);
  }
  ...
  public void test08()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepth(1435, 0, 1469, 1769, (double) 0, 0);
      assertEquals("updateMktDepth: 1435 0 1469 1769 0.0 0", string0);
  }
  ...
  public void test09()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickString(2554, 2554, (String) null);
      assertEquals("id=2554  unknown=null", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        String string0 = EWrapperMsgGenerator.deltaNeutralValidation((-1344), contract0.m_underComp);
        fail("Expecting exception: NullPointerException");
  ...
  public void test11()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateNewsBulletin(0, (-1344), "gue", "current time = 296 (Jan 1, 1970 12:04:56 AM)");
      assertEquals("MsgId=0 :: MsgType=-1344 :: Origin=current time = 296 (Jan 1, 1970 12:04:56 AM) :: Message=gue", string0);
  }
  ...
  public void test12()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.fundamentalData(5826, "OlY!e Q5");
      assertEquals("id  = 5826 len = 8\nOlY!e Q5", string0);
  }
  ...
  public void test13()  throws Throwable  {
      Contract contract0 = new Contract();
      ContractDetails contractDetails0 = new ContractDetails(contract0, (String) null, (String) null, (double) 0, (String) null, (String) null, 1452, "descAppend = ", (String) null, (String) null, (String) null, "A-uqz'P_[YRz<+kMX0]", (String) null, " words, with an average length of ", (String) null);
      String string0 = EWrapperMsgGenerator.updatePortfolio(contractDetails0.m_summary, 0, (double) 0, 0.0, 0.0, 0.0, 0.0, (String) null);
  ...
  public void test14()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountValue("", "*;", "7", "7");
      assertEquals("updateAccountValue:  *; 7 7", string0);
  }
  ...
  public void test15()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.receiveFA(4678, (String) null);
  ...
  public void test17()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSnapshotEnd(261);
      assertEquals("id=261 =============== end ===============", string0);
  }
  ...
  public void test18()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.orderStatus((-1726), "/2N8T", (-1726), 1033, (double) 1033, 1033, (-1726), (double) 1033, 1033, "/2N8T");
      assertEquals("order status: orderId=-1726 clientId=1033 permId=1033 status=/2N8T filled=-1726 remaining=1033 avgFillPrice=1033.0 lastFillPrice=1033.0 parent Id=-1726 whyHeld=/2N8T", string0);
  }
  ...
  public void test19()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerDataEnd(3269);
      assertEquals("id = 3269 =============== end ===============", string0);
  }
  ...
  public void test20()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickGeneric(5103, 5103, (double) 5103);
      assertEquals("id=5103  unknown=5103.0", string0);
  }
  ...
  public void test21()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.managedAccounts("\"eW%m");
      assertEquals("Connected : The list of managed accounts are : [\"eW%m]", string0);
  }
  ...
  public void test23()  throws Throwable  {
      Contract contract0 = new Contract();
      ContractDetails contractDetails0 = new ContractDetails(contract0, (String) null, "", 0.0, "+Dp;CP'rB2", (String) null, 0, (String) null, "", "current time = 296 (Jan 1, 1970 12:04:56 AM)", "", "", "", "", "'8N~P3'qHkf}mqDk1B");
      String string0 = EWrapperMsgGenerator.contractDetails(2201, contractDetails0);
      assertEquals("reqId = 2201 ===================================\n ---- Contract Details begin ----\nconid = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\nmultiplier = null\nexchange = null\nprimaryExch = null\ncurrency = null\nlocalSymbol = null\nmarketName = null\ntradingClass = \nminTick = 0.0\nprice magnifier = 0\norderTypes = +Dp;CP'rB2\nvalidExchanges = null\nunderConId = 0\nlongName = null\ncontractMonth = \nindustry = current time = 296 (Jan 1, 1970 12:04:56 AM)\ncategory = \nsubcategory = \ntimeZoneId = \ntradingHours = \nliquidHours = '8N~P3'qHkf}mqDk1B\n ---- Contract Details End ----\n", string0);
  }
  ...
  public void test24()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.accountDownloadEnd("}nPpfG");
      assertEquals("accountDownloadEnd: }nPpfG", string0);
  }
  ...
  public void test25()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepthL2(0, 0, " nbboPriceCap=", 0, 0, (double) 0, 0);
      assertEquals("updateMktDepth: 0 0  nbboPriceCap= 0 0 0.0 0", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.bondContractDetails(4678, contractDetails0);
      assertEquals("reqId = 4678 ===================================\n ---- Bond Contract Details begin ----\nsymbol = null\nsecType = null\ncusip = null\ncoupon = 0.0\nmaturity = null\nissueDate = null\nratings = null\nbondType = null\ncouponType = null\nconvertible = false\ncallable = false\nputable = false\ndescAppend = null\nexchange = null\ncurrency = null\nmarketName = null\ntradingClass = null\nconid = 0\nminTick = 0.0\norderTypes = null\nvalidExchanges = null\nnextOptionDate = null\nnextOptionType = null\nnextOptionPartial = false\nnotes = null\nlongName = null\n ---- Bond Contract Details End ----\n", string0);
  }
  ...
  public void test27()  throws Throwable  {
      ContractDetails contractDetails0 = new ContractDetails();
      String string0 = EWrapperMsgGenerator.scannerData(261, 261, contractDetails0, "_!F3!yoTNL", "g9.C`e!-", "}", (String) null);
      assertEquals("id = 261 rank=261 symbol=null secType=null expiry=null strike=0.0 right=null exchange=null currency=null localSymbol=null marketName=null tradingClass=null distance=_!F3!yoTNL benchmark=g9.C`e!- projection=} legsStr=null", string0);
  }
  ...
  public void test28()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.realtimeBar(0, 295L, 0.0, 1.7976931348623157E308, (double) (-28), 1.7976931348623157E308, (long) 0, 0.0, (-28));
      assertEquals("id=0 time = 295 open=0.0 high=1.7976931348623157E308 low=-28.0 close=1.7976931348623157E308 volume=0 count=-28 WAP=0.0", string0);
  }
  ...
  public void test31()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.currentTime((-506L));
      assertEquals("current time = -506 (Dec 31, 1969 11:51:34 PM)", string0);
  }
  ...
  public void test33()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickEFP(105, 105, (double) 105, "primaryExch = ", (-1.0), (-1819), "primaryExch = ", (double) 105, (double) (-1819));
      assertEquals("id=105  unknown: basisPoints = 105.0/primaryExch =  impliedFuture = -1.0 holdDays = -1819 futureExpiry = primaryExch =  dividendImpact = 105.0 dividends to expiry = -1819.0", string0);
  }
  ...
  public void test34()  throws Throwable  {
      Contract contract0 = new Contract();
      Execution execution0 = new Execution(1033, 536, "[,]q0}|%U4M=]nPr\"", (String) null, (String) null, (String) null, "c|", 3150, 1.7976931348623157E308, 1033, 873, Integer.MAX_VALUE, 1.7976931348623157E308);
      String string0 = EWrapperMsgGenerator.execDetails((-1454), contract0, execution0);
  ...
  public void test36()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerParameters("primaryExch = ");
  ...
  public void test37()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.historicalData(22, "R<ItK}WWsA*s", (double) 22, (double) 22, (double) 22, (double) 22, 22, 22, (double) 22, true);
      assertEquals("id=22 date = R<ItK}WWsA*s open=22.0 high=22.0 low=22.0 close=22.0 volume=22 count=22 WAP=22.0 hasGaps=true", string0);
  }
