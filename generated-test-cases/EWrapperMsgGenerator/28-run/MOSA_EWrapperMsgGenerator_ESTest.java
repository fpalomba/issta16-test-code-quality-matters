...
public class EWrapperMsgGenerator_ESTest extends EWrapperMsgGenerator_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(578, 13, (double) 13, (double) 13, (double) (-1122), (double) 13);
      assertEquals("id=578  modelOptComp: vol = 13.0 delta = N/A: modelPrice = N/A: pvDividend = 13.0", string0);
  }
  ...
  public void test03()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(2712, 5, 1.7976931348623157E308, 0.0, 795.0291394640363, 0.0);
      assertEquals("id=2712  lastSize: vol = N/A delta = 0.0", string0);
  }
  ...
  public void test04()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(578, 13, (double) 13, (double) 13, 0.0, (double) (-1842));
      assertEquals("id=578  modelOptComp: vol = 13.0 delta = N/A: modelPrice = 0.0: pvDividend = N/A", string0);
  }
  ...
  public void test05()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation((-904), (-904), (-291.1), 3010.562177, (double) (-904), 284.82824);
      assertEquals("id=-904  unknown: vol = N/A delta = N/A", string0);
  }
  ...
  public void test06()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickPrice((-904), (-904), (-3895.935), (-1670));
      assertEquals("id=-904  unknown=-3895.935  canAutoExecute", string0);
  }
  ...
  public void test07()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickPrice(0, 1680, 0.0, 0);
  ...
  public void test08()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepth(13, (-1842), (-1122), 13, (double) (-1107), (-1387));
      assertEquals("updateMktDepth: 13 -1842 -1122 13 -1107.0 -1387", string0);
  }
  ...
  public void test09()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickString((-817), 0, "");
      assertEquals("id=-817  bidSize=", string0);
  }
  ...
  public void test10()  throws Throwable  {
      UnderComp underComp0 = new UnderComp();
      String string0 = EWrapperMsgGenerator.deltaNeutralValidation((-907), underComp0);
      assertEquals("id = -907 underComp.conId =0 underComp.delta =0.0 underComp.price =0.0", string0);
  }
  ...
  public void test11()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateNewsBulletin(6417, (-56), "id=578  modelOptComp: vol = 13.0 delta = N/A: modelPrice = 0.0: pvDividend = N/A", "lavor");
      assertEquals("MsgId=6417 :: MsgType=-56 :: Origin=lavor :: Message=id=578  modelOptComp: vol = 13.0 delta = N/A: modelPrice = 0.0: pvDividend = N/A", string0);
  }
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try {
        String string0 = EWrapperMsgGenerator.updatePortfolio((Contract) null, (-1453), (double) (-1453), 1031.0993588610495, 3943.69236165695, 3943.69236165695, (double) 2596, "");
        fail("Expecting exception: NullPointerException");
  ...
  public void test14()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountValue(",invertible", "N=p=?XDj#)agI<(RU", "~Rf.@", ",invertible");
      assertEquals("updateAccountValue: ,invertible N=p=?XDj#)agI<(RU ~Rf.@ ,invertible", string0);
  }
  ...
  public void test15()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.receiveFA(11, "current time = 0 (Jan 1, 1970 12:00:00 AM)");
      assertEquals("FA: null current time = 0 (Jan 1, 1970 12:00:00 AM)", string0);
  }
  ...
  public void test16()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.contractDetailsEnd(5);
      assertEquals("reqId = 5 =============== end ===============", string0);
  }
  ...
  public void test17()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSnapshotEnd((-56));
      assertEquals("id=-56 =============== end ===============", string0);
  }
  ...
  public void test18()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.orderStatus(0, "", 0, 0, 0.0, 0, 0, (double) 0, 0, "Next Valid Order ID: 0");
      assertEquals("order status: orderId=0 clientId=0 permId=0 status= filled=0 remaining=0 avgFillPrice=0.0 lastFillPrice=0.0 parent Id=0 whyHeld=Next Valid Order ID: 0", string0);
  }
  ...
  public void test20()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickGeneric((-1402), 7251, 2942.848957301533);
      assertEquals("id=-1402  unknown=2942.848957301533", string0);
  }
  ...
  public void test21()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.managedAccounts(": basisPoints = ");
      assertEquals("Connected : The list of managed accounts are : [: basisPoints = ]", string0);
  }
  ...
  public void test24()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.accountDownloadEnd("]+q");
      assertEquals("accountDownloadEnd: ]+q", string0);
  }
  ...
  public void test25()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepthL2((-2514), 5214, "h#`;P;7", (-3118), 0, (double) 13, (-364));
      assertEquals("updateMktDepth: -2514 5214 h#`;P;7 -3118 0 13.0 -364", string0);
  }
  ...
  public void test27()  throws Throwable  {
      Contract contract0 = new Contract((-787), "Connected : The list of managed accounts are : [: basisPoints = ]", "id = 0 =============== end ===============", "id = 0 =============== end ===============", 2064.10162, (String) null, "ZPj*C#jmI</", "id  = ", (String) null, " basisPoints=", (Vector) null, "-,,4aduD+4#u6u", true, "id  = ", (String) null);
      ContractDetails contractDetails0 = new ContractDetails(contract0, (String) null, "Connected : The list of managed accounts are : [: basisPoints = ]", 0.0, "Connected : The list of managed accounts are : [: basisPoints = ]", "id = 0 =============== end ===============", 2377, "id  = ", "thousand", (String) null, "", "id  = ", "KvNC7n\"~XX./_1psZ8`", (String) null, "");
      String string0 = EWrapperMsgGenerator.scannerData(0, (-787), contractDetails0, "KvNC7n\"~XX./_1psZ8`", (String) null, (String) null, "lt|g,");
      assertEquals("id = 0 rank=-787 symbol=Connected : The list of managed accounts are : [: basisPoints = ] secType=id = 0 =============== end =============== expiry=id = 0 =============== end =============== strike=2064.10162 right=null exchange=id  =  currency=null localSymbol= basisPoints= marketName=null tradingClass=Connected : The list of managed accounts are : [: basisPoints = ] distance=KvNC7n\"~XX./_1psZ8` benchmark=null projection=null legsStr=lt|g,", string0);
  }
  ...
  public void test28()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.realtimeBar(0, (long) 0, 1.7976931348623157E308, 0.0, 1309.742883, 1.7976931348623157E308, (long) 0, 1000.0, 0);
      assertEquals("id=0 time = 0 open=1.7976931348623157E308 high=0.0 low=1309.742883 close=1.7976931348623157E308 volume=0 count=0 WAP=1000.0", string0);
  }
  ...
  public void test29()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.nextValidId(6467);
      assertEquals("Next Valid Order ID: 6467", string0);
  }
  ...
  public void test31()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.currentTime(866L);
      assertEquals("current time = 866 (Jan 1, 1970 12:14:26 AM)", string0);
  }
  ...
  public void test33()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickEFP((-1670), (-904), 10.0, "2377 | 416 | minTick = ", (double) 2377, 2377, "minTick = ", (double) 416, (-291.1));
      assertEquals("id=-1670  unknown: basisPoints = 10.0/2377 | 416 | minTick =  impliedFuture = 2377.0 holdDays = 2377 futureExpiry = minTick =  dividendImpact = 416.0 dividends to expiry = -291.1", string0);
  }
  ...
  public void test34()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.execDetails(598, contract0, execution0);
  ...
  public void test35()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSize(0, 0, 7161);
      assertEquals("id=0  bidSize=7161", string0);
  }
  ...
  public void test36()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerParameters("Vd`^oPL!");
  ...
  public void test37()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.historicalData(416, "id = 0 =============== end ===============", (double) 2377, (double) 416, 950.1513325, 1.0, 2377, (-1), 0.0, false);
      assertEquals("id=416 date = id = 0 =============== end =============== open=2377.0 high=416.0 low=950.1513325 close=1.0 volume=2377 count=-1 WAP=0.0 hasGaps=false", string0);
  }
  ...
  public void test38()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountTime("id=-1402  unknown=2942.848957301533");
      assertEquals("updateAccountTime: id=-1402  unknown=2942.848957301533", string0);
  }
}
