...
public class EWrapperMsgGenerator_ESTest extends EWrapperMsgGenerator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepthL2((-169), (-169), "/^UCP/=ucp [ <, /^JJ|ADJP/=adjp | ( <1 DT <2 /^JJ|ADJP/=adj ) | <- (ADJP=adjp < (JJR < /^(?i:younger|lder)$/)) | <, /^N/=np | ( <1 DT <2 /^N/=np ) |  <, /^ADVP/=advp ]", (-169), (-169), (double) (-169), (-169));
      assertEquals("updateMktDepth: -169 -169 /^UCP/=ucp [ <, /^JJ|ADJP/=adjp | ( <1 DT <2 /^JJ|ADJP/=adj ) | <- (ADJP=adjp < (JJR < /^(?i:younger|lder)$/)) | <, /^N/=np | ( <1 DT <2 /^N/=np ) |  <, /^ADVP/=advp ] -169 -169 -169.0 -169", string0);
  }
  ...
  public void test01()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.contractDetails((-156), contractDetails0);
      assertEquals("reqId = -156 ===================================\n ---- Contract Details begin ----\nconid = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\nmultiplier = null\nexchange = null\nprimaryExch = null\ncurrency = null\nlocalSymbol = null\nmarketName = null\ntradingClass = null\nminTick = 0.0\nprice magnifier = 0\norderTypes = null\nvalidExchanges = null\nunderConId = 0\nlongName = null\ncontractMonth = null\nindustry = null\ncategory = null\nsubcategory = null\ntimeZoneId = null\ntradingHours = null\nliquidHours = null\n ---- Contract Details End ----\n", string0);
  }
  ...
  public void test02()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation((-112), 13, (double) 2, (double) 13, (double) (-112), (double) 13);
      assertEquals("id=-112  modelOptComp: vol = 2.0 delta = N/A: modelPrice = N/A: pvDividend = 13.0", string0);
  }
  ...
  public void test03()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerParameters("  It does not support Subsequent Le#e Size for Scale ordrs.");
      assertEquals("SCANNER PARAMETERS:\n  It does not support Subsequent Le#e Size for Scale ordrs.", string0);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.updatePortfolio(contract0, 0, (double) 0, (double) 0, (double) 0, 0.0, (double) 0, (String) null);
  ...
  public void test05()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSnapshotEnd((-11));
  ...
  public void test06()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.receiveFA(22, "NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|Septemb{r|October|November|December|Jan.|Fei.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearne <: (CD=year <: __)t 8 =root j- =yearnp");
      assertEquals("FA: null NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|Septemb{r|October|November|December|Jan.|Fei.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearne <: (CD=year <: __)t 8 =root j- =yearnp", string0);
  }
  ...
  public void test09()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountValue("  It does not support Subsequent Le#e Size for Scale orders.", "  It does not support Subsequent Le#e Size for Scale orders.", "  It does not support Subsequent Le#e Size for Scale orders.", "  It does not support Subsequent Le#e Size for Scale orders.");
      assertEquals("updateAccountValue:   It does not support Subsequent Le#e Size for Scale orders.   It does not support Subsequent Le#e Size for Scale orders.   It does not support Subsequent Le#e Size for Scale orders.   It does not support Subsequent Le#e Size for Scale orders.", string0);
  }
  ...
  public void test12()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.execDetailsEnd((-3090));
      assertEquals("reqId = -3090 =============== end ===============", string0);
  }
  ...
  public void test13()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation((-686), (-686), (double) (-686), (double) (-686), (double) (-686), (double) (-686));
      assertEquals("id=-686  unknown: vol = N/A delta = N/A", string0);
  }
  ...
  public void test16()  throws Throwable  {
      ContractDetails contractDetails0 = new ContractDetails();
      String string0 = EWrapperMsgGenerator.tickOptionComputation(13, 13, (double) 13, (double) 0, (double) 0, (double) 0);
  ...
  public void test17()  throws Throwable  {
      ...
      Contract contract0 = new Contract(2, "^xN6", "^xN6", "^xN6", (double) 2, "^xN6", "^xN6", "^xN6", "^xN6", "^xN6", (Vector) vector0, "^xN6", false, "^xN6", "^xN6");
      String string0 = EWrapperMsgGenerator.tickPrice(2, 2, 2.0, 2);
      assertEquals("id=2  askPrice=2.0  canAutoExecute", string0);
  }
  ...
  public void test18()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountTime("NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|Septemb{r|October|November|December|Jan.|Fei.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearne <: (CD=year <: __)t 8 =root j- =yearnp");
      assertEquals("updateAccountTime: NP=root <1 (NP <: (NNP=month <: /January|February|March|April|May|June|July|August|Septemb{r|October|November|December|Jan.|Fei.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./)) <2 (NP=yearne <: (CD=year <: __)t 8 =root j- =yearnp", string0);
  }
  ...
  public void test19()  throws Throwable  {
      Vector<StringLabel> vector0 = new Vector<StringLabel>();
      Contract contract0 = new Contract(1632, "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx", (double) 1632, "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx", (Vector) vector0, "UPX/BUKa0Bwsx", true, "UPX/BUKa0Bwsx", "UPX/BUKa0Bwsx");
      String string0 = EWrapperMsgGenerator.tickEFP(1632, 1632, (double) 1632, (String) null, (double) 1632, 1632, "UPX/BUKa0Bwsx", (double) 1632, (double) 1632);
      assertEquals("id=1632  unknown: basisPoints = 1632.0/null impliedFuture = 1632.0 holdDays = 1632 futureExpiry = UPX/BUKa0Bwsx dividendImpact = 1632.0 dividends to expiry = 1632.0", string0);
  }
  ...
  public void test20()  throws Throwable  {
      Vector<StringLabel> vector0 = new Vector<StringLabel>();
      Contract contract0 = new Contract(5, "^xN6", "^xN6", "^xN6", (double) 5, "^xN6", "^xN6", "^xN6", "^xN6", "^xN6", (Vector) vector0, "^xN6", true, "^xN6", "^xN6");
      // Undeclared exception!
      try {
        String string0 = EWrapperMsgGenerator.deltaNeutralValidation(5, (UnderComp) null);
  ...
  public void test22()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.managedAccounts("  It does not support Subsequent Le#e Size for Scale orders.");
      assertEquals("Connected : The list of managed accounts are : [  It does not support Subsequent Le#e Size for Scale orders.]", string0);
  }
  ...
  public void test23()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.accountDownloadEnd("  It does not suppot Subsequet Le0el ize (or Scale orders.");
      assertEquals("accountDownloadEnd:   It does not suppot Subsequet Le0el ize (or Scale orders.", string0);
  }
  ...
  public void test24()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerDataEnd((-1365));
      assertEquals("id = -1365 =============== end ===============", string0);
  }
  ...
  public void test26()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickString(2265, 2265, "Connected : The list of managed accounts are : [");
      assertEquals("id=2265  unknown=Connected : The list of managed accounts are : [", string0);
  }
  ...
  public void test27()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.realtimeBar((-2220), (long) (-2220), (double) (-2220), (double) (-2220), (double) (-2220), (double) (-2220), (long) (-2220), (double) (-2220), (-2220));
      assertEquals("id=-2220 time = -2220 open=-2220.0 high=-2220.0 low=-2220.0 close=-2220.0 volume=-2220 count=-2220 WAP=-2220.0", string0);
  }
  ...
  public void test28()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.execDetails((-4), contractDetails0.m_summary, execution0);
  ...
  public void test29()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.contractDetailsEnd((-156));
      assertEquals("reqId = -156 =============== end ===============", string0);
  }
  ...
  public void test31()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.orderStatus((-2220), " has ", (-2220), (-2220), (double) (-2220), (-2220), (-2220), (double) (-2220), (-2220), " has ");
      assertEquals("order status: orderId=-2220 clientId=-2220 permId=-2220 status= has  filled=-2220 remaining=-2220 avgFillPrice=-2220.0 lastFillPrice=-2220.0 parent Id=-2220 whyHeld= has ", string0);
  }
  ...
  public void test32()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepth(5080, 5080, 5080, 5080, (double) 5080, 5080);
      assertEquals("updateMktDepth: 5080 5080 5080 5080 5080.0 5080", string0);
  }
  ...
  public void test34()  throws Throwable  {
      Vector<StringLabel> vector0 = new Vector<StringLabel>();
      Contract contract0 = new Contract(28, "}!s(xF", "}!s(xF", "}!s(xF", (double) 28, "}!s(xF", "}!s(xF", "}!s(xF", "}!s(xF", "}!s(xF", (Vector) vector0, "}!s(xF", false, "}!s(xF", "}!s(xF");
      String string0 = EWrapperMsgGenerator.tickGeneric(28, 28, (double) 28);
      assertEquals("id=28  OptionPutOpenInterest=28.0", string0);
  }
  ...
  public void test35()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.fundamentalData(2, "UPX/BUKa0Bwsx");
      assertEquals("id  = 2 len = 13\nUPX/BUKa0Bwsx", string0);
  }
  ...
  public void test36()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.currentTime((long) 2);
  ...
  public void test38()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(13, 13, 1.7976931348623157E308, (double) 13, 1.7976931348623157E308, (-3.4587292534E10));
