...
public class EWrapperMsgGenerator_ESTest extends EWrapperMsgGenerator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Contract contract0 = new Contract(12, "e+$>/%IIZvBm", "BAG", "Jb[k_", (double) 12, "Jb[k_", " date = ", "hcSe\"Q2?J>pur-", "BAG", "Jb[k_", (Vector) vector0, "BAG", false, "e+$>/%IIZvBm", "BAG");
      Order order0 = new Order();
      OrderState orderState0 = new OrderState();
      String string0 = EWrapperMsgGenerator.openOrder(12, contract0, order0, orderState0);
      assertEquals("open order: orderId=12 action=null quantity=0 symbol=e+$>/%IIZvBm exchange=hcSe\"Q2?J>pur- secType=BAG type=null lmtPrice=0.0 auxPrice=0.0 TIF=null localSymbol=Jb[k_ client Id=0 parent Id=0 permId=0 outsideRth=false hidden=false discretionaryAmt=0.0 triggerMethod=0 goodAfterTime=null goodTillDate=null faGroup=null faMethod=null faPercentage=null faProfile=null shortSaleSlot=0 designatedLocation= ocaGroup=null ocaType=0 rule80A=null allOrNone=false minQty=2147483647 percentOffset=1.7976931348623157E308 eTradeOnly=false firmQuoteOnly=false nbboPriceCap=1.7976931348623157E308 auctionStrategy=0 startingPrice=1.7976931348623157E308 stockRefPrice=1.7976931348623157E308 delta=1.7976931348623157E308 stockRangeLower=1.7976931348623157E308 stockRangeUpper=1.7976931348623157E308 volatility=1.7976931348623157E308 volatilityType=2147483647 deltaNeutralOrderType= deltaNeutralAuxPrice=1.7976931348623157E308 continuousUpdate=0 referencePriceType=2147483647 trailStopPrice=1.7976931348623157E308 scaleInitLevelSize= scaleSubsLevelSize= scalePriceIncrement= account=null settlingFirm=null clearingAccount=null clearingIntent=null notHeld=false whatIf=false status=null initMargin=null maintMargin=null equityWithLoan=null commission=0.0 minCommission=0.0 maxCommission=0.0 commissionCurrency=null warningText=null", string0);
  }
  ...
  public void test02()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(5770, 13, 10.0, 694.12, 1.7976931348623157E308, 0.0);
      assertEquals("id=5770  modelOptComp: vol = 10.0 delta = N/A: modelPrice = N/A: pvDividend = 0.0", string0);
  }
  ...
  public void test03()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(13, 13, 1.7976931348623157E308, 1.7976931348623157E308, (double) (byte) (-103), 1.7976931348623157E308);
  ...
  public void test04()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(0, 0, 0.0, (double) 0, 0.0, (double) 0);
  ...
  public void test05()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(213, 13, (double) (-3573), (double) (-3573), 2130.2320621971, (double) 13);
      assertEquals("id=213  modelOptComp: vol = N/A delta = N/A: modelPrice = 2130.2320621971: pvDividend = 13.0", string0);
  }
  ...
  public void test06()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickPrice(0, Integer.MAX_VALUE, 0.0, 4403);
  ...
  public void test08()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepth(1569, 1569, 1350, 0, (double) 1569, 2536);
      assertEquals("updateMktDepth: 1569 1569 1350 0 1569.0 2536", string0);
  }
  ...
  public void test09()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickString(0, (-1531), "updateAccountValue: -1531 | -1531 | null null -1531 | -1531 | null null");
      assertEquals("id=0  unknown=updateAccountValue: -1531 | -1531 | null null -1531 | -1531 | null null", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        String string0 = EWrapperMsgGenerator.deltaNeutralValidation(2374, (UnderComp) null);
  ...
  public void test11()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateNewsBulletin(0, 0, "1!-oRpj", (String) null);
      assertEquals("MsgId=0 :: MsgType=0 :: Origin=null :: Message=1!-oRpj", string0);
  }
  ...
  public void test12()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.fundamentalData(0, "reqId = 0 =============== end ===============");
      assertEquals("id  = 0 len = 45\nreqId = 0 =============== end ===============", string0);
  }
  ...
  public void test13()  throws Throwable  {
      Contract contract0 = new Contract();
      String string0 = EWrapperMsgGenerator.updatePortfolio(contract0, (-121), (double) Integer.MAX_VALUE, (double) (-121), 1.7976931348623157E308, 0.0, (double) 0, (String) null);
      assertEquals("updatePortfolio: conid = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\nmultiplier = null\nexchange = null\nprimaryExch = null\ncurrency = null\nlocalSymbol = null\n-121 2.147483647E9 -121.0 1.7976931348623157E308 0.0 0.0 null", string0);
  }
  ...
  public void test14()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountValue("-1531 | -1531 | null", (String) null, "-1531 | -1531 | null", (String) null);
      assertEquals("updateAccountValue: -1531 | -1531 | null null -1531 | -1531 | null null", string0);
  }
  ...
  public void test15()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.receiveFA((-1491), "current time = 1000 (Jan 1, 1970 12:16:40 AM)");
      assertEquals("FA: null current time = 1000 (Jan 1, 1970 12:16:40 AM)", string0);
  }
  ...
  public void test17()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSnapshotEnd((-1531));
      assertEquals("id=-1531 =============== end ===============", string0);
  }
  ...
  public void test18()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.orderStatus(0, "", 0, 1662, (-2632.55859073), 6676, 0, (double) 0, (-471), (String) null);
      assertEquals("order status: orderId=0 clientId=-471 permId=6676 status= filled=0 remaining=1662 avgFillPrice=-2632.55859073 lastFillPrice=0.0 parent Id=0 whyHeld=null", string0);
  }
  ...
  public void test19()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerDataEnd((-1491));
      assertEquals("id = -1491 =============== end ===============", string0);
  }
  ...
  public void test23()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.contractDetails(6775, contractDetails0);
      assertEquals("reqId = 6775 ===================================\n ---- Contract Details begin ----\nconid = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\nmultiplier = null\nexchange = null\nprimaryExch = null\ncurrency = null\nlocalSymbol = null\nmarketName = null\ntradingClass = null\nminTick = 0.0\nprice magnifier = 0\norderTypes = null\nvalidExchanges = null\nunderConId = 0\nlongName = null\ncontractMonth = null\nindustry = null\ncategory = null\nsubcategory = null\ntimeZoneId = null\ntradingHours = null\nliquidHours = null\n ---- Contract Details End ----\n", string0);
  }
  ...
  public void test24()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.accountDownloadEnd("id=598 =============== end ===============");
      assertEquals("accountDownloadEnd: id=598 =============== end ===============", string0);
  }
  ...
  public void test25()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepthL2(1949, 1092, "", 1092, 0, (double) 0, 1949);
      assertEquals("updateMktDepth: 1949 1092  1092 0 0.0 1949", string0);
  }
  ...
  public void test26()  throws Throwable  {
      ContractDetails contractDetails0 = new ContractDetails();
      String string0 = EWrapperMsgGenerator.bondContractDetails(1896, contractDetails0);
      assertEquals("reqId = 1896 ===================================\n ---- Bond Contract Details begin ----\nsymbol = null\nsecType = null\ncusip = null\ncoupon = 0.0\nmaturity = null\nissueDate = null\nratings = null\nbondType = null\ncouponType = null\nconvertible = false\ncallable = false\nputable = false\ndescAppend = null\nexchange = null\ncurrency = null\nmarketName = null\ntradingClass = null\nconid = 0\nminTick = 0.0\norderTypes = null\nvalidExchanges = null\nnextOptionDate = null\nnextOptionType = null\nnextOptionPartial = false\nnotes = null\nlongName = null\n ---- Bond Contract Details End ----\n", string0);
  }
  ...
  public void test27()  throws Throwable  {
      ContractDetails contractDetails0 = new ContractDetails();
      String string0 = EWrapperMsgGenerator.scannerData(995, 0, contractDetails0, (String) null, (String) null, (String) null, (String) null);
      assertEquals("id = 995 rank=0 symbol=null secType=null expiry=null strike=0.0 right=null exchange=null currency=null localSymbol=null marketName=null tradingClass=null distance=null benchmark=null projection=null legsStr=null", string0);
  }
  ...
  public void test28()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.realtimeBar(1896, (long) 1896, (-1387.85768648318), (double) 0, 937.91699, 0.0, 0L, (double) 0, 7106);
      assertEquals("id=1896 time = 1896 open=-1387.85768648318 high=0.0 low=937.91699 close=0.0 volume=0 count=7106 WAP=0.0", string0);
  }
  ...
  public void test33()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickEFP(12, 12, (double) 12, "Jb[k_", (-531.83958249658), 12, " date = ", (-531.83958249658), 849.52);
      assertEquals("id=12  lastOptComp: basisPoints = 12.0/Jb[k_ impliedFuture = -531.83958249658 holdDays = 12 futureExpiry =  date =  dividendImpact = -531.83958249658 dividends to expiry = 849.52", string0);
  }
  ...
  public void test34()  throws Throwable  {
      Contract contract0 = new Contract();
      ContractDetails contractDetails0 = new ContractDetails(contract0, (String) null, (String) null, (double) 0, (String) null, (String) null, (-819), (String) null, "Savk''^ury)o", (String) null, "wK@U]^?JLDLf.vj9Awa", "BAG", " whyHeld=", (String) null, (String) null);
      Execution execution0 = new Execution();
      String string0 = EWrapperMsgGenerator.execDetails((-819), contractDetails0.m_summary, execution0);
  ...
  public void test35()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSize((-2322), (-1531), (-1531));
      assertEquals("id=-2322  unknown=-1531", string0);
  }
  ...
  public void test36()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.scannerParameters("32V4xdZ@MB@o%");
      assertEquals("SCANNER PARAMETERS:\n32V4xdZ@MB@o%", string0);
  }
  ...
  public void test37()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.historicalData((-1531), (String) null, (double) (-2322), (double) (-1531), (double) 0, 875.44, 0, 0, (double) (-1531), false);
      assertEquals("id=-1531 date = null open=-2322.0 high=-1531.0 low=0.0 close=875.44 volume=0 count=0 WAP=-1531.0 hasGaps=false", string0);
  }
  ...
  public void test38()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountTime("1!-oRpj");
      assertEquals("updateAccountTime: 1!-oRpj", string0);
  }
}
