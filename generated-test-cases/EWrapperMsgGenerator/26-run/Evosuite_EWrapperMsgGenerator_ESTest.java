...
public class EWrapperMsgGenerator_ESTest extends EWrapperMsgGenerator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation((-2523), 13, 1000000.0, (double) 13, 0.0, 1000000.0);
      assertEquals("id=-2523  modelOptComp: vol = 1000000.0 delta = N/A: modelPrice = 0.0: pvDividend = 1000000.0", string0);
  }
  ...
  public void test02()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation(0, 0, 1.7976931348623157E308, (double) 0, 0.0, (double) 0);
  ...
  public void test03()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickOptionComputation((-2523), 13, (-2709.16837735543), 1698.3844704, (-2709.16837735543), (-2709.16837735543));
      assertEquals("id=-2523  modelOptComp: vol = N/A delta = N/A: modelPrice = N/A: pvDividend = N/A", string0);
  }
  ...
  public void test04()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickPrice((-1241), (-1035), (double) (-1241), (-1241));
      assertEquals("id=-1241  unknown=-1241.0  canAutoExecute", string0);
  }
  ...
  public void test06()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepth(2115, 0, 2115, 3534, (double) 3534, 16);
      assertEquals("updateMktDepth: 2115 0 2115 3534 3534.0 16", string0);
  }
  ...
  public void test07()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickString(2138, 609, (String) null);
      assertEquals("id=2138  unknown=null", string0);
  }
  ...
  public void test08()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.deltaNeutralValidation((-2523), underComp0);
      assertEquals("id = -2523 underComp.conId =0 underComp.delta =0.0 underComp.price =0.0", string0);
  }
  ...
  public void test10()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.fundamentalData((-1241), "KQ@b_XLHc2-h:P");
  ...
  public void test11()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.updatePortfolio(contract0, 0, 0.0, 0.0, (double) 0, 0.0, (double) 0, (String) null);
  ...
  public void test12()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountValue("nRUC!/Xjlb0WD", "", "id=1642  unknown=466.27328556156", "x");
      assertEquals("updateAccountValue: nRUC!/Xjlb0WD  id=1642  unknown=466.27328556156 x", string0);
  }
  ...
  public void test13()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.receiveFA((-1035), "id  = -1241 len = 14\nKQ@b_XLHc2-h:P");
      assertNotNull(string0);
  }
  ...
  public void test14()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.contractDetailsEnd(3479);
      assertEquals("reqId = 3479 =============== end ===============", string0);
  }
  ...
  public void test15()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSnapshotEnd((-1042));
      assertEquals("id=-1042 =============== end ===============", string0);
  }
  ...
  public void test16()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.orderStatus(0, (String) null, 3479, 0, 0.0, 0, 1553, (double) 0, 0, (String) null);
      assertEquals("order status: orderId=0 clientId=0 permId=0 status=null filled=3479 remaining=0 avgFillPrice=0.0 lastFillPrice=0.0 parent Id=1553 whyHeld=null", string0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.contractDetails(609, contractDetails0);
      assertEquals("reqId = 609 ===================================\n ---- Contract Details begin ----\nconid = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\nmultiplier = null\nexchange = null\nprimaryExch = null\ncurrency = null\nlocalSymbol = null\nmarketName = null\ntradingClass = null\nminTick = 0.0\nprice magnifier = 0\norderTypes = null\nvalidExchanges = null\nunderConId = 0\nlongName = null\ncontractMonth = null\nindustry = null\ncategory = null\nsubcategory = null\ntimeZoneId = null\ntradingHours = null\nliquidHours = null\n ---- Contract Details End ----\n", string0);
  }
  ...
  public void test22()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.accountDownloadEnd("` d/YIGpl(pek3y\"b");
      assertEquals("accountDownloadEnd: ` d/YIGpl(pek3y\"b", string0);
  }
  ...
  public void test23()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateMktDepthL2(2138, 609, "L;yl[x", 2138, 0, (double) 0, 609);
      assertEquals("updateMktDepth: 2138 609 L;yl[x 2138 0 0.0 609", string0);
  }
  ...
  public void test25()  throws Throwable  {
      ContractDetails contractDetails0 = new ContractDetails();
      String string0 = EWrapperMsgGenerator.scannerData(0, 0, contractDetails0, "tRF!HJyT^$+vXsn3>Tz", (String) null, (String) null, (String) null);
      assertEquals("id = 0 rank=0 symbol=null secType=null expiry=null strike=0.0 right=null exchange=null currency=null localSymbol=null marketName=null tradingClass=null distance=tRF!HJyT^$+vXsn3>Tz benchmark=null projection=null legsStr=null", string0);
  }
  ...
  public void test26()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.realtimeBar(0, (-584L), (double) (-584L), (double) 0, (double) 0, (double) 0, (long) 0, (double) 3479, 0);
      assertEquals("id=0 time = -584 open=-584.0 high=0.0 low=0.0 close=0.0 volume=0 count=0 WAP=3479.0", string0);
  }
  ...
  public void test27()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.nextValidId(530);
      assertEquals("Next Valid Order ID: 530", string0);
  }
  ...
  public void test29()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.currentTime((long) 2115);
      assertEquals("current time = 2115 (Jan 1, 1970 12:35:15 AM)", string0);
  }
  ...
  public void test31()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickEFP(0, 0, (double) 2115, "id=0  unknown: vol = 1897.3298391982028 delta = N/A", (double) 0, (-1241), "*lQ>PW&]<", 1897.3298391982028, (-1698.9538968658276));
      assertEquals("id=0  bidSize: basisPoints = 2115.0/id=0  unknown: vol = 1897.3298391982028 delta = N/A impliedFuture = 0.0 holdDays = -1241 futureExpiry = *lQ>PW&]< dividendImpact = 1897.3298391982028 dividends to expiry = -1698.9538968658276", string0);
  }
  ...
  public void test32()  throws Throwable  {
      ...
      String string0 = EWrapperMsgGenerator.execDetails(3479, contractDetails0.m_summary, execution0);
  ...
  public void test33()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.tickSize((-1241), (-2111), 0);
      assertEquals("id=-1241  unknown=0", string0);
  }
  ...
  public void test35()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.historicalData((-1596), "bW", (double) (-1596), (double) (-1596), (double) (-1596), 0.0, 0, (-1596), 0.0, true);
      assertEquals("id=-1596 date = bW open=-1596.0 high=-1596.0 low=-1596.0 close=0.0 volume=0 count=-1596 WAP=0.0 hasGaps=true", string0);
  }
  ...
  public void test36()  throws Throwable  {
      String string0 = EWrapperMsgGenerator.updateAccountTime(" ---- Execution Details begin ----\nreqId = 3479\norderId = 0\nclientId = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\ncontractExchange = null\ncurrency = null\nlocalSymbol = null\nexecId = null\ntime = null\nacctNumber = null\nexecutionExchange = null\nside = null\nshares = 0\nprice = 0.0\npermId = 0\nliquidation = 0\ncumQty = 0\navgPrice = 0.0\n ---- Execution Details end ----\n");
      assertEquals("updateAccountTime:  ---- Execution Details begin ----\nreqId = 3479\norderId = 0\nclientId = 0\nsymbol = null\nsecType = null\nexpiry = null\nstrike = 0.0\nright = null\ncontractExchange = null\ncurrency = null\nlocalSymbol = null\nexecId = null\ntime = null\nacctNumber = null\nexecutionExchange = null\nside = null\nshares = 0\nprice = 0.0\npermId = 0\nliquidation = 0\ncumQty = 0\navgPrice = 0.0\n ---- Execution Details end ----\n", string0);
  }
}
