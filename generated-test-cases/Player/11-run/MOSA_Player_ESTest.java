...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player(672, "", "", 0, 672);
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player(9, "8j1n<b<K&", "8j1n<b<K&", 9, 9);
      player0.setDead();
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player(0, "yRHAuVHNP63(,xG@F", "yRHAuVHNP63(,xG@F", 2234, 8);
      boolean boolean0 = player0.isDead();
      assertFalse(boolean0);
      assertEquals(8, player0.getStrength());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(2234, player0.getPictureId());
  }
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player(1483);
      player0.reset(true);
      assertEquals(0, player0.getPictureId());
      assertEquals(1, player0.getStrength());
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((-697), "", (-697));
      player0.reset(false);
      assertEquals(0L, player0.getTimeOfDeath());
      assertEquals(1, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(-697, player0.getPictureId());
      assertFalse(player0.isDead());
  }
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player((-1954), "", "sop", (-1954));
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player();
      player0.setMoney((float) (byte)35);
      assertEquals(35.0F, player0.getMoney(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ(1590.2383F);
      assertEquals(1590.2383F, player0.getZ(), 0.01F);
  }
