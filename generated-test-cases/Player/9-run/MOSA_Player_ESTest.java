...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player((-39), "", "", 1, (-39));
      player0.setJoinOK(player0, true);
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertTrue(boolean0);
      assertEquals(-39, player0.getStrength());
      assertEquals(1, player0.getPictureId());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((-494), "duel", "duel", (-494), (-494));
      player0.reset(true);
      assertEquals(-494, player0.getStrength());
  ...
  public void test09()  throws Throwable  {
      Player player0 = new Player(6293, "0,O=q\"gDm{a", 6293);
      float float0 = player0.getX();
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(6293, player0.getPictureId());
  ...
  public void test11()  throws Throwable  {
      Player player0 = new Player((-1797), "~LV6", 3063);
  ...
  public void test14()  throws Throwable  {
      ...
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(3063, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player();
      player0.setMoney((-3106.23F));
      assertEquals((-3106.23F), player0.getMoney(), 0.01F);
  }
  ...
  public void test18()  throws Throwable  {
      Player player0 = new Player((-2936));
      player0.setDead();
      boolean boolean0 = player0.isDead();
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player(0, "2{=R", "_", 0);
      player0.setX((-1096.86F));
      assertEquals((-1096.86F), player0.getX(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player(975);
      player0.setZ((float) 975);
      assertEquals(975.0F, player0.getZ(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player(2666, "", "", 2666, 202);
      player0.setY((-676.1441F));
      assertEquals((-676.1441F), player0.getY(), 0.01F);
  }
