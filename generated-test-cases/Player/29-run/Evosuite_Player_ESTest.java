...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player((-353), "fB", "^^SKF", (-353), (-353));
      player0.setJoinOK(player0, false);
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertFalse(player0.isDead());
      assertEquals("fB", player0.getIP());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(boolean0);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(-353, player0.getPictureId());
      assertEquals(-353, player0.getStrength());
  }
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player(3123, "o.a7gCqu@", "o.a7gCqu@", 3123, 3123);
      boolean boolean0 = player0.isDead();
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(3123, player0.getPictureId());
      assertFalse(boolean0);
      assertEquals(3123, player0.getStrength());
  }
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player(1325, "", "", 1325);
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((int) (byte)0, "tI)5;w{G}c])V+K%F", "tI)5;w{G}c])V+K%F", (int) (byte)0);
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player((-26), "CzAiw']i~\"?rltnxm8{", "CzAiw']i~\"?rltnxm8{", (-26));
      player0.setJoinOK(player0, true);
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertTrue(boolean0);
      assertFalse(player0.isDead());
      assertEquals(-26, player0.getPictureId());
      assertEquals(1, player0.getStrength());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
  }
  ...
  public void test14()  throws Throwable  {
      Player player0 = new Player(1325, "", "", 1325);
      player0.setMoney((float) 1325);
      assertEquals(1325.0F, player0.getMoney(), 0.01F);
  }
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player();
      player0.setX((-2147.0F));
      assertEquals((-2147.0F), player0.getX(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player(3123, "o.a7gCqu@", "o.a7gCqu@", 3123, 3123);
      player0.setZ((float) 3123);
      assertEquals(3123.0F, player0.getZ(), 0.01F);
  }
