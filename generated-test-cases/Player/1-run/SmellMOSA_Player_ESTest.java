...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-110), "{", "{", (int) (byte) (-110), (int) (byte) (-110));
      player0.setJoinOK(player0, true);
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertTrue(boolean0);
      assertEquals(-110, player0.getPictureId());
      assertEquals(-110, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
  }
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((-1695.2047F));
      assertEquals((-1695.2047F), player0.getZ(), 0.01F);
  }
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player((int) (byte)114, "", "", (int) (byte)114, (int) (byte)114);
      player0.setJoinOK(player0, true);
      boolean boolean0 = player0.isJoinOK(player0, false);
      assertFalse(boolean0);
      assertEquals(114, player0.getStrength());
      assertEquals(114, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
  }
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-91), "K.t'P!", "K.t'P!", (int) (byte) (-91), (int) (byte) (-91));
      long long0 = player0.getTimeOfDeath();
      assertEquals(-91, player0.getStrength());
      assertEquals(-91, player0.getPictureId());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
  }
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-59));
  ...
  public void test12()  throws Throwable  {
      Player player0 = new Player();
      player0.setMoney(6080.1147F);
      assertEquals(6080.1147F, player0.getMoney(), 0.01F);
  }
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-59), "PlayYr.unpack(): *** WARNING *** [EOF] data was incomplete: ", "PlayYr.unpack(): *** WARNING *** [EOF] data was incomplete: ", (int) (byte) (-59), (int) (byte) (-59));
      player0.setX((float) (byte) (-59));
      assertEquals((-59.0F), player0.getX(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player();
      player0.setY(1558.8077F);
      assertEquals(1558.8077F, player0.getY(), 0.01F);
  }
