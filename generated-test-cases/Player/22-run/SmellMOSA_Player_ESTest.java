...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      player0.setY((float) (-678));
      assertEquals((-678.0F), player0.getY(), 0.01F);
  }
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player(20, "NP=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Pov.|Dec./) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)", 20);
      player0.setMoney((float) 20);
  ...
  public void test04()  throws Throwable  {
      Player player0 = new Player(51, "layer.pack(): *** ERROR *** [IO] pack failed! current state is inconsistent: ", 51);
      String string0 = player0.toString();
      assertEquals(51, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player(0, "NP=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|September|October|November|December|Jan.|Feb.|Mar.|Apr.|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)", 0);
  ...
  public void test12()  throws Throwable  {
      Player player0 = new Player((-2538), "layer.pack(): *** ERROR *** [IO] pack failed! current state is inconsistent: ", "layer.pack(): *** ERROR *** [IO] pack failed! current state is inconsistent: ", (-2538), (-2538));
      player0.setX((float) (-2538));
      assertEquals((-2538.0F), player0.getX(), 0.01F);
  }
  ...
  public void test20()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((float) (-579));
      assertEquals((-579.0F), player0.getZ(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player((-12), "SBARQ < (WHNP=head $+ (/^VB/ < ", "SBARQ < (WHNP=head $+ (/^VB/ < ", (-12), (-12));
   ...
   * Goal 3. state.Player.getX()F: root-Branch
   */
