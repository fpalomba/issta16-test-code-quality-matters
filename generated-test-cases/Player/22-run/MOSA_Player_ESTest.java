...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player(3829, "Player.pack(): *** ERROR *** [IO] pack failed! current state is inconsistent: ", "t&`I6|?", 3829);
      byte[] byteArray0 = player0.pack();
      player0.unpack(byteArray0);
      assertEquals(-11, player0.getId());
  }
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player(3829);
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player((-1607));
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0, player0.getPictureId());
  ...
  public void test03()  throws Throwable  {
      ...
      player0.setDead((long) (-2346), false);
      boolean boolean0 = player0.isDead();
      assertEquals((-2346L), player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player(5804, "i;-", "i;-", 2470, 965);
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player(2358);
      player0.reset(true);
      assertEquals(1, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player(4850);
  ...
  public void test14()  throws Throwable  {
      Player player0 = new Player(3295);
  ...
  public void test16()  throws Throwable  {
      Player player0 = new Player(5804, "i;-", "i;-", 2470, 965);
      player0.setMoney((float) 2206);
      assertEquals(2206.0F, player0.getMoney(), 0.01F);
  }
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player(3295);
      player0.setX(188.0F);
      assertEquals(188.0F, player0.getX(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player(5804, "i;-", "i;-", 2470, 965);
      player0.setZ(2061.4873F);
      assertEquals(2061.4873F, player0.getZ(), 0.01F);
  }
  ...
  public void test27()  throws Throwable  {
      ...
      assertEquals(2470, player0.getPictureId());
      assertEquals(965, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(0.0F, float0, 0.01F);
