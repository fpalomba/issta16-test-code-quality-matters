...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringBufferInputStream stringBufferInputStream0 = new StringBufferInputStream("Player-1");
      BufferedInputStream bufferedInputStream0 = new BufferedInputStream((InputStream) stringBufferInputStream0, 1480);
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player(138, "", "", 138);
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player(104, "NJ#W` +", "NJ#W` +", 104, (-4982));
      player0.reset(true);
      ...
      assertEquals(-4982, player0.getStrength());
  }
  ...
  public void test14()  throws Throwable  {
      Player player0 = new Player(104, "NJ#W` +", "NJ#W` +", 104, (-4982));
      player0.setMoney((float) (-4982));
      assertEquals((-4982.0F), player0.getMoney(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player(138, "", "", 138);
      player0.setZ((float) 138);
      assertEquals(138.0F, player0.getZ(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player((-1006));
      player0.setY((float) (-1006));
      assertEquals((-1006.0F), player0.getY(), 0.01F);
  }
