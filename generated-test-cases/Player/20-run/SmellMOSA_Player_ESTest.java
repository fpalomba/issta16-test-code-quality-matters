...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player();
      player0.setY(7.4F);
      assertEquals(7.4F, player0.getY(), 0.01F);
  }
  ...
  public void test04()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-109));
      player0.setZ((float) (byte) (-109));
      assertEquals((-109.0F), player0.getZ(), 0.01F);
  }
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player(2, "0 `/x<", 2);
  ...
  public void test14()  throws Throwable  {
      Player player0 = new Player((-1020), "Player.pack(): *** ERROR *** [IO] pack failed! curren state s inconsistent: ", "Player.pack(): *** ERROR *** [IO] pack failed! curren state s inconsistent: ", (-1020));
      int int0 = player0.gangStrength();
      assertEquals(-1020, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(1, int0);
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player(1576, " ", " ", 1576);
  ...
  public void test16()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-104));
  ...
  public void test17()  throws Throwable  {
      Player player0 = new Player(3272, "ter DateTreeTranformer        ", "ter DateTreeTranformer        ", 3272, 3272);
      String string0 = player0.getName();
      assertEquals(3272, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(3272, player0.getPictureId());
  }
  ...
  public void test18()  throws Throwable  {
      Player player0 = new Player();
      player0.setMoney((-201.729F));
      assertEquals((-201.729F), player0.getMoney(), 0.01F);
  }
   ...
   * Goal 3. state.Player.setConnected(Z)V: root-Branch
   */
