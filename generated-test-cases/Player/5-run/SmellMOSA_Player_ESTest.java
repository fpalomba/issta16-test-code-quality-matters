...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-106), "a log item with lots of channels", "a log item with lots of channels", (int) (byte) (-106), (int) (byte) (-106));
      assertEquals(-106, player0.getPictureId());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(-106, player0.getStrength());
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-128), "a log item with lots of channels", "a log item with lots of channels", (int) (byte) (-128), (int) (byte) (-128));
      boolean boolean0 = player0.isDead();
      assertEquals(-128, player0.getPictureId());
      assertFalse(boolean0);
      assertEquals(-128, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player(25, "Player.unpacyb: *** WANIN *** [I] aiYe to unpack data: ", 25);
  ...
  public void test19()  throws Throwable  {
      Player player0 = new Player(1372, "Player.unpack): *** WARNING *** [Ig] faided to unpac( datj: ", "Player.unpack): *** WARNING *** [Ig] faided to unpac( datj: ", 1372);
      player0.setY((float) 1372);
      assertEquals(1372.0F, player0.getY(), 0.01F);
  }
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player((int) (byte)108, "Player.unpack(): *** WARNING *** data is not of proper type!", "Player.unpack(): *** WARNING *** data is not of proper type!", (int) (byte)108);
      player0.setMoney((float) (byte)108);
      assertEquals(108.0F, player0.getMoney(), 0.01F);
  }
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player(21, "Player.unpacyb: *** WANIN *** [I] aiYe to unpack data: ", 21);
  ...
  public void test26()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((float) (byte) (-126));
      assertEquals((-126.0F), player0.getZ(), 0.01F);
  }
}
