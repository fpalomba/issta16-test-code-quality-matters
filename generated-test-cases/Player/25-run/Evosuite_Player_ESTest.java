...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player(0, "adFA:}V8|G", 0);
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player((-2139), "}?{#", "}?{#", (-2139));
      boolean boolean0 = player0.isJoinOK(player0, false);
      assertEquals(-2139, player0.getPictureId());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(1, player0.getStrength());
  ...
  public void test04()  throws Throwable  {
      Player player0 = new Player(33, (String) null, "S!:a", 33, 33);
  ...
  public void test07()  throws Throwable  {
      Player player0 = new Player(616, "c3eEAO", 616);
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(33, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(33, player0.getPictureId());
  }
  ...
  public void test14()  throws Throwable  {
      Player player0 = new Player();
      player0.setMoney((float) (byte)40);
      assertEquals(40.0F, player0.getMoney(), 0.01F);
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player(1683, "0.0.0.0", "0.0.0.0", 1683);
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player();
      player0.setX((float) (byte)40);
      assertEquals(40.0F, player0.getX(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player(1683, "0.0.0.0", "0.0.0.0", 1683);
      player0.setZ((float) 1683);
      assertEquals(1683.0F, player0.getZ(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player(1683, "0.0.0.0", "0.0.0.0", 1683);
      player0.setY((float) 1683);
      assertEquals(1683.0F, player0.getY(), 0.01F);
  }
