...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      player0.setY((-1922.5527F));
      assertEquals((-1922.5527F), player0.getY(), 0.01F);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      assertEquals((-15L), player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player(0, "Player pack(): R*Q ERROR *u* ,*O] pack failed! currcnt tae +s $nconsistent: ", "Player pack(): R*Q ERROR *u* ,*O] pack failed! currcnt tae +s $nconsistent: ", 0, 0);
  ...
  public void test20()  throws Throwable  {
      Player player0 = new Player((-21), "Playerunpck(): *** WARNIG *** [IO] faled to urack data ", "Playerunpck(): *** WARNIG *** [IO] faled to urack data ", (-21));
      player0.setMoney((float) (-21));
      assertEquals((-21.0F), player0.getMoney(), 0.01F);
  }
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player(948, "$ayer.unpack(): ** WNINGr*** [EOF] ata {Ys incomplete: ", "$ayer.unpack(): ** WNINGr*** [EOF] ata {Ys incomplete: ", 948);
      player0.setX((float) 948);
      assertEquals(948.0F, player0.getX(), 0.01F);
  }
   ...
   * Goal 4. state.Player.gangStrength()I: I21 Branch 2 IFEQ L171 - true
   * Goal 5. state.Player.gangStrength()I: I21 Branch 2 IFEQ L171 - false
   */

  @Test
  public void test28()  throws Throwable  {
      Player player0 = new Player((-21), "Playerunpck(): *** WARNIG *** [IO] faled to unrack data ", "Playerunpck(): *** WARNIG *** [IO] faled to unrack data ", (-21));
