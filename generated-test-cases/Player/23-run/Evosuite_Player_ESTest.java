...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player(2447, "M1ui", "M1ui", 2447);
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((-2636));
  ...
  public void test07()  throws Throwable  {
      Player player0 = new Player((-81), "", "wvsaY", (-2529), (-2529));
      player0.reset(true);
      assertEquals(-2529, player0.getPictureId());
      assertEquals(-2529, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player(897, "", 897);
      float float0 = player0.getX();
      assertEquals(1, player0.getStrength());
      assertEquals(10.0F, float0, 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(897, player0.getPictureId());
  }
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player((-81), "", "wvsaY", (-2529), (-2529));
      player0.setX((float) (-2529));
      assertEquals((-2529.0F), player0.getX(), 0.01F);
  }
  ...
  public void test25()  throws Throwable  {
      Player player0 = new Player(897, "", 897);
      player0.setY((-1148.905F));
      assertEquals((-1148.905F), player0.getY(), 0.01F);
  }
