...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-28));
      player0.setZ((float) (byte) (-28));
      assertEquals((-28.0F), player0.getZ(), 0.01F);
  }
  ...
  public void test09()  throws Throwable  {
      Player player0 = new Player();
      player0.setDead(266L);
      boolean boolean0 = player0.isDead();
      assertEquals(266L, player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test12()  throws Throwable  {
      Player player0 = new Player((-29), "NP=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|Se/tember|October|Noember|December|Jan.|Feb.|Mar.|AprV|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)", "NP=root <1 (NP=monthdayroot <1 (NNP=month <: /January|February|March|April|May|June|July|August|Se/tember|October|Noember|December|Jan.|Feb.|Mar.|AprV|Aug.|Sep.|Sept.|Oct.|Nov.|Dec./) <2 (CD=day <: __)) <2 (/^,$/=comma <: /^,$/) <3 (NP=yearroot <: (CD=year <: __)) : (=root <- =yearroot) : (=monthdayroot <- =day)", (-29));
  ...
  public void test13()  throws Throwable  {
      Player player0 = new Player((int) (byte)10, "z7yO&", "z7yO&", (int) (byte)10, (int) (byte)10);
  ...
  public void test16()  throws Throwable  {
      Player player0 = new Player((-14), "Player.pack(): ***ERROR *** [IO] pack ailedx curr}t state is inconsistent: ", (-14));
   ...
   * Goal 3. state.Player$JoinInfo.<init>(Lstate/Player;Z)V: root-Branch
   * Goal 4. state.Player.isJoinOK(Lstate/Player;Z)Z: I11 Branch 4 IFEQ L263 - false
   * Goal 5. state.Player.isJoinOK(Lstate/Player;Z)Z: I41 Branch 5 IFLE L267 - false
   * Goal 6. state.Player.isJoinOK(Lstate/Player;Z)Z: I48 Branch 6 IF_ICMPNE L267 - false
   */

  @Test
  public void test23()  throws Throwable  {
      Player player0 = new Player((-14), "Player.pack(): ***ERROR *** [IO] pack ailedx curr}t state is inconsistent: ", (-14));
      Player player1 = new Player((-14), "Player.pack(): ***ERROR *** [IO] pack ailedx curr}t state is inconsistent: ", "Player.pack(): ***ERROR *** [IO] pack ailedx curr}t state is inconsistent: ", (-14), (-14));
      player0.setJoinOK(player1, false);
      boolean boolean0 = player0.isJoinOK(player1, false);
      assertEquals(-14, player1.getStrength());
      assertEquals(1, player0.getStrength());
      assertTrue(boolean0);
      assertEquals(-14, player1.getPictureId());
  ...
  public void test26()  throws Throwable  {
      Player player0 = new Player(1172, "layer.pack(): ***EROR **4C[IO] packdfailed! curr}nt state s inconsistent:", "layer.pack(): ***EROR **4C[IO] packdfailed! curr}nt state s inconsistent:", 1172);
      player0.setY((float) 1172);
      assertEquals(1172.0F, player0.getY(), 0.01F);
  }
