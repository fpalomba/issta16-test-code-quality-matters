...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player((int) (byte)4);
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player(6382);
      boolean boolean0 = player0.isJoinOK(player0, false);
      assertEquals(1, player0.getStrength());
      assertEquals(0, player0.getPictureId());
      assertFalse(player0.isDead());
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player();
      player0.setX(215.84F);
      assertEquals(215.84F, player0.getX(), 0.01F);
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-17), "", "", (int) (byte) (-17), (int) (byte) (-17));
  ...
  public void test17()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-68));
      player0.setDead((long) (byte) (-68));
      boolean boolean0 = player0.isDead();
      assertEquals((-68L), player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test18()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-68));
      player0.setMoney((float) (byte) (-68));
      assertEquals((-68.0F), player0.getMoney(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((-254.77878F));
      assertEquals((-254.77878F), player0.getZ(), 0.01F);
  }
  ...
  public void test25()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-17), "edu.stanford.nlp.process.LowercaseFunction", "edu.stanford.nlp.process.LowercaseFunction", (int) (byte) (-17));
      player0.setJoinOK(player0, false);
      assertEquals(1, player0.getStrength());
      assertEquals(-17, player0.getPictureId());
      assertFalse(player0.isDead());
  ...
  public void test28()  throws Throwable  {
      Player player0 = new Player(6371, "Player.pack(): *** ERROR *** [IO] pack failed! current state is inconsistent: ", "Player.pack(): *** ERROR *** [IO] pack failed! current state is inconsistent: ", 6371);
      player0.setConnected(true);
      assertEquals(6371, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(1, player0.getStrength());
