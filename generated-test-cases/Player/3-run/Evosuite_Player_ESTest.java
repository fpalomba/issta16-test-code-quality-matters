...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player((-2213), (String) null, "", 0, (-2213));
      boolean boolean0 = player0.isJoinOK(player0, false);
      assertEquals(0, player0.getPictureId());
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player(0, ":CH]vNOZyATqgRl", "8b985#DJPGQ8*", (-2778));
      player0.setDead((long) (-2778));
      boolean boolean0 = player0.isDead();
      assertEquals((-2778L), player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player(3237);
      player0.reset(true);
      assertEquals(0, player0.getPictureId());
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
  ...
  public void test08()  throws Throwable  {
      ...
      assertEquals(":CH]vNOZyATqgRl", player0.getIP());
      assertEquals(1, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertFalse(player0.isDead());
  ...
  public void test19()  throws Throwable  {
      Player player0 = new Player(409, "done.", 409);
      player0.setDead();
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player();
      player0.setX((float) (byte)4);
      assertEquals(4.0F, player0.getX(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player((-2213), (String) null, "", 0, (-2213));
      player0.setZ((float) 1717);
      assertEquals(1717.0F, player0.getZ(), 0.01F);
  }
