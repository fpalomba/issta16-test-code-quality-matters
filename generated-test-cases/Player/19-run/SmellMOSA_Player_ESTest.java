...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player(185);
      player0.setDead((long) 185);
      boolean boolean0 = player0.isDead();
      assertEquals(185L, player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player(3083, "-layer.pack(): *** ERROR *** [IO] pack failed! crrent stte i inconsistent: ", 3083);
      int int0 = player0.type();
      assertEquals(3083, player0.getPictureId());
      assertEquals(1, player0.getStrength());
      assertEquals(5, int0);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
  ...
  public void test09()  throws Throwable  {
      Player player0 = new Player((-779), "", "", (-779), (-779));
      ...
      assertEquals(-779, player0.getPictureId());
  }
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player(185, "Payer.pack(): *** ERROR *** [IO] pack faile! current state is incosisent: ", "Payer.pack(): *** ERROR *** [IO] pack faile! current state is incosisent: ", 185);
      String string0 = player0.toString();
      assertEquals(1, player0.getStrength());
      assertEquals(185, player0.getPictureId());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
  }
  ...
  public void test18()  throws Throwable  {
      Player player0 = new Player(0, "-layer.pack(): *** ERROR *** [IO] pac failed! crrent stte is inconsistent: ", "-layer.pack(): *** ERROR *** [IO] pac failed! crrent stte is inconsistent: ", 0, 0);
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player(185, "-layLr.pack(): *** ERROR *** [IO] pac failed! crrent stte %s inconsistent: ", 185);
  ...
  public void test27()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((float) (-3687));
      assertEquals((-3687.0F), player0.getZ(), 0.01F);
  }

  //Test case number: 28
  /*
   * 3 covered goals:
   * Goal 1. state.Player.<init>(I)V: root-Branch
   * Goal 2. state.Player.<init>(ILjava/lang/String;I)V: root-Branch
   * Goal 3. state.Player.isDead()Z: I7 Branch 3 IFNE L191 - true
   */

  @Test
  public void test28()  throws Throwable  {
      Player player0 = new Player((-41), "lfter combindCojp:               ", (-41));
      boolean boolean0 = player0.isDead();
      assertEquals(1, player0.getStrength());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertFalse(boolean0);
