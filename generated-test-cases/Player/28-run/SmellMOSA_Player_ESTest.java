...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player(3168);
  ...
  public void test04()  throws Throwable  {
      Player player0 = new Player(6, "*cyiJ{l/Helwaauw ", 6);
      byte[] byteArray0 = player0.pack();
      player0.unpack(byteArray0);
      assertEquals(6, player0.getId());
      assertFalse(player0.isDead());
  ...
  public void test07()  throws Throwable  {
      Player player0 = new Player();
      player0.setY((float) (-3007));
      assertEquals((-3007.0F), player0.getY(), 0.01F);
  }
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player((-2596), "Player.unpack(): *** WARNING *** [EOF] data was incomplete: ", (-2596));
      String string0 = player0.getName();
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(-2596, player0.getPictureId());
  }
  ...
  public void test09()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((-0.733288F));
      assertEquals((-0.733288F), player0.getZ(), 0.01F);
  }
  ...
  public void test12()  throws Throwable  {
      Player player0 = new Player((-1339), "Player.unpack(): *** WARNING *** [IO] failed to unpac* data: ", (-1339));
      player0.setX((float) (-1339));
      assertEquals((-1339.0F), player0.getX(), 0.01F);
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player((-1326));
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player(6041, "Treebank: Bad tree in treebank!: ", "Treebank: Bad tree in treebank!: ", 6041, 6041);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(6041, player0.getStrength());
      assertEquals(6041, player0.getPictureId());
  }
   ...
   * Goal 3. state.Player.gangStrength()I: I21 Branch 2 IFEQ L171 - true
   * Goal 4. state.Player.gangStrength()I: I21 Branch 2 IFEQ L171 - false
   */
