...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player(6, (String) null, 6);
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player((-2185), "edu.stanford.Elp.util.MapFactory$LinkedHashMapFactory", "edu.stanford.Elp.util.MapFactory$LinkedHashMapFactory", (-2185));
      boolean boolean0 = player0.isJoinOK(player0, false);
      assertEquals(-2185, player0.getPictureId());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(1, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player(0, "^KPDlfpFv@{y", 0);
      player0.setDead();
  ...
  public void test04()  throws Throwable  {
      Player player0 = new Player(0, "I/xRf@", "Player.pack(): *** ERROR *** [IO] pack siiled! current state is in onsistent: ", 0);
      boolean boolean0 = player0.isDead();
      ...
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(1, player0.getStrength());
      assertEquals("I/xRf@", player0.getIP());
  }
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((-505), ". m@V!ucm/mDfYMf", ". m@V!ucm/mDfYMf", 2759);
      player0.reset(true);
      assertEquals(1, player0.getStrength());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      ...
      assertFalse(player0.isDead());
      assertEquals(2759, player0.getPictureId());
  }
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player(0, "KV-EqXD>1rmIr1v", "KV-EqXD>1rmIr1v", 0);
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player(24, "30ykb67mb:", "30ykb67mb:", 24, 24);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player(24);
      player0.setZ((float) 24);
      assertEquals(24.0F, player0.getZ(), 0.01F);
  }
