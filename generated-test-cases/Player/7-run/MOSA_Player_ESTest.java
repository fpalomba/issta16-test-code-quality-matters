...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player(0, "GVHwaLsV_", "GVHwaLsV_", 0);
  ...
  public void test07()  throws Throwable  {
      Player player0 = new Player(3535, "", (String) null, 3535);
      player0.reset(false);
      assertEquals(3535, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertFalse(player0.isDead());
      assertEquals(1, player0.getStrength());
      assertEquals(10.0F, player0.getX(), 0.01F);
  ...
  public void test08()  throws Throwable  {
      Player player0 = new Player(5056);
  ...
  public void test09()  throws Throwable  {
      Player player0 = new Player(1492, "F2f[x{SDtrbY#/#hG]", "F2f[x{SDtrbY#/#hG]", 4436, 2412);
      float float0 = player0.getX();
      assertEquals(4436, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, float0, 0.01F);
      assertFalse(player0.isDead());
      assertEquals(2412, player0.getStrength());
  }
  ...
  public void test16()  throws Throwable  {
      Player player0 = new Player(0, "GVHwaLsV_", "GVHwaLsV_", 0);
      player0.setMoney((-1988.2F));
      assertEquals((-1988.2F), player0.getMoney(), 0.01F);
  }
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player((-819));
      player0.setX((-224.85F));
      assertEquals((-224.85F), player0.getX(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player(885, "[a3", "[a3", (-1406), 885);
      player0.setZ((float) (-1406));
      assertEquals((-1406.0F), player0.getZ(), 0.01F);
  }
