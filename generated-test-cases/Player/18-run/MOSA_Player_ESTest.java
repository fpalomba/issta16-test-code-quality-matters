...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      Player player0 = new Player(250, "F6WO{$", "F6WO{$", 250, 250);
  ...
  public void test01()  throws Throwable  {
      Player player0 = new Player(275, "n$", "n$", 0);
      boolean boolean0 = player0.isJoinOK(player0, true);
      assertEquals(0.0F, player0.getY(), 0.01F);
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player(420, "", "", 420, (-1560));
      player0.setDead(3412L, false);
      boolean boolean0 = player0.isDead();
      assertEquals(3412L, player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test03()  throws Throwable  {
      Player player0 = new Player(1049, "", "", (-1529), 909);
      boolean boolean0 = player0.isDead();
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(-1529, player0.getPictureId());
      assertFalse(boolean0);
      assertEquals(909, player0.getStrength());
      assertEquals(10.0F, player0.getX(), 0.01F);
  }
  ...
  public void test04()  throws Throwable  {
      Player player0 = new Player(2596);
  ...
  public void test12()  throws Throwable  {
      Player player0 = new Player(7, "Player.unpack(): *** WARNING *** data is not of proper type!", 442);
      int int0 = player0.getStrength();
      assertEquals(1, int0);
      assertFalse(player0.isDead());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(442, player0.getPictureId());
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player(5821, "exp", "\"2q\"M[?cWi^pr3Q0,*<", 932, 5821);
      player0.setMoney((float) 80);
      assertEquals(80.0F, player0.getMoney(), 0.01F);
  }
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player(275, "n$", "n$", 0);
      player0.setX((float) 275);
      assertEquals(275.0F, player0.getX(), 0.01F);
  }
  ...
  public void test25()  throws Throwable  {
      Player player0 = new Player(7, "Player.unpack(): *** WARNING *** data is not of proper type!", 442);
      player0.setY((-1288.0F));
      assertEquals((-1288.0F), player0.getY(), 0.01F);
  }
