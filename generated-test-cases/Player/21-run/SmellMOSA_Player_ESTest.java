...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-61), "Playe.pack():***JERROR *** [IO]ack faileh~ current state is inconsistent: ", "Playe.pack():***JERROR *** [IO]ack faileh~ current state is inconsistent: ", (int) (byte) (-61), (int) (byte) (-61));
  ...
  public void test07()  throws Throwable  {
      Player player0 = new Player((-1371), "After hansUormCC:  O         >", (-1371));
      player0.setY((float) (-1371));
      assertEquals((-1371.0F), player0.getY(), 0.01F);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      player0.setMoney((float) (-2050));
      assertEquals((-2050.0F), player0.getMoney(), 0.01F);
  }
  ...
  public void test19()  throws Throwable  {
      Player player0 = new Player((-2050), "[if exists lnum creaIeSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", "[if exists lnum creaIeSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", (-2050), (-2050));
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player(678, "Y", "Y", 678);
      long long0 = player0.getTimeOfDeath();
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(678, player0.getPictureId());
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
  }
  ...
  public void test23()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-50), "Player.inpack(): *** WARNING *** [IO] failed to unpack data: ", "Player.inpack(): *** WARNING *** [IO] failed to unpack data: ", (int) (byte) (-50), (int) (byte) (-50));
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(-50, player0.getPictureId());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(-50, player0.getStrength());
  }
