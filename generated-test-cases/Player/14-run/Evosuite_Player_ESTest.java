...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player(3663, "+D.", 3663);
      player0.reset(true);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(3663, player0.getPictureId());
      assertEquals(1, player0.getStrength());
      assertFalse(player0.isDead());
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player((-399), " ", " ", (-399), (-399));
      player0.reset(false);
      assertEquals(-399, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(-399, player0.getStrength());
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0L, player0.getTimeOfDeath());
  }
  ...
  public void test07()  throws Throwable  {
      Player player0 = new Player((-808), "", (-808));
      ...
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(1, player0.getStrength());
      assertEquals(-808, player0.getPictureId());
  }
  ...
  public void test13()  throws Throwable  {
      Player player0 = new Player((-1281), (String) null, (String) null, (-1281));
      Player player1 = new Player((-1281), "", (-1281));
  ...
  public void test21()  throws Throwable  {
      Player player0 = new Player((-1281), (String) null, (String) null, (-1281));
      player0.setX((float) (-1281));
      assertEquals((-1281.0F), player0.getX(), 0.01F);
  }
  ...
  public void test24()  throws Throwable  {
      Player player0 = new Player(3663, "+D.", 3663);
      player0.setY((float) 3663);
      assertEquals(3663.0F, player0.getY(), 0.01F);
  }
