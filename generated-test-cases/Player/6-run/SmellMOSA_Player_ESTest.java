...
public class Player_ESTest extends Player_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      Player player0 = new Player();
      player0.setZ((-3066.902F));
      assertEquals((-3066.902F), player0.getZ(), 0.01F);
  }
  ...
  public void test06()  throws Throwable  {
      Player player0 = new Player(8, "Hlayer.ack(): *** ERROR ***c[IO] pack failed! current sta-e is inconsisPnt: ", 8);
  ...
  public void test07()  throws Throwable  {
      ...
      player0.setMoney((float) (-308));
      assertEquals((-308.0F), player0.getMoney(), 0.01F);
  }
  ...
  public void test09()  throws Throwable  {
      Player player0 = new Player(1197, "untap", "untap", 1197, 1197);
      player0.setDead((long) 1197);
      boolean boolean0 = player0.isDead();
      assertEquals(1197L, player0.getTimeOfDeath());
      assertTrue(boolean0);
  }
  ...
  public void test10()  throws Throwable  {
      Player player0 = new Player(1966, "Hlayer.ack(): *** ERROR ***c[IO] pack failed! current sta-e is inconsistPnt: ", 1966);
      int int0 = player0.getStrength();
      assertFalse(player0.isDead());
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(1, int0);
      assertEquals(1966, player0.getPictureId());
  }
  ...
  public void test15()  throws Throwable  {
      Player player0 = new Player((int) (byte) (-10), "9/WieQN'", "9/WieQN'", (int) (byte) (-10), (int) (byte) (-10));
  ...
  public void test16()  throws Throwable  {
      Player player0 = new Player(27, "Player.unpack(): *** WARNING *** [IO] failed to unpack data: ", "Player.unpack(): *** WARNING *** [IO] failed to unpack data: ", 27, 27);
  ...
  public void test18()  throws Throwable  {
      ...
      assertEquals(1197, player0.getStrength());
      assertEquals(1197, player0.getPictureId());
      assertEquals(0.0F, player0.getY(), 0.01F);
      assertEquals(10.0F, player0.getX(), 0.01F);
      assertFalse(player0.isDead());
  }
  ...
  public void test19()  throws Throwable  {
      Player player0 = new Player((-293), "Player.unpack(): *** WARNING *** [IO] failed to unpack data: ", "Player.unpack(): *** WARNING *** [IO] failed to unpack data: ", (-293));
      player0.setX((float) (-293));
      assertEquals((-293.0F), player0.getX(), 0.01F);
  }
  ...
  public void test20()  throws Throwable  {
      Player player0 = new Player(0, "Hlayer.ack(): *** ERROR ***c[IO] pack failed! current sta-e is inconsistPnt: ", 0);
  ...
  public void test22()  throws Throwable  {
      Player player0 = new Player(1197, "0.0.0.0", "0.0.0.0", 1197, 1197);
  ...
  public void test25()  throws Throwable  {
      Player player0 = new Player((int) (byte)0, "9g.(=3jcDo9-s:F2\"", "9g.(=3jcDo9-s:F2\"", (int) (byte)0, (int) (byte)0);
  ...
  public void test27()  throws Throwable  {
      Player player0 = new Player();
      player0.setY((float) 489);
      assertEquals(489.0F, player0.getY(), 0.01F);
  }
}
