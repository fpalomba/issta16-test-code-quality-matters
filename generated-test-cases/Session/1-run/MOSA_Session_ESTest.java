...
public class Session_ESTest extends Session_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        session0 = new Session((IApplication) null, (ISQLDriver) sQLDriver0, sQLAlias0, (SQLConnection) null, "OI%4p+~^BKH4CHe:G", "OI%4p+~^BKH4CHe:G", (IIdentifier) integerIdentifier0);
