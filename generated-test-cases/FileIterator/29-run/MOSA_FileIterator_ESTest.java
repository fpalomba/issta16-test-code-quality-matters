...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("8z\"W", "8z\"W");
      ...
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("8z\"W");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no more fils");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("oJ@cU'vI", "oJ@cU'vI", (File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no more fils");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("no more fils", "no more fils", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile2 = (MockFile)fileIterator0.next();
      assertEquals("no more fils0no more fils", mockFile2.getName());
  }
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile("no more fils");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("oJ@YcU'vI", "oJ@YcU'vI", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      // Undeclared exception!
      try {
  ...
  public void test07()  throws Throwable  {
      ...
      MockFile mockFile2 = (MockFile)MockFile.createTempFile("4Ue[2bi1g%*UoqO", "no more fils", (File) mockFile1);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("yeLHF:T+C($3z");
   ...
   * Goal 11. org.jcvi.jillion.core.util.FileIterator$NonHiddenFileFilter.accept(Ljava/io/File;)Z: I7 Branch 18 IFNE L114 - false
   * Goal 12. org.jcvi.jillion.core.util.FileIterator.<init>(Ljava/io/File;Ljava/io/FileFilter;)V: I10 Branch 5 IFNONNULL L126 - true
