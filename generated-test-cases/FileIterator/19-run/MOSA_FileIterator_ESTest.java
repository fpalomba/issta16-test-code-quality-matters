...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "TCz9'2u7Q':<9YY");
  ...
  public void test03()  throws Throwable  {
      ...
      MockFile mockFile1 = (MockFile)mockFile0.getParentFile();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile1);
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(49, (int) (byte)38, false);
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "TCz9'2u7Q':<9YY");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("cF/.=5%&", "2@_o|6QZ`U]N", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "fileFilter can not be null");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("fileFilter can not be null", " @_/|6oZ$U]N", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertTrue(fileIterator0.hasNext());
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      Pattern pattern0 = Pattern.compile("org.jcvi.jillion.core.util.FileIterator$FileNameComparator", 0);
