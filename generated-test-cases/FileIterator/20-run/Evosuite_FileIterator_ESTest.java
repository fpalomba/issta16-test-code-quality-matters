...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      MockFile mockFile0 = new MockFile("edu.stanford.nlp.util.Pair");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("edu.stanford.nlp.util.Pair", "edu.stanford.nlp.util.Pair", (File) mockFile0);
      MockFile mockFile2 = new MockFile((File) mockFile1, "edu.stanford.nlp.util.Pair");
      ...
      Pattern pattern0 = Pattern.compile("edu.stanford.nlp.util.Pair", (-3900));
      RegExFileFilter regExFileFilter0 = new RegExFileFilter(pattern0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator(mockFile0, regExFileFilter0);
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = (MockFile)MockFile.createTempFile(".[QUg\"O-T]ay(PF", ".[QUg\"O-T]ay(PF");
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter((-1616), (-1616), true);
