...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("qcwf+ )+E<V0");
  ...
  public void test02()  throws Throwable  {
      ...
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("org.jcvi.jillion.core.util.FileIterator");
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("qc(f` s)DEV0");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("qc(f` s)DEV0", "qc(f` s)DEV0", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test06()  throws Throwable  {
      ...
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("%+Kf,");
      // Undeclared exception!
      try {
        FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator((File) null, extensionFileFilter0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".gcGW6jejPT^hB1");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".gcGW6jejPT^hB1", ".gcGW6jejPT^hB1", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
   ...
   * Goal 12. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I7 Branch 1 IFEQ L411 - true
   * Goal 13. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I41 Branch 3 IFEQ L418 - true
   */
   ...
   * Goal 13. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I11 Branch 13 IFNONNULL L270 - true
   * Goal 14. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I7 Branch 1 IFEQ L411 - false
   * Goal 15. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I15 Branch 2 IFEQ L412 - false
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(756, 0, true);
