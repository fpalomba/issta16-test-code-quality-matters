...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter((-3), (-566), false);
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile mockFile1 = new MockFile("", "segments");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator(mockFile1, regExFileFilter0);
  ...
  public void test05()  throws Throwable  {
      ...
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("org.apache.lucene.index.IndexFileNameFilter");
      // Undeclared exception!
      try {
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("/");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".ja_.w[QV^.", ".ja_.w[QV^.", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
   ...
   * Goal 6. org.jcvi.jillion.core.util.FileIterator.hasNext()Z: I7 Branch 10 IFNULL L181 - false
   * Goal 7. org.jcvi.jillion.core.util.FileIterator.next()Ljava/io/File;: I7 Branch 11 IFNE L186 - true
   */
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("/");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("`Mv.YWU\"g&a|P", true);
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(21, (-566), true);
  ...
  /*
   * 2 covered goals:
   * Goal 1. org.jcvi.jillion.core.util.FileIterator.getNextFile()Ljava/io/File;: I8 Branch 9 IFEQ L172 - false
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("/");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter(".ja_.w[QV^.");
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
