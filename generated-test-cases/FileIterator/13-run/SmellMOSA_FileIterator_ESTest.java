...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile(",1SnPf#Tw(S\"X?}F].", ",1SnPf#Tw(S\"X?}F].");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(",1SnPf#Tw(S\"X?}F].", ",1SnPf#Tw(S\"X?}F].", (File) mockFile0);
  ...
  public void test01()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile((File) mockFile0, "rootDir must be a directory");
  ...
  public void test03()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile((File) mockFile0, "deletable");
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator(mockFile1, (FileFilter) null);
   ...
   * Goal 7. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I41 Branch 3 IFEQ L418 - false
   * Goal 8. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I74 Branch 4 IFNULL L426 - false
   */
   ...
   * Goal 4. org.jcvi.jillion.core.util.FileIterator$NonHiddenFileFilter.accept(Ljava/io/File;)Z: I7 Branch 18 IFNE L114 - false
  ...
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/Constructor argument not valid list of number ranges (too maGy hyphens): /Constructor argument not valid list of number ranges (too maGy hyphens): ");
   ...
   * Goal 11. org.jcvi.jillion.core.util.FileIterator$BreadthFirstFileIterator.createDirectoryIterator()Ljava/util/Queue;: root-Branch
   * Goal 12. org.jcvi.jillion.core.util.FileIterator$BreadthFirstFileIterator.<init>(Ljava/io/File;Ljava/io/FileFilter;)V: root-Branch
   ...
   * Goal 14. org.jcvi.jillion.core.util.FileIterator$BreadthFirstFileIteratorBuilder.<init>(Ljava/io/File;)V: root-Branch
   * Goal 15. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.<init>(Ljava/io/File;Ljava/io/FileFilter;)V: root-Branch
   * Goal 16. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFromSubDir()Ljava/io/File;: root-Branch
   * Goal 17. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.setUpInitialState(Ljava/io/File;)V: root-Branch
   ...
   * Goal 26. org.jcvi.jillion.core.util.FileIterator.next()Ljava/io/File;: I7 Branch 11 IFNE L186 - false
