...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(58, 58, true);
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".Z@C$HqP$;HP1", ".Z@C$HqP$;HP1");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".Z@C$HqP$;HP1", ".Z@C$HqP$;HP1", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile(";wY+jbzA");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      // Undeclared exception!
      try {
        FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test07()  throws Throwable  {
      ...
      assertEquals("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/.Z@C$HqP$;HP1/.Z@C$HqP$;HP1", mockFile1.getParent());
  }
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".Z@C$HqP$;HP1", ".Z@C$HqP$;HP1");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter(".Z@C$HqP$;HP1");
   ...
   * Goal 10. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I74 Branch 4 IFNULL L426 - true
   */
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) null);
      Pattern pattern0 = Pattern.compile("", (-237));
