...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("/L`weF^4$l6LVg", "/L`weF^4$l6LVg");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("1nBhNy\u0004>dS,");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("1nBhNy\u0004>dS,", "1nBhNy\u0004>dS,", (File) mockFile0);
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".nFU6hz", "");
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("/L`weF^4$l6LVg", "/L`weF^4$l6LVg");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("/L`weF^4$l6LVg", true);
   ...
   * Goal 6. org.jcvi.jillion.core.util.FileIterator.hasNext()Z: I7 Branch 10 IFNULL L181 - true
   * Goal 7. org.jcvi.jillion.core.util.FileIterator.next()Ljava/io/File;: I7 Branch 11 IFNE L186 - false
   */
  ...
  public void test10()  throws Throwable  {
      ...
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter((-268), (-268), false);
  ...
  public void test13()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("fileFilter can not be null", true);
