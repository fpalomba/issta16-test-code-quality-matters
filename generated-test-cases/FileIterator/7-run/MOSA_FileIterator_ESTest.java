...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("org.jcvi.jillion.core.util.FKleLterator");
      ...
      Pattern pattern0 = Pattern.compile("org.jcvi.jillion.core.util.FKleLterator", 65);
  ...
  public void test03()  throws Throwable  {
      MockFile mockFile0 = new MockFile("org.jcvi.jillion.core.util.FKleLterator");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("org.jcvi.jillion.core.util.FKleLterator", "org.jcvi.jillion.core.util.FKleLterator", (File) mockFile0);
      ...
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile2 = new MockFile("8S-@Vq", "@/W");
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("fileFilter can not be null");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("oHr=C)|", "oHr=C)|", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test05()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".~&)(Nuf(O");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".~&)(Nuf(O", ".~&)(Nuf(O", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test07()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(4452, 0, true);
      // Undeclared exception!
      try {
        Iterator<File> iterator0 = fileIterator0.createNewInstance((File) null, numberRangeFileFilter0);
        fail("Expecting exception: NullPointerException");
   ...
   * Goal 4. org.jcvi.jillion.core.util.FileIterator.next()Ljava/io/File;: I7 Branch 11 IFNE L186 - false
   * Goal 5. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I11 Branch 13 IFNONNULL L270 - false
   * Goal 6. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I17 Branch 14 IFEQ L270 - true
   * Goal 7. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I17 Branch 14 IFEQ L270 - false
   * Goal 8. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.hasMoreSubDirs()Z: I8 Branch 15 IFLE L277 - true
   * Goal 9. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.hasMoreSubDirs()Z: I8 Branch 15 IFLE L277 - false
   * Goal 10. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.hasMoreSubDirs()Z: I20 Branch 16 IFNE L277 - true
   ...
   * Goal 3. org.jcvi.jillion.core.util.FileIterator.remove()V: root-Branch
   ...
   * Goal 6. org.jcvi.jillion.core.util.FileIterator$NonDirectoryFileFilter.accept(Ljava/io/File;)Z: I7 Branch 17 IFNE L108 - true
   ...
   * Goal 14. org.jcvi.jillion.core.util.FileIterator$NonDirectoryFileFilter.accept(Ljava/io/File;)Z: I7 Branch 17 IFNE L108 - false
   * Goal 15. org.jcvi.jillion.core.util.FileIterator$NonHiddenFileFilter.accept(Ljava/io/File;)Z: I7 Branch 18 IFNE L114 - false
   ...
   * Goal 20. org.jcvi.jillion.core.util.FileIterator.getNextFile()Ljava/io/File;: I8 Branch 9 IFEQ L172 - false
   ...
   * Goal 22. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I11 Branch 13 IFNONNULL L270 - true
