...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("rootDir can not be ul", "rootDir can not be ul");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("rootDir can not be ul", "rootDir can not be ul");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("rootDir can not be ul", "rootDir can not be ul", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/rootDir can not be ul/rootDir can not be ul/rootDir can not be ul0rootDir can not be ul", mockFile1.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      Pattern pattern0 = Pattern.compile("", (-3062));
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = new MockFile("Gc&4teG|&qz\")5Z(u");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("Gc&4teG|&qz\")5Z(u", "", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      // Undeclared exception!
      try {
