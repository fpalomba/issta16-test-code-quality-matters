...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(3397, 12, true);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator(mockFile0, numberRangeFileFilter0);
      MockFile mockFile1 = new MockFile("@S%?qA)+", "\"lb~MWB");
  ...
  public void test03()  throws Throwable  {
      ...
      MockFile mockFile2 = new MockFile((File) mockFile1, "");
      MockFile mockFile3 = (MockFile)mockFile2.getParentFile();
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile3);
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("@S%?qA)+", "\"lb~MWB");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      // Undeclared exception!
      try {
        FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("i5");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".v['ek2bbkiG", "6_v", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
