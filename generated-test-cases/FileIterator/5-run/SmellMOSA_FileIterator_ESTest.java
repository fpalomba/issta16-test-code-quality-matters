...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(90, 90, false);
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".b6s8ZrSlJ7N>", ".b6s8ZrSlJ7N>");
      ...
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".b6s8ZrSlJ7N>", ".b6s8ZrSlJ7N>", (File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile("rootDir cn not be null", "rootDir cn not be null");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("rootDir cn not be null", "rootDir cn not be null", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeHiddenFiles(true);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertTrue(fileIterator0.hasNext());
   ...
   * Goal 6. org.jcvi.jillion.core.util.FileIterator$NonRecursiveFileIteratorBuilder.createFileIterator(Ljava/io/File;Ljava/io/FileFilter;)Lorg/jcvi/jillion/core/util/FileIterator;: root-Branch
   ...
   * Goal 8. org.jcvi.jillion.core.util.FileIterator$NonHiddenFileFilter.accept(Ljava/io/File;)Z: I7 Branch 18 IFNE L114 - false
  ...
  public void test08()  throws Throwable  {
      MockFile mockFile0 = new MockFile("rootDir cn not be null", "rootDir cn not be null");
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/rootDir cn not be null/rootDir cn not be null/rootDir cn not be null0rootDir cn not be null");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
   ...
   * Goal 12. org.jcvi.jillion.core.util.FileIterator$FileNameComparator.compare(Ljava/io/File;Ljava/io/File;)I: root-Branch
   * Goal 13. org.jcvi.jillion.core.util.FileIterator$NonDirectoryFileFilter.accept(Ljava/io/File;)Z: I7 Branch 17 IFNE L108 - true
   ...
   * Goal 18. org.jcvi.jillion.core.util.FileIterator.getFilesFor(Ljava/io/File;)Ljava/util/Iterator;: I13 Branch 8 IFNONNULL L152 - false
   * Goal 19. org.jcvi.jillion.core.util.FileIterator.getNextFile()Ljava/io/File;: I8 Branch 9 IFEQ L172 - true
   * Goal 20. org.jcvi.jillion.core.util.FileIterator.hasNext()Z: I7 Branch 10 IFNULL L181 - true
   * Goal 21. org.jcvi.jillion.core.util.FileIterator.next()Ljava/io/File;: I7 Branch 11 IFNE L186 - false
   ...
   * Goal 23. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getSubdirectoriesFor(Ljava/io/File;)Ljava/util/List;: I12 Branch 12 IFNONNULL L253 - false
  ...
  public void test09()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile1 = new MockFile((File) mockFile0, "e zM#x9a@|`3TWHE u");
