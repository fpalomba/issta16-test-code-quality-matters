...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      MockFile mockFile0 = (MockFile)MockFile.createTempFile("rootDir can not be null", "rootDir can not be null");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".F<!3o", "");
      ...
      MockFile mockFile1 = new MockFile((File) mockFile0, ".F<!3o");
      MockFile mockFile2 = (MockFile)MockFile.createTempFile("rootDir can not be null", "", (File) mockFile1);
      MockFile mockFile3 = (MockFile)mockFile1.getParentFile();
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("");
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator(mockFile3, extensionFileFilter0);
      MockFile mockFile4 = (MockFile)fileIterator0.next();
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".F<!3o", "");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("rootDir can not be null", "", (File) mockFile0);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("");
  ...
  public void test07()  throws Throwable  {
      ...
      MockFile mockFile1 = new MockFile((File) mockFile0, "rootDir can not be null");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile1);
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("rootDir can not be null", true);
   ...
   * Goal 8. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.includeHiddenFiles(Z)Lorg/jcvi/jillion/core/util/FileIterator$FileIteratorBuilder;: root-Branch
   * Goal 9. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.includeDirectories(Z)Lorg/jcvi/jillion/core/util/FileIterator$FileIteratorBuilder;: root-Branch
   * Goal 10. org.jcvi.jillion.core.util.FileIterator.getNextFile()Ljava/io/File;: I8 Branch 9 IFEQ L172 - false
   * Goal 11. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I11 Branch 13 IFNONNULL L270 - true
   * Goal 12. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I7 Branch 1 IFEQ L411 - false
   * Goal 13. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I15 Branch 2 IFEQ L412 - false
   */

  @Test
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("l1c", "l1c");
