...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("{*@9]UR,-wC!VYu");
  ...
  public void test02()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "M s zbr>hDC@uN");
  ...
  public void test03()  throws Throwable  {
      MockFile mockFile0 = new MockFile("", "M s zbr>hDC@uN");
      MockFile mockFile1 = (MockFile)mockFile0.getParentFile();
      MockFile mockFile2 = (MockFile)MockFile.createTempFile("M s zbr>hDC@uN", "", (File) mockFile1);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile1);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertTrue(fileIterator0.hasNext());
  ...
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder((File) mockFile0);
      NumberRangeFileFilter numberRangeFileFilter0 = new NumberRangeFileFilter(11, 11, true);
  ...
  public void test09()  throws Throwable  {
      MockFile mockFile0 = (MockFile)MockFile.createTempFile("Constru`tor argumqnt8not valid list of number ranges ", "Constru`tor argumqnt8not valid list of number ranges ");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeHiddenFiles(true);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder2 = fileIterator_FileIteratorBuilder1.includeDirectories(true);
      // Undeclared exception!
  ...
  public void test10()  throws Throwable  {
      MockFile mockFile0 = new MockFile("=q_11wP<PiwNfIrmw");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("=q_11wP<PiwNfIrmw", "=q_11wP<PiwNfIrmw", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".m.8M4Ce\u0003I~{&UM)+");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".m.8M4Ce\u0003I~{&UM)+", ".m.8M4Ce\u0003I~{&UM)+", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
   ...
   * Goal 15. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getSubdirectoriesFor(Ljava/io/File;)Ljava/util/List;: I12 Branch 12 IFNONNULL L253 - true
   * Goal 16. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I11 Branch 13 IFNONNULL L270 - false
   * Goal 17. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I17 Branch 14 IFEQ L270 - true
   ...
   * Goal 20. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I41 Branch 3 IFEQ L418 - true
   */
   ...
   * Goal 8. org.jcvi.jillion.core.util.FileIterator$FileIteratorBuilder.build()Lorg/jcvi/jillion/core/util/FileIterator;: I41 Branch 3 IFEQ L418 - false
