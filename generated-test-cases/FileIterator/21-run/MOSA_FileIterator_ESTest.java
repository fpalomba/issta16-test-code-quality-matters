...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      MockFile mockFile0 = new MockFile("K{B%XA`", "IG93S:?U$u|");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("6FLSh^hh,xW\"", "6FLSh^hh,xW\"", (File) mockFile0);
      ...
      ExtensionFileFilter extensionFileFilter0 = new ExtensionFileFilter("IG93S:?U$u|", false);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.createFileIterator(mockFile0, extensionFileFilter0);
   ...
   * Goal 2. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getNextFile()Ljava/io/File;: I11 Branch 13 IFNONNULL L270 - true
   */

  @Test
  public void test06()  throws Throwable  {
      MockFile mockFile0 = new MockFile("e~1Xq%j^4B_S;{B", "e~1Xq%j^4B_S;{B");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("e~1Xq%j^4B_S;{B", "", (File) mockFile0);
  ...
  public void test07()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".^Mk)-bfAg3PHT", ".^Mk)-bfAg3PHT");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
   ...
   * Goal 7. org.jcvi.jillion.core.util.FileIterator.getFilesFor(Ljava/io/File;)Ljava/util/Iterator;: I13 Branch 8 IFNONNULL L152 - false
   * Goal 8. org.jcvi.jillion.core.util.FileIterator$RecursiveFileIterator.getSubdirectoriesFor(Ljava/io/File;)Ljava/util/List;: I12 Branch 12 IFNONNULL L253 - false
  ...
  public void test09()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile1 = new MockFile("B[>|klc#.e[j9$ks$V");
   ...
   * Goal 10. org.jcvi.jillion.core.util.FileIterator$NonDirectoryFileFilter.accept(Ljava/io/File;)Z: I7 Branch 17 IFNE L108 - false
   * Goal 11. org.jcvi.jillion.core.util.FileIterator$NonHiddenFileFilter.accept(Ljava/io/File;)Z: I7 Branch 18 IFNE L114 - true
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".^Mk)-bfAg3PHT", ".^Mk)-bfAg3PHT");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile(".^Mk)-bfAg3PHT", "", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder((File) mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
