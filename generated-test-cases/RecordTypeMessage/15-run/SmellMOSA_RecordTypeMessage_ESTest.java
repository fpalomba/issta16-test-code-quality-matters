...
public class RecordTypeMessage_ESTest extends RecordTypeMessage_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals(23, byteArrayList0.length());
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setResponseText("After QP reeTransformer:          ", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test03()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?i:as|than)$/ ) <4 /^CD|DT/ ) ] ", (XBUSSystem) null, "QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?i:as|than)$/ ) <4 /^CD|DT/ ) ] ");
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?i:as|than)$/ ) <4 /^CD|DT/ ) ] ", recordTypeMessage0.getFunction());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?i:as|than)$/ ) <4 /^CD|DT/ ) ] ", recordTypeMessage0.getId());
  ...
  public void test04()  throws Throwable  {
      ...
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("M", recordTypeMessage0.getFunction());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("M", recordTypeMessage0.getId());
      assertNotNull(recordTypeMessage0);
      
      byte[] byteArray0 = new byte[13];
      ByteArrayList byteArrayList0 = ByteArrayList.createByteArrayList(byteArray0, (int) (byte)0);
      assertEquals(13, byteArrayList0.length());
  ...
  public void test07()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("r>2vdHGt", (XBUSSystem) null, "r>2vdHGt");
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("r>2vdHGt", recordTypeMessage0.getId());
      assertEquals("r>2vdHGt", recordTypeMessage0.getFunction());
      assertNull(recordTypeMessage0.getErrortext());
      assertNotNull(recordTypeMessage0);
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setRequestText("Given ofset and e gth exceedQThe ar>a lejgth", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test11()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?ias|than)$ ) <4 /CD|DT/ ) ] ", (XBUSSystem) null, "QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?ias|than)$ ) <4 /CD|DT/ ) ] ");
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?ias|than)$ ) <4 /CD|DT/ ) ] ", recordTypeMessage0.getId());
      assertEquals("QP <1 /^RB|JJ|IN/=left [ ( <2 /^JJ|IN/=right <3 /^CD|DT/ ) | ( <2 /^JJ|IN/ <3 ( IN=right < /^(?ias|than)$ ) <4 /CD|DT/ ) ] ", recordTypeMessage0.getFunction());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertNotNull(recordTypeMessage0);
   ...
   * Goal 3. net.sf.xbus.protocol.records.RecordTypeMessage.setRequestObject(Ljava/lang/Object;Lnet/sf/xbus/base/xbussystem/XBUSSystem;)V: I29 Branch 7 IFNE L181 - false
   */
