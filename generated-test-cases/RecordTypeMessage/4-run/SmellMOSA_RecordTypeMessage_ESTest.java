...
public class RecordTypeMessage_ESTest extends RecordTypeMessage_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", (XBUSSystem) null, "[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]");
      assertNotNull(recordTypeMessage0);
      assertEquals("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", recordTypeMessage0.getFunction());
      assertEquals("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", recordTypeMessage0.getId());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      ...
      try {
        recordTypeMessage0.setResponseText("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", (XBUSSystem) null);
  ...
  public void test04()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum reateSubtree QP l2 r2] [if not exists num createSubtree NP l2 r2]", (XBUSSystem) null, "[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum reateSubtree QP l2 r2] [if not exists num createSubtree NP l2 r2]");
      assertNotNull(recordTypeMessage0);
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum reateSubtree QP l2 r2] [if not exists num createSubtree NP l2 r2]", recordTypeMessage0.getFunction());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum reateSubtree QP l2 r2] [if not exists num createSubtree NP l2 r2]", recordTypeMessage0.getId());
  ...
  public void test08()  throws Throwable  {
      ...
      try {
        recordTypeMessage0.setRequestObject((Object) "[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", (XBUSSystem) null);
  ...
  public void test09()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("followed", (XBUSSystem) null, "followed");
      assertNotNull(recordTypeMessage0);
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("followed", recordTypeMessage0.getId());
      assertEquals("followed", recordTypeMessage0.getFunction());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
      ...
      assertEquals(1, byteArrayList0.length());
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setRequestText("[if exists lnum createSubtree QP l1 r1] [if not exists lnum createSubtree NP l1 r1] [if exists rnum createSubtree QP l2 r2] [if not exists rnum createSubtree NP l2 r2]", (XBUSSystem) null);
        fail("Expecting exception: NullPointerException");
