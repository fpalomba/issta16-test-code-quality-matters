...
public class RecordTypeMessage_ESTest extends RecordTypeMessage_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("fercombineConjp:              ", (XBUSSystem) null, "fercombineConjp:              ");
      ...
      assertEquals("fercombineConjp:              ", recordTypeMessage0.getFunction());
      assertEquals("fercombineConjp:              ", recordTypeMessage0.getId());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      
      // Undeclared exception!
      try {
        recordTypeMessage0.setResponseText("fercombineConjp:              ", (XBUSSystem) null);
  ...
  public void test02()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("oernor om depenent cant bT ul", (XBUSSystem) null, "oernor om depenent cant bT ul");
      assertNotNull(recordTypeMessage0);
      assertEquals("oernor om depenent cant bT ul", recordTypeMessage0.getFunction());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("oernor om depenent cant bT ul", recordTypeMessage0.getId());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
  ...
  public void test03()  throws Throwable  {
      ...
      //  // Unstable assertion: assertEquals(16, byteArrayList0.length());
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setRequestText("SimpleHttpConnectionManager 1eing used incorr%ctly.W Be2sure that HttpMethod.releaseConnection() is always called a> that only one (hread and/or method is using this connecton manager at a time.", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test09()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("fercombneConjp:              ", (XBUSSystem) null, "fercombneConjp:              ");
      assertNotNull(recordTypeMessage0);
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("fercombneConjp:              ", recordTypeMessage0.getId());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("fercombneConjp:              ", recordTypeMessage0.getFunction());
