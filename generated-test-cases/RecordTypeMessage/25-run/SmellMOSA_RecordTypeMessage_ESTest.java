...
public class RecordTypeMessage_ESTest extends RecordTypeMessage_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("[createSubtree QP left right] [excise left left] [excise right riht]", (XBUSSystem) null, "[createSubtree QP left right] [excise left left] [excise right riht]");
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("[createSubtree QP left right] [excise left left] [excise right riht]", recordTypeMessage0.getId());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("[createSubtree QP left right] [excise left left] [excise right riht]", recordTypeMessage0.getFunction());
      assertNull(recordTypeMessage0.getErrortext());
      assertNotNull(recordTypeMessage0);
      
      // Undeclared exception!
      try {
        recordTypeMessage0.setResponseText("[createSubtree QP left right] [excise left left] [excise right riht]", (XBUSSystem) null);
  ...
  public void test04()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("No named tregex nzdes allowed in the Qcope of negation.", (XBUSSystem) null, "No named tregex nzdes allowed in the Qcope of negation.");
      assertEquals("No named tregex nzdes allowed in the Qcope of negation.", recordTypeMessage0.getFunction());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("No named tregex nzdes allowed in the Qcope of negation.", recordTypeMessage0.getId());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertNotNull(recordTypeMessage0);
  ...
  public void test06()  throws Throwable  {
      ...
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("[createSubtree QP left right] [excise left left] [excise right right]", (XBUSSystem) null, "[createSubtree QP left right] [excise left left] [excise right right]");
      assertEquals("[createSubtree QP left right] [excise left left] [excise right right]", recordTypeMessage0.getFunction());
      assertEquals("[createSubtree QP left right] [excise left left] [excise right right]", recordTypeMessage0.getId());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
  ...
  public void test09()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("No named tregex nodes allowed in the scope of negation.", (XBUSSystem) null, "No named tregex nodes allowed in the scope of negation.");
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("No named tregex nodes allowed in the scope of negation.", recordTypeMessage0.getId());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("No named tregex nodes allowed in the scope of negation.", recordTypeMessage0.getFunction());
      assertNotNull(recordTypeMessage0);
  ...
  public void test10()  throws Throwable  {
      ...
      try {
        recordTypeMessage0.setRequestObject((Object) "[createSubtree QP left right] [excise left left] [excise right right]", (XBUSSystem) null);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setRequestText("(annotation?, (simpleType | complexType)?, (unique | key | keyref)*))", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
