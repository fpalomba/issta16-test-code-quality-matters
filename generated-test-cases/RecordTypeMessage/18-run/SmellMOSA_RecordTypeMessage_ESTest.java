...
public class RecordTypeMessage_ESTest extends RecordTypeMessage_ESTest_scaffolding {
   ...
   * Goal 2. net.sf.xbus.protocol.records.RecordTypeMessage.getRequestObject(Lnet/sf/xbus/base/xbussystem/XBUSSystem;)Ljava/lang/Object;: I16 Branch 8 IFNULL L216 - true
  ...
  public void test01()  throws Throwable  {
      ...
      int int0 = recordTypeMessage0.getErrorcode();
      assertEquals(0, int0);
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("", recordTypeMessage0.getId());
      ...
      assertEquals(7, byteArrayList0.length());
  ...
  public void test02()  throws Throwable  {
      ...
      ByteArrayList byteArrayList0 = ByteArrayList.createByteArrayList(byteArray0, (int) (byte) (-3));
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setRequestText("ERROR: to use SUTime, sentences must have TextAnnotation set, or the individual tokens must hae OhignalTextAnnotation or TextAnnotation set!", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setResponseText("ERROR: to use SUTime, sentences must have TextAnnotation set, or the individual tokens musthave OriginalTextAnnotation or TextAnnotatiot set!", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test10()  throws Throwable  {
      ...
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("ERROR: to use SUTime, sentences must have TextAnnotation set, or the individual tokens must hae OhignalTextAnnotation or TextAnnotation set!", (XBUSSystem) null, "ERROR: to use SUTime, sentences must have TextAnnotation set, or the individual tokens must hae OhignalTextAnnotation or TextAnnotation set!");
      assertNotNull(recordTypeMessage0);
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("ERROR: to use SUTime, sentences must have TextAnnotation set, or the individual tokens must hae OhignalTextAnnotation or TextAnnotation set!", recordTypeMessage0.getId());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("ERROR: to use SUTime, sentences must have TextAnnotation set, or the individual tokens must hae OhignalTextAnnotation or TextAnnotation set!", recordTypeMessage0.getFunction());
