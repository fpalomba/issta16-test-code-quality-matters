...
public class RecordTypeMessage_ESTest extends RecordTypeMessage_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      try {
        recordTypeMessage0.setRequestText("/^SPP|VP|NP/ < (/^(S|PP|VP|NP)/$++ (/^(,|CC|CONJP)$/ [ $+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB) ])) : (=adv $+ /^(S|PP|VP|NP)/=dest) ", (XBUSSystem) null);
  ...
  public void test04()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("er CTran#former: A   w      ", (XBUSSystem) null, "er CTran#former: A   w      ");
      assertNotNull(recordTypeMessage0);
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("er CTran#former: A   w      ", recordTypeMessage0.getId());
      assertEquals("er CTran#former: A   w      ", recordTypeMessage0.getFunction());
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        recordTypeMessage0.setResponseText("SB4RQ < (VHNP=wha% < WP)$+ (SQ=sq < (/^Vg/=v*rb < ", (XBUSSystem) null);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
  ...
  public void test06()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("/^S|3P|VP|NP/ < (/^(S|PP|VP|NP)/ $++ (/^(,|CC|CONJP)$/ [ $+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB) ])) : (=adv $+ /^(S|PP|VP|NP)/=dest) ", (XBUSSystem) null, "/^S|3P|VP|NP/ < (/^(S|PP|VP|NP)/ $++ (/^(,|CC|CONJP)$/ [ $+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB) ])) : (=adv $+ /^(S|PP|VP|NP)/=dest) ");
      assertNotNull(recordTypeMessage0);
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("/^S|3P|VP|NP/ < (/^(S|PP|VP|NP)/ $++ (/^(,|CC|CONJP)$/ [ $+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB) ])) : (=adv $+ /^(S|PP|VP|NP)/=dest) ", recordTypeMessage0.getId());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("/^S|3P|VP|NP/ < (/^(S|PP|VP|NP)/ $++ (/^(,|CC|CONJP)$/ [ $+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB) ])) : (=adv $+ /^(S|PP|VP|NP)/=dest) ", recordTypeMessage0.getFunction());
      assertNull(recordTypeMessage0.getErrortext());
   ...
   * Goal 2. net.sf.xbus.protocol.records.RecordTypeMessage.setResponseText(Ljava/lang/String;Lnet/sf/xbus/base/xbussystem/XBUSSystem;)V: I21 Branch 3 IFNONNULL L132 - false
   */
  ...
  public void test10()  throws Throwable  {
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("SB4RQ < (VHNP=wha% < WP)$+ (SQ=sq < (/Vg/=v*rb < ", (XBUSSystem) null, "SB4RQ < (VHNP=wha% < WP)$+ (SQ=sq < (/Vg/=v*rb < ");
      assertNotNull(recordTypeMessage0);
      assertEquals("SB4RQ < (VHNP=wha% < WP)$+ (SQ=sq < (/Vg/=v*rb < ", recordTypeMessage0.getFunction());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("SB4RQ < (VHNP=wha% < WP)$+ (SQ=sq < (/Vg/=v*rb < ", recordTypeMessage0.getId());
  ...
  public void test11()  throws Throwable  {
      ...
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("H(]{)0aF)", (XBUSSystem) null, "H(]{)0aF)");
      assertNotNull(recordTypeMessage0);
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertNull(recordTypeMessage0.getErrortext());
      assertEquals("H(]{)0aF)", recordTypeMessage0.getId());
      assertEquals("H(]{)0aF)", recordTypeMessage0.getFunction());
      assertEquals(0, recordTypeMessage0.getErrorcode());
  ...
  public void test12()  throws Throwable  {
      ...
      RecordTypeMessage recordTypeMessage0 = new RecordTypeMessage("{W84i)=\"_", (XBUSSystem) null, "{W84i)=\"_");
      assertNotNull(recordTypeMessage0);
      assertEquals("RC_OK", recordTypeMessage0.getReturncode());
      assertEquals("RecordTypeMessage", recordTypeMessage0.getShortname());
      assertEquals(0, recordTypeMessage0.getErrorcode());
      assertEquals("{W84i)=\"_", recordTypeMessage0.getId());
      assertEquals("{W84i)=\"_", recordTypeMessage0.getFunction());
      assertNull(recordTypeMessage0.getErrortext());
