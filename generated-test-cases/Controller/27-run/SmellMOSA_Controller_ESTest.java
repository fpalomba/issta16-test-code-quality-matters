...
public class Controller_ESTest extends Controller_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      assertFalse(defaultTreeCellRenderer0.isMinimumSizeSet());
      assertFalse(defaultTreeCellRenderer0.getIgnoreRepaint());
      assertFalse(defaultTreeCellRenderer0.isLightweight());
      assertFalse(defaultTreeCellRenderer0.isFocusCycleRoot());
      assertFalse(defaultTreeCellRenderer0.isDisplayable());
      assertFalse(defaultTreeCellRenderer0.isBackgroundSet());
      assertFalse(defaultTreeCellRenderer0.isFocusTraversalPolicySet());
      assertTrue(defaultTreeCellRenderer0.isForegroundSet());
      assertEquals(0, defaultTreeCellRenderer0.countComponents());
      assertFalse(defaultTreeCellRenderer0.isShowing());
      assertFalse(defaultTreeCellRenderer0.isFocusTraversalPolicyProvider());
      assertFalse(defaultTreeCellRenderer0.isFontSet());
      assertFalse(defaultTreeCellRenderer0.isValid());
      assertTrue(defaultTreeCellRenderer0.isEnabled());
      assertFalse(defaultTreeCellRenderer0.isCursorSet());
      ...
      assertFalse(defaultTreeCellRenderer0.isPreferredSizeSet());
      assertFalse(defaultTreeCellRenderer0.isMaximumSizeSet());
      ...
      try {
        Color color0 = Controller.showCommonJColorChooserDialog((Component) defaultTreeCellRenderer0, "@7n:<`'", (Color) printColorUIResource0);
