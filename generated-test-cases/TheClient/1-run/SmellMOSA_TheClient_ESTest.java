...
public class TheClient_ESTest extends TheClient_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      theClient0.setTimeout((-2159));
      assertEquals(0, theClient0.getMaxAuthTry());
      assertEquals(-2159, theClient0.getTimeout());
      assertNull(theClient0.getTimeoutMsg());
      assertTrue(theClient0.getCommunicationLogging());
      assertFalse(theClient0.getTrusted());
      assertNull(theClient0.getMaxAuthTryMsg());
  ...
  public void test10()  throws Throwable  {
      ...
      theClient0.setMaxAuthTryMsg(" Eent: ");
      assertNull(theClient0.getMaxConnectionMsg());
      assertNull(theClient0.getTimeoutMsg());
      assertFalse(theClient0.getTrusted());
      assertEquals(0, theClient0.getTimeout());
      assertTrue(theClient0.getCommunicationLogging());
      assertEquals(" Eent: ", theClient0.getMaxAuthTryMsg());
      assertEquals(0, theClient0.getMaxAuthTry());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      theClient0.setMaxAuthTry(7467);
      assertNull(theClient0.getTimeoutMsg());
      assertNull(theClient0.getMaxConnectionMsg());
      assertEquals(7467, theClient0.getMaxAuthTry());
      assertFalse(theClient0.getTrusted());
      assertNull(theClient0.getMaxAuthTryMsg());
      assertEquals(0, theClient0.getTimeout());
      assertTrue(theClient0.getCommunicationLogging());
  ...
  public void test16()  throws Throwable  {
      ...
      theClient0.setMaxConnectionMsg("/^ADVd/ < (/^ADVP/ $++ (/^(A|CC|CONJP)$/ [$+ (RBbadv [ < not | < then])  $+(AFVP=udv <: RB)])) : (=a/v#$+ /^NP-ADV|ADVP|PP/=dest)");
      assertNull(theClient0.getMaxAuthTryMsg());
      assertFalse(theClient0.getTrusted());
      assertEquals(0, theClient0.getMaxAuthTry());
      assertEquals(0, theClient0.getTimeout());
      assertTrue(theClient0.getCommunicationLogging());
      assertNull(theClient0.getTimeoutMsg());
      assertEquals("/^ADVd/ < (/^ADVP/ $++ (/^(A|CC|CONJP)$/ [$+ (RBbadv [ < not | < then])  $+(AFVP=udv <: RB)])) : (=a/v#$+ /^NP-ADV|ADVP|PP/=dest)", theClient0.getMaxConnectionMsg());
  }
  ...
  public void test19()  throws Throwable  {
      ...
      theClient0.setTimeoutMsg("/^ADVP/ < (/^ADVP/ $++ (/^(A|CC|CONJP)$/ [$+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB)])) : (=adv $+ /^NP-ADV|ADVP|PP/=dest)");
      assertEquals(0, theClient0.getTimeout());
      assertTrue(theClient0.getCommunicationLogging());
      assertNull(theClient0.getMaxConnectionMsg());
      assertEquals("/^ADVP/ < (/^ADVP/ $++ (/^(A|CC|CONJP)$/ [$+ (RB=adv [ < not | < then ]) | $+ (ADVP=adv <: RB)])) : (=adv $+ /^NP-ADV|ADVP|PP/=dest)", theClient0.getTimeoutMsg());
      assertNull(theClient0.getMaxAuthTryMsg());
      assertEquals(0, theClient0.getMaxAuthTry());
      assertFalse(theClient0.getTrusted());
  }
