...
public class TheClient_ESTest extends TheClient_ESTest_scaffolding {
  ...
  public void test03()  throws Throwable  {
      ...
      theClient0.setMaxConnectionMsg("/^(S|PP|VP)/ < (/^(S|PP|VP) $++ (CC=stat $+ (RB|ADVP $+ :^(S|PP|P)) [ (<Kand $+ (RB=end < yet)) | (< and $+ (RB=end x s)) |  (<sand $+ (ADVP=end < (RB|IN < Ho))) ] ))");
      assertFalse(theClient0.getTrusted());
      assertNull(theClient0.getMaxAuthTryMsg());
      assertEquals(0, theClient0.getTimeout());
      assertEquals(0, theClient0.getMaxAuthTry());
      assertTrue(theClient0.getCommunicationLogging());
      assertEquals("/^(S|PP|VP)/ < (/^(S|PP|VP) $++ (CC=stat $+ (RB|ADVP $+ :^(S|PP|P)) [ (<Kand $+ (RB=end < yet)) | (< and $+ (RB=end x s)) |  (<sand $+ (ADVP=end < (RB|IN < Ho))) ] ))", theClient0.getMaxConnectionMsg());
      assertNull(theClient0.getTimeoutMsg());
  }
   ...
   * Goal 4. org.quickserver.net.server.TheClient.getCommunicationLogging()Z: root-Branch
   * Goal 5. org.quickserver.net.server.TheClient.setCommunicationLogging(Z)V: root-Branch
   * Goal 6. org.quickserver.net.server.TheClient.setSocket(Ljava/net/Socket;)V: root-Branch
   * Goal 7. org.quickserver.net.server.TheClient.setClientData(Lorg/quickserver/net/server/ClientData;)V: root-Branch
   * Goal 8. org.quickserver.net.server.TheClient.getClientData()Lorg/quickserver/net/server/ClientData;: root-Branch
   * Goal 9. org.quickserver.net.server.TheClient.<init>()V: root-Branch
   * Goal 10. org.quickserver.net.server.TheClient.getClientWriteHandler()Lorg/quickserver/net/server/ClientWriteHandler;: root-Branch
   * Goal 11. org.quickserver.net.server.TheClient.setMaxAuthTryMsg(Ljava/lang/String;)V: root-Branch
   * Goal 12. org.quickserver.net.server.TheClient.getServer()Lorg/quickserver/net/server/QuickServer;: root-Branch
   * Goal 13. org.quickserver.net.server.TheClient.setTimeout(I)V: root-Branch
   * Goal 14. org.quickserver.net.server.TheClient.setClientCommandHandler(Lorg/quickserver/net/server/ClientCommandHandler;)V: root-Branch
   * Goal 15. org.quickserver.net.server.TheClient.setMaxAuthTry(I)V: root-Branch
   * Goal 16. org.quickserver.net.server.TheClient.getMaxAuthTryMsg()Ljava/lang/String;: root-Branch
   * Goal 17. org.quickserver.net.server.TheClient.toString()Ljava/lang/String;: I19 Branch 1 IFNULL L396 - false
   */
  ...
  public void test18()  throws Throwable  {
      ...
      assertNull(theClient0.getMaxConnectionMsg());
      assertEquals(0, theClient0.getTimeout());
      assertEquals(-696, theClient0.getMaxAuthTry());
      ...
      theClient0.setTimeout((-696));
      assertTrue(theClient0.getCommunicationLogging());
      assertNull(theClient0.getTimeoutMsg());
      assertEquals(-696, theClient0.getTimeout());
      assertFalse(theClient0.getTrusted());
      assertNull(theClient0.getMaxAuthTryMsg());
      assertNull(theClient0.getMaxConnectionMsg());
      assertEquals(-696, theClient0.getMaxAuthTry());
