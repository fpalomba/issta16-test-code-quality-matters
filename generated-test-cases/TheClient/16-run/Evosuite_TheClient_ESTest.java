...
public class TheClient_ESTest extends TheClient_ESTest_scaffolding {
   ...
   * Goal 6. org.quickserver.net.server.TheClient.setCommunicationLogging(Z)V: root-Branch
   * Goal 7. org.quickserver.net.server.TheClient.setAuthenticator(Lorg/quickserver/net/server/Authenticator;)V: root-Branch
   * Goal 8. org.quickserver.net.server.TheClient.setClientWriteHandler(Lorg/quickserver/net/server/ClientWriteHandler;)V: root-Branch
   ...
   * Goal 14. org.quickserver.net.server.TheClient.setClientBinaryHandler(Lorg/quickserver/net/server/ClientBinaryHandler;)V: root-Branch
   * Goal 15. org.quickserver.net.server.TheClient.setClientCommandHandler(Lorg/quickserver/net/server/ClientCommandHandler;)V: root-Branch
   * Goal 16. org.quickserver.net.server.TheClient.setMaxAuthTry(I)V: root-Branch
   */
