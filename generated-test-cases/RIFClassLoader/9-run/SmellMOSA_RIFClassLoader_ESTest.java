...
public class RIFClassLoader_ESTest extends RIFClassLoader_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        rIFClassLoader0.registerClass("D8*a?) c_", byteArray0);
        fail("Expecting exception: ClassFormatError");
      
      } catch(ClassFormatError e) {
         //
         // Incompatible magic value 0 in class file D8*a?) c_
         //
      }
  }
  ...
  public void test1()  throws Throwable  {
      ...
      Class<?> class0 = rIFClassLoader0.loadClass("{X<Rq5Bf^3KBBFEv");
      assertNull(class0);
  }
}
