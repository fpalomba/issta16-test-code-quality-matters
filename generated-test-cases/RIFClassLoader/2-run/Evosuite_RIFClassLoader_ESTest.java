...
public class RIFClassLoader_ESTest extends RIFClassLoader_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        rIFClassLoader0.registerClass("e)!iX^m~Av91B:I", byteArray0);
        fail("Expecting exception: ClassFormatError");
      
      } catch(ClassFormatError e) {
         //
         // Incompatible magic value 0 in class file e)!iX^m~Av91B:I
         //
      }
  }
  ...
  public void test1()  throws Throwable  {
      RIFClassLoader rIFClassLoader0 = new RIFClassLoader();
      Class<?> class0 = rIFClassLoader0.loadClass("enh@L9,%P*f}yrdlpGL");
      assertNull(class0);
  }
}
