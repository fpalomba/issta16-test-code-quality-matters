...
public class RIFClassLoader_ESTest extends RIFClassLoader_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        rIFClassLoader0.registerClass("}NZ-lU6>/)ogWC_#X30", byteArray0);
        fail("Expecting exception: NoClassDefFoundError");
      
      } catch(NoClassDefFoundError e) {
         //
         // IllegalName: }NZ-lU6>/)ogWC_#X30
         //
      }
  }
  ...
  public void test1()  throws Throwable  {
      RIFClassLoader rIFClassLoader0 = new RIFClassLoader();
      Class<?> class0 = rIFClassLoader0.loadClass("}NZ-lU6>/)ogWC_#X30");
      assertNull(class0);
  }
}
