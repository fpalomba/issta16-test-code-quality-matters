...
public class RIFClassLoader_ESTest extends RIFClassLoader_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        rIFClassLoader0.registerClass("\"_FI[rIlW?'", byteArray0);
        fail("Expecting exception: ClassFormatError");
      
      } catch(ClassFormatError e) {
         //
         // Incompatible magic value 0 in class file \"_FI[rIlW?'
         //
      }
  }
  ...
  public void test1()  throws Throwable  {
      RIFClassLoader rIFClassLoader0 = new RIFClassLoader();
      Class<?> class0 = rIFClassLoader0.findClass("xnU6A{'/kj^!9G&.W");
      assertNull(class0);
  }
}
