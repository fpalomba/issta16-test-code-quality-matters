...
public class SupportingDocument_ESTest extends SupportingDocument_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      SupportingDocument supportingDocument0 = new SupportingDocument();
      supportingDocument0.setFileName("Z8Fv%CX-Vl}j|#s~ 1");
      User user0 = new User("supportingDocument.title.saveChanges", "S9gD@'<!ES|-x@o");
      SupportingDocument supportingDocument1 = new SupportingDocument();
  ...
  public void test02()  throws Throwable  {
      SupportingDocument supportingDocument0 = new SupportingDocument();
      User user0 = new User("supportingDocument.title.saveChanges", "S9gD@'<!ES|-x@o");
      supportingDocument0.setDescription("Z8Fv%CX-Vl}j|#s~ 1");
      SupportingDocument supportingDocument1 = new SupportingDocument();
      ArrayList<MacawChangeEvent> arrayList0 = SupportingDocument.detectFieldChanges(user0, supportingDocument0, supportingDocument1);
      assertEquals(0, supportingDocument1.getIdentifier());
      assertEquals(1, arrayList0.size());
  ...
  public void test04()  throws Throwable  {
      ...
      User user0 = new User("supportingDocument.title.saveChanges", "S9gD@'<!ES|-x@o");
      SupportingDocument supportingDocument1 = new SupportingDocument();
      supportingDocument0.setTitle("dualDecompInitialStepSize");
      ArrayList<MacawChangeEvent> arrayList0 = SupportingDocument.detectFieldChanges(user0, supportingDocument0, supportingDocument1);
      assertEquals(0, supportingDocument0.getIdentifier());
  ...
  public void test05()  throws Throwable  {
      SupportingDocument supportingDocument0 = new SupportingDocument();
      supportingDocument0.setFileName("should");
      supportingDocument0.setDocumentCode("supportingDocument.title.saveChanges");
      supportingDocument0.setTitle("supportingDocuent.title.saveChanges");
  ...
  public void test07()  throws Throwable  {
      SupportingDocument supportingDocument0 = new SupportingDocument();
      supportingDocument0.setDocumentCode("!s9U69");
      try {
        SupportingDocument.validateFields(supportingDocument0);
        fail("Expecting exception: Exception");
