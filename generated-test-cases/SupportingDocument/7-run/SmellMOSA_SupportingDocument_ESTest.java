...
public class SupportingDocument_ESTest extends SupportingDocument_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      supportingDocument0.setDocumentCode("Vo@VE<C G.!iD2B}");
      assertEquals("", supportingDocument0.getTitle());
      assertEquals("", supportingDocument0.getDescription());
      assertFalse(supportingDocument0.isNewRecord());
      assertEquals("", supportingDocument0.getFileName());
      assertEquals("Vo@VE<C G.!iD2B}", supportingDocument0.getDocumentCode());
      assertEquals(0, supportingDocument0.getIdentifier());
      assertEquals("", supportingDocument0.getFilePath());
      assertEquals("0", supportingDocument0.getDisplayItemIdentifier());
   ...
   * Goal 7. macaw.businessLayer.SupportingDocument.detectFieldChanges(Lmacaw/businessLayer/User;Lmacaw/businessLayer/SupportingDocument;Lmacaw/businessLayer/SupportingDocument;)Ljava/util/ArrayList;: I123 Branch 8 IFGT L318 - false
   */

  @Test
  public void test3()  throws Throwable  {
      User user0 = new User("jK-QL,<3<S)#('O=U", "jK-QL,<3<S)#('O=U");
      assertEquals(0, user0.getIdentifier());
      assertEquals("", user0.getAddressLine2());
      assertEquals("jK-QL,<3<S)#('O=U", user0.getDisplayName());
      assertEquals("0", user0.getDisplayItemIdentifier());
      assertEquals("", user0.getAffiliation());
      assertEquals("jK-QL,<3<S)#('O=U", user0.getPassword());
      assertEquals("", user0.getPhone());
      assertEquals("", user0.getLastName());
      assertEquals("", user0.getAddressLine1());
      assertEquals("jK-QL,<3<S)#('O=U", user0.getUserID());
      assertEquals("", user0.getEmail());
      assertEquals("", user0.getCounty());
      assertEquals("UNVERIFIED", user0.getStatus());
      assertEquals("", user0.getPostCode());
      ...
      supportingDocument0.setDescription("jK-QL,<3<S)#('O=U");
      assertFalse(supportingDocument0.equals((Object)supportingDocument1));
      assertEquals("", supportingDocument0.getFilePath());
      assertEquals(0, supportingDocument0.getIdentifier());
      assertFalse(supportingDocument0.isNewRecord());
      assertEquals("", supportingDocument0.getTitle());
      assertEquals("jK-QL,<3<S)#('O=U", supportingDocument0.getDescription());
      assertEquals("", supportingDocument0.getFileName());
      assertEquals("0", supportingDocument0.getDisplayItemIdentifier());
      assertEquals("", supportingDocument0.getDocumentCode());
      assertNotSame(supportingDocument0, supportingDocument1);
  ...
  public void test5()  throws Throwable  {
      ...
      supportingDocument1.setTitle("Nj19h");
      assertFalse(supportingDocument1.equals((Object)supportingDocument0));
      assertEquals("0", supportingDocument1.getDisplayItemIdentifier());
      assertEquals("", supportingDocument1.getDocumentCode());
      assertEquals("Nj19h", supportingDocument1.getTitle());
      assertEquals("", supportingDocument1.getFileName());
      assertFalse(supportingDocument1.isNewRecord());
      assertEquals("", supportingDocument1.getDescription());
      assertEquals("", supportingDocument1.getFilePath());
  ...
  /*
   * 6 covered goals:
   * Goal 1. macaw.businessLayer.SupportingDocument.getFilePath()Ljava/lang/String;: root-Branch
   ...
   * Goal 6. macaw.businessLayer.SupportingDocument.detectFieldChanges(Lmacaw/businessLayer/User;Lmacaw/businessLayer/SupportingDocument;Lmacaw/businessLayer/SupportingDocument;)Ljava/util/ArrayList;: I217 Branch 10 IFGT L348 - true
   */
   ...
   * Goal 15. macaw.businessLayer.SupportingDocument.validateFields(Lmacaw/businessLayer/SupportingDocument;)V: I50 Branch 2 IF_ICMPNE L210 - true
   ...
   * Goal 17. macaw.businessLayer.SupportingDocument.validateFields(Lmacaw/businessLayer/SupportingDocument;)V: I106 Branch 4 IFLE L238 - true
   */
  ...
  public void test9()  throws Throwable  {
      ...
      supportingDocument0.setIdentifier(1819);
      assertEquals("0", supportingDocument0.getFilePath());
      assertFalse(supportingDocument0.isNewRecord());
      assertEquals(1819, supportingDocument0.getIdentifier());
      assertEquals("", supportingDocument0.getTitle());
      assertEquals("", supportingDocument0.getDescription());
      assertEquals("0", supportingDocument0.getFileName());
      assertEquals("1819", supportingDocument0.getDisplayItemIdentifier());
      assertEquals("", supportingDocument0.getDocumentCode());
