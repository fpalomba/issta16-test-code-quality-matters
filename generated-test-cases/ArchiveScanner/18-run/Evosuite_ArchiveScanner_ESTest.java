...
public class ArchiveScanner_ESTest extends ArchiveScanner_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)objectBank_PathToFileFunction0.apply("&Do<6%NIT@r6.sjar");
      MockFile mockFile1 = (MockFile)MockFile.createTempFile("&Do<6%NIT@r6.sjar", "&Do<6%NIT@r6.sjar", (File) mockFile0);
      ImprovedFile improvedFile0 = new ImprovedFile((File) mockFile1, "&Do<6%NIT@r6.sjar");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      // Undeclared exception!
      try {
        archiveScanner0.scandir(mockFile0, "&Do<6%NIT@r6.sjar", true);
  ...
  public void test02()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("contour");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      try {
        archiveScanner0.scandir(improvedFile0, "contour", true);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // IO error scanning directory /Users/fabiopalomba/Documents/workspace/LunchEvosuite/contour
         //
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      stringArray0[0] = "startFold > numFolds -> setting startFold to 1";
      stringArray0[1] = "startFold > numFolds -> setting startFold to 1";
      stringArray0[2] = "startFold > numFolds -> setting startFold to 1";
      stringArray0[3] = "startFold > numFolds -> setting startFold to 1";
      archiveScanner0.setExcludes(stringArray0);
      ImprovedFile improvedFile0 = new ImprovedFile("startFold > numFolds -> setting startFold to 1", "startFold > numFolds -> setting startFold to 1");
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processArchive((File) improvedFile0, "startFold > numFolds -> setting startFold to 1");
        fail("Expecting exception: NullPointerException");
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray1[0] = "startFold > numFolds -> setting startFold to 1";
      stringArray1[1] = "{rw}#&--o:8&bm";
      stringArray1[2] = "{rw}#&--o:8&bm";
      stringArray1[3] = "{rw}#&--o:8&bm";
      archiveScanner0.setIncludes(stringArray1);
      // Undeclared exception!
      try {
        archiveScanner0.processArchive((File) improvedFile0, "{rw}#&--o:8&bm");
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        archiveScanner0.processArchive((File) improvedFile0, "un-man");
        fail("Expecting exception: NullPointerException");
  ...
  public void test06()  throws Throwable  {
      ...
      stringArray0[0] = "&Do<6%NIT@r6.jar";
      stringArray0[1] = "&Do<6%NIT@r6.jar";
      stringArray0[2] = "&Do<6%NIT@r6.jar";
      stringArray0[3] = "&Do<6%NIT@r6.jar";
      stringArray0[4] = "&Do<6%NIT@r6.jar";
      archiveScanner0.setExcludes(stringArray0);
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processFile("&Do<6%NIT@r6.jar");
        fail("Expecting exception: NullPointerException");
  ...
  public void test08()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("\"YzkQFt3D", "\"YzkQFt3D");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      String[] stringArray0 = new String[7];
      stringArray0[0] = "/Users/fabiopalomba/Documents/workspace/LunchEvosuite/\"YzkQFt3D/\"YzkQFt3D";
      stringArray0[1] = "/Users/fabiopalomba/Documents/workspace/LunchEvosuite/\"YzkQFt3D/\"YzkQFt3D";
      stringArray0[2] = "/Users/fabiopalomba/Documents/workspace/LunchEvosuite/\"YzkQFt3D/\"YzkQFt3D";
      stringArray0[3] = "/Users/fabiopalomba/Documents/workspace/LunchEvosuite/\"YzkQFt3D/\"YzkQFt3D";
      stringArray0[4] = "\"YzkQFt3D";
      stringArray0[5] = "/Users/fabiopalomba/Documents/workspace/LunchEvosuite/\"YzkQFt3D/\"YzkQFt3D";
      stringArray0[6] = "/Users/fabiopalomba/Documents/workspace/LunchEvosuite/\"YzkQFt3D/\"YzkQFt3D";
      archiveScanner0.includes = stringArray0;
      // Undeclared exception!
      try {
        archiveScanner0.processFile("CavI[/rj.C.-T'GMKz4");
        fail("Expecting exception: NullPointerException");
  ...
  public void test10()  throws Throwable  {
      ...
      archiveScanner0.dirsIncluded = vector0;
      String[] stringArray0 = new String[4];
      stringArray0[0] = "^[-,N0^[-,N.jar";
      stringArray0[1] = "^[-,N0^[-,N.jar";
      stringArray0[2] = "!";
      stringArray0[3] = "!";
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
  ...
  public void test12()  throws Throwable  {
      ...
      stringArray0[0] = "($1(t[V0A@B%0=}OV s";
      stringArray0[1] = "($1(t[V0A@B%0=}OV s";
      archiveScanner0.includes = stringArray0;
      // Undeclared exception!
      try {
        archiveScanner0.processDirectory((File) null, "/xO`#Pey x@9C ", true);
        fail("Expecting exception: NullPointerException");
