...
public class ArchiveScanner_ESTest extends ArchiveScanner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("Cannot handle null mode");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      try {
        archiveScanner0.scandir(improvedFile0, "Kx[I", false);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // IO error scanning directory /Users/fabiopalomba/Documents/workspace/LunchEvosuite/Cannot handle null mode
         //
      }
  }
  ...
  public void test1()  throws Throwable  {
      MockFile mockFile0 = (MockFile)MockFile.createTempFile(">h$U\"x1DKx[I", ">h$U\"x1DKx[I");
      ImprovedFile improvedFile0 = new ImprovedFile((File) mockFile0);
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      String[] stringArray0 = new String[1];
      stringArray0[0] = ">h$U\"x1DKx[I";
      archiveScanner0.setExcludes(stringArray0);
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processArchive((File) improvedFile0, ">h$U\"x1DKx[I");
  ...
  public void test3()  throws Throwable  {
      MockFile mockFile0 = (MockFile)MockFile.createTempFile("d@9N!yoX?b*kS|3C/O", "d@9N!yoX?b*kS|3C/O");
      ImprovedFile improvedFile0 = new ImprovedFile((File) mockFile0);
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      String[] stringArray0 = new String[1];
      stringArray0[0] = "d@9N!yoX?b*kS|3C/O";
      archiveScanner0.setIncludes(stringArray0);
      String[] stringArray1 = new String[10];
      stringArray1[0] = "r";
      stringArray1[1] = "<h";
      stringArray1[2] = "r";
      stringArray1[3] = "d@9N!yoX?b*kS|3C/O";
      archiveScanner0.excludes = stringArray1;
      // Undeclared exception!
      try {
        archiveScanner0.processFile("d@9N!yoX?b*kS|3C/O");
        fail("Expecting exception: NullPointerException");
  ...
  public void test4()  throws Throwable  {
      ...
      stringArray0[0] = "\"Ff_6,`";
      stringArray0[1] = ">h$U\"x1DKx[I";
      stringArray0[2] = ">h$U\"x1DKx[I";
      stringArray0[3] = ">h$U\"x1DKx[I";
      stringArray0[4] = ">h$U\"x1DKx[I";
      stringArray0[5] = ">h$U\"x1DKx[I";
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processFile("\"Ff_6,`");
        fail("Expecting exception: NullPointerException");
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        archiveScanner0.processDirectory((File) improvedFile0, ">h$U\"x1DKx[I", true);
        fail("Expecting exception: NullPointerException");
  ...
  public void test7()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("YL");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      ImprovedFile improvedFile1 = improvedFile0.createTempDir();
      String[] stringArray0 = new String[6];
      stringArray0[0] = "QX3f$";
      stringArray0[1] = "v+r~eR.L";
      stringArray0[2] = "v+r~eR.L";
      stringArray0[3] = "QX3f$";
      stringArray0[4] = "0d@9N!yo\"X?b*k|3C.jar";
      stringArray0[5] = "QX3f$";
      archiveScanner0.setIncludes(stringArray0);
   ...
   * Goal 4. com.lts.io.ArchiveScanner.processDirectory(Ljava/io/File;Ljava/lang/String;Z)V: I30 Branch 8 IFEQ L105 - false
   ...
   * Goal 12. com.lts.io.ArchiveScanner.scandir(Ljava/io/File;Ljava/lang/String;Z)V: I86 Branch 20 TABLESWITCH L198 Case 1 - false
   * Goal 13. com.lts.io.ArchiveScanner.scandir(Ljava/io/File;Ljava/lang/String;Z)V: I86 Branch 21 TABLESWITCH L198 Case 2 - true
  ...
  public void test9()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("YL");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      MockFile mockFile0 = (MockFile)MockFile.createTempFile("v+r~eR.L", "QX3f$", (File) improvedFile0);
      archiveScanner0.basedir = (File) improvedFile0;
      try {
        archiveScanner0.scan();
       //  fail("Expecting exception: Exception");
       // Unstable assertion
         ...
         //
         // Error trying to list archive, YL/v+r~eR.L0QX3f$
         //
      }
  }
}
