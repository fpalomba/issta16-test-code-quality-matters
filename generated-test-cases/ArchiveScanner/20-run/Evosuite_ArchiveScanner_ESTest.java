...
public class ArchiveScanner_ESTest extends ArchiveScanner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("f(<avorite", "f(<avorite");
      ImprovedFile improvedFile1 = ImprovedFile.createTempImprovedFile("f(<avorite", "f(<avorite", (File) improvedFile0);
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      // Undeclared exception!
      try {
        archiveScanner0.scandir(improvedFile0, "f(<avorite", true);
  ...
  public void test1()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/Users/fabiopalomba/Documents/workspace/LunchEvosuite/favorite/favorite");
      boolean boolean0 = FileSystemHandling.createFolder(evoSuiteFile0);
      ImprovedFile improvedFile0 = new ImprovedFile("favorite", "favorite");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      archiveScanner0.scandir(improvedFile0, "favorite", true);
  ...
  public void test2()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("WE");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      try {
        archiveScanner0.scandir(improvedFile0, "WE", true);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // IO error scanning directory /Users/fabiopalomba/Documents/workspace/LunchEvosuite/WE
         //
      }
  }
  ...
  public void test5()  throws Throwable  {
      ...
      stringArray0[0] = "favorite";
      stringArray0[1] = "favorite";
      stringArray0[2] = "favorite";
      stringArray0[3] = "favorite";
      stringArray0[4] = "favorite";
      stringArray0[5] = "favorite";
      stringArray0[6] = "favorite";
      archiveScanner0.addDefaultExcludes();
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processFile("favorite");
        fail("Expecting exception: NullPointerException");
  ...
  public void test7()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("cmlts.io.ArchiveScanner", "cmlts.io.ArchiveScanner");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      String[] stringArray0 = new String[4];
      stringArray0[0] = "cmlts.io.ArchiveScanner";
      stringArray0[1] = "cmlts.io.ArchiveScanner";
      stringArray0[2] = "cmlts.io.ArchiveScanner";
      stringArray0[3] = "cmlts.io.ArchiveScanner";
      archiveScanner0.addDefaultExcludes();
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processDirectory((File) improvedFile0, "cmlts.io.ArchiveScanner", false);
        fail("Expecting exception: NullPointerException");
  ...
  public void test8()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("comlts.inArchiveEcanner", "comlts.inArchiveEcanner");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      String[] stringArray0 = new String[4];
      stringArray0[0] = "comlts.inArchiveEcanner";
      stringArray0[1] = "comlts.inArchiveEcanner";
      stringArray0[2] = "comlts.inArchiveEcanner";
      stringArray0[3] = "comlts.inArchiveEcanner";
      archiveScanner0.setExcludes(stringArray0);
      archiveScanner0.setIncludes(stringArray0);
      // Undeclared exception!
      try {
        archiveScanner0.processDirectory((File) improvedFile0, "comlts.inArchiveEcanner", true);
        fail("Expecting exception: NullPointerException");
  ...
  public void test9()  throws Throwable  {
      ...
      ImprovedFile improvedFile1 = improvedFile0.createTempDir("com.lts.io.ArchiveScanner", "com.lts.io.ArchiveScanner");
      ...
      // Undeclared exception!
      try {
        archiveScanner0.scandir(improvedFile0, "com.lts.io.ArchiveScanner", true);
        fail("Expecting exception: NullPointerException");
