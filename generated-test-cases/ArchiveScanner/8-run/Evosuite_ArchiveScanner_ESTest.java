...
public class ArchiveScanner_ESTest extends ArchiveScanner_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ImprovedFile improvedFile0 = new ImprovedFile("Mr#,.jar", "Mr#,.jar");
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile0);
      try {
        archiveScanner0.scandir(improvedFile0, "Mr#,.jar", false);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // IO error scanning directory /Users/fabiopalomba/Documents/workspace/LunchEvosuite/Mr#,.jar/Mr#,.jar
         //
      }
  }
  ...
  public void test1()  throws Throwable  {
      ...
      stringArray0[0] = "U~dFIkMZ`l]G4;*odZ";
      archiveScanner0.setExcludes(stringArray0);
      archiveScanner0.includes = stringArray0;
      // Undeclared exception!
      try {
        archiveScanner0.processArchive((File) null, "U~dFIkMZ`l]G4;*odZ");
  ...
  public void test2()  throws Throwable  {
      ...
      stringArray1[0] = "U~dFIkMZ`l]G4;*odZ";
  ...
  public void test7()  throws Throwable  {
      ...
      MockFile mockFile0 = (MockFile)objectBank_PathToFileFunction0.apply("VX( )4zq'u[>");
      ImprovedFile improvedFile0 = new ImprovedFile((File) mockFile0);
      ImprovedFile improvedFile1 = ImprovedFile.createTempImprovedFile("VX( )4zq'u[>", "VX( )4zq'u[>", (File) improvedFile0);
      ArchiveScanner archiveScanner0 = new ArchiveScanner(improvedFile1);
      // Undeclared exception!
      try {
        archiveScanner0.scandir(improvedFile0, "VX( )4zq'u[>", true);
        fail("Expecting exception: NullPointerException");
